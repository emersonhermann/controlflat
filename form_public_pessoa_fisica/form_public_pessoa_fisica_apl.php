<?php
//
class form_public_pessoa_fisica_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_public_pessoa_fisica']['nm_run_menu'] = 1;
      } 
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_public_pessoa_fisica']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_public_pessoa_fisica']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_public_pessoa_fisica']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_public_pessoa_fisica']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_public_pessoa_fisica']['parms']))
      {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_public_pessoa_fisica']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_public_pessoa_fisica']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_public_pessoa_fisica']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_public_pessoa_fisica']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_public_pessoa_fisica']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_public_pessoa_fisica']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_public_pessoa_fisica']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_public_pessoa_fisica_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("pt_br");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_public_pessoa_fisica']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_public_pessoa_fisica']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_public_pessoa_fisica'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_public_pessoa_fisica']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_public_pessoa_fisica']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_public_pessoa_fisica') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_public_pessoa_fisica']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - Pessoa Física";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_public_pessoa_fisica")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      if (isset($_GET['nmgp_opcao']) && $_GET['nmgp_opcao'] == "ajax_aut_comp_dyn_search")
      {
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['dyn_search_aut_comp']);
          exit;
      }


      $_SESSION['scriptcase']['error_icon']['form_public_pessoa_fisica']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_public_pessoa_fisica'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";
      ...
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['embutida_call'] : $this->Embutida_call;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['table_refresh'] = false;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_public_pessoa_fisica']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_public_pessoa_fisica']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_public_pessoa_fisica']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_public_pessoa_fisica']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_public_pessoa_fisica']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_public_pessoa_fisica']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_public_pessoa_fisica']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_public_pessoa_fisica']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_public_pessoa_fisica']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_public_pessoa_fisica']['goto'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_public_pessoa_fisica']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_public_pessoa_fisica']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_public_pessoa_fisica']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_public_pessoa_fisica']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_public_pessoa_fisica']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_public_pessoa_fisica']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_public_pessoa_fisica']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_public_pessoa_fisica']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_public_pessoa_fisica']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_public_pessoa_fisica", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_public_pessoa_fisica/form_public_pessoa_fisica_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_public_pessoa_fisica_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_public_pessoa_fisica_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_public_pessoa_fisica_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_public_pessoa_fisica/form_public_pessoa_fisica_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_public_pessoa_fisica_erro.class.php"); 
      }
      $this->Erro      = new form_public_pessoa_fisica_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['opcao'] = "inicio";
      ...
      if ($this->nmgp_opcao == "dyn_search" || $this->nmgp_opcao == "dyn_search_clear")  
      {
          ...
          if ($this->nmgp_opcao == "dyn_search_clear")  
          {
              ...
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['total']);
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['cond_pesq']);
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['dyn_search']);
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['empty_filter'])
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['empty_filter']);
                  $this->NM_ajax_info['empty_filter'] = 'ok';
                  form_public_pessoa_fisica_pack_ajax_response();
                  exit;
              }
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['dyn_search_clear'] = true;
      ...
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['opcao']))
         { 
             if ($this->id_pessoa_fisica != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_public_pessoa_fisica']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_public_pessoa_fisica']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_public_pessoa_fisica']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['sc_redir_atualiz'] == "ok")
          {
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_public_pessoa_fisica']) || !is_array($this->NM_ajax_info['errList']['geral_form_public_pessoa_fisica']))
              {
                  $this->NM_ajax_info['errList']['geral_form_public_pessoa_fisica'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_public_pessoa_fisica'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    {
        global $teste_validade;
               if (!empty($this->nacionalidade) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_nacionalidade']) && !in_array($this->nacionalidade, $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_nacionalidade']))
               {
    ...
    {
        global $teste_validade;
               if (!empty($this->id_tipo_estado_civil) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_tipo_estado_civil']) && !in_array($this->id_tipo_estado_civil, $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_tipo_estado_civil']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->id_tipo_escolaridade) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_tipo_escolaridade']) && !in_array($this->id_tipo_escolaridade, $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_tipo_escolaridade']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->id_tipo_sanguineo) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_tipo_sanguineo']) && !in_array($this->id_tipo_sanguineo, $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_tipo_sanguineo']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_id_ativo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->id_ativo != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_ativo']) && !in_array($this->id_ativo, $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_ativo']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->id_municipio) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_municipio']) && !in_array($this->id_municipio, $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_municipio']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->id_uf) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_uf']) && !in_array($this->id_uf, $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_uf']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->id_pais) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_pais']) && !in_array($this->id_pais, $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_pais']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->id_municipio_cob) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_municipio_cob']) && !in_array($this->id_municipio_cob, $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_municipio_cob']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->id_uf_cob) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_uf_cob']) && !in_array($this->id_uf_cob, $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_uf_cob']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->id_pais_cob) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_pais_cob']) && !in_array($this->id_pais_cob, $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_pais_cob']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->rg_uf_emissor) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_rg_uf_emissor']) && !in_array($this->rg_uf_emissor, $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_rg_uf_emissor']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->passaporte_pais_origem) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_passaporte_pais_origem']) && !in_array($this->passaporte_pais_origem, $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_passaporte_pais_origem']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id_pessoa_fisica']['keyVal'] = form_public_pessoa_fisica_pack_protect_string($this->nmgp_dados_form['id_pessoa_fisica']);
          }
   } // ajax_return_values
...
$aLookup[] = array(form_public_pessoa_fisica_pack_protect_string('M') => form_public_pessoa_fisica_pack_protect_string("Masculino"));
$aLookup[] = array(form_public_pessoa_fisica_pack_protect_string('F') => form_public_pessoa_fisica_pack_protect_string("Feminino"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_sexo'][] = 'M';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_sexo'][] = 'F';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"sexo\"";
          ...
          {
              $this->NM_ajax_info['fldList']['sexo']['valList'][$i] = form_public_pessoa_fisica_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_nacionalidade']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_nacionalidade'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_nacionalidade']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_nacionalidade'] = array(); 
}
$aLookup[] = array(form_public_pessoa_fisica_pack_protect_string('') => form_public_pessoa_fisica_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_nacionalidade'][] = '';
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $aLookup[] = array(form_public_pessoa_fisica_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => form_public_pessoa_fisica_pack_protect_string(NM_charset_to_utf8($rs->fields[0] . " - " . $rs->fields[1])));
              $nmgp_def_dados .= $rs->fields[0] . " - " . $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_nacionalidade'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['nacionalidade']['valList'][$i] = form_public_pessoa_fisica_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_tipo_estado_civil']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_tipo_estado_civil'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_tipo_estado_civil']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_tipo_estado_civil'] = array(); 
}
$aLookup[] = array(form_public_pessoa_fisica_pack_protect_string('') => form_public_pessoa_fisica_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_tipo_estado_civil'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[0] . " - " . $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_tipo_estado_civil'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_tipo_estado_civil']['valList'][$i] = form_public_pessoa_fisica_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_tipo_escolaridade']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_tipo_escolaridade'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_tipo_escolaridade']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_tipo_escolaridade'] = array(); 
}
$aLookup[] = array(form_public_pessoa_fisica_pack_protect_string('') => form_public_pessoa_fisica_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_tipo_escolaridade'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[0] . " - " . $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_tipo_escolaridade'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_tipo_escolaridade']['valList'][$i] = form_public_pessoa_fisica_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_tipo_sanguineo']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_tipo_sanguineo'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_tipo_sanguineo']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_tipo_sanguineo'] = array(); 
}
$aLookup[] = array(form_public_pessoa_fisica_pack_protect_string('') => form_public_pessoa_fisica_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_tipo_sanguineo'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[0] . " - " . $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_tipo_sanguineo'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_tipo_sanguineo']['valList'][$i] = form_public_pessoa_fisica_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_public_pessoa_fisica_pack_protect_string('S') => form_public_pessoa_fisica_pack_protect_string("Sim"));
$aLookup[] = array(form_public_pessoa_fisica_pack_protect_string('N') => form_public_pessoa_fisica_pack_protect_string("Não"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_aposentado'][] = 'S';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_aposentado'][] = 'N';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['aposentado']['valList'][$i] = form_public_pessoa_fisica_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_public_pessoa_fisica_pack_protect_string('1') => form_public_pessoa_fisica_pack_protect_string("Ativo"));
$aLookup[] = array(form_public_pessoa_fisica_pack_protect_string('0') => form_public_pessoa_fisica_pack_protect_string("Inativo"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_ativo'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_ativo'][] = '0';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['id_ativo']['valList'][$i] = form_public_pessoa_fisica_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_municipio']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_municipio'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_municipio']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_municipio'] = array(); 
}
$aLookup[] = array(form_public_pessoa_fisica_pack_protect_string('') => form_public_pessoa_fisica_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_municipio'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[0] . " - " . $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_municipio'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_municipio']['valList'][$i] = form_public_pessoa_fisica_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_uf']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_uf'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_uf']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_uf'] = array(); 
}
$aLookup[] = array(form_public_pessoa_fisica_pack_protect_string('') => form_public_pessoa_fisica_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_uf'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[0] . " - " . $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_uf'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_uf']['valList'][$i] = form_public_pessoa_fisica_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_pais']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_pais'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_pais']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_pais'] = array(); 
}
$aLookup[] = array(form_public_pessoa_fisica_pack_protect_string('') => form_public_pessoa_fisica_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_pais'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[0] . " - " . $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_pais'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_pais']['valList'][$i] = form_public_pessoa_fisica_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_municipio_cob']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_municipio_cob'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_municipio_cob']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_municipio_cob'] = array(); 
}
$aLookup[] = array(form_public_pessoa_fisica_pack_protect_string('') => form_public_pessoa_fisica_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_municipio_cob'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[0] . " - " . $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_municipio_cob'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_municipio_cob']['valList'][$i] = form_public_pessoa_fisica_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_uf_cob']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_uf_cob'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_uf_cob']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_uf_cob'] = array(); 
}
$aLookup[] = array(form_public_pessoa_fisica_pack_protect_string('') => form_public_pessoa_fisica_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_uf_cob'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[0] . " - " . $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_uf_cob'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_uf_cob']['valList'][$i] = form_public_pessoa_fisica_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_pais_cob']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_pais_cob'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_pais_cob']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_pais_cob'] = array(); 
}
$aLookup[] = array(form_public_pessoa_fisica_pack_protect_string('') => form_public_pessoa_fisica_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_pais_cob'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[0] . " - " . $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_pais_cob'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_pais_cob']['valList'][$i] = form_public_pessoa_fisica_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_rg_uf_emissor'][] = '';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['rg_uf_emissor']['valList'][$i] = form_public_pessoa_fisica_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_passaporte_pais_origem'][] = '';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['passaporte_pais_origem']['valList'][$i] = form_public_pessoa_fisica_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_cnh_dt_validade($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          $this->usu_atualiza = $this->usu_atualiza_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['parms'] = "id_pessoa_fisica?#?$this->id_pessoa_fisica?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['where_filter_form'];
      }
...
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_public_pessoa_fisica = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['total'] = $qt_geral_reg_form_public_pessoa_fisica;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->id_pessoa_fisica))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_public_pessoa_fisica = $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['reg_start'] > $qt_geral_reg_form_public_pessoa_fisica)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['reg_start'] = $qt_geral_reg_form_public_pessoa_fisica; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_public_pessoa_fisica) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['reg_start']) ;  
              } 
          } 
          ...
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['reg_start'] < $qt_geral_reg_form_public_pessoa_fisica;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['opcao']   = '';
          }
      } 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['reg_start'] + 1;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        include_once("form_public_pessoa_fisica_form0.php");
        include_once("form_public_pessoa_fisica_form1.php");
        include_once("form_public_pessoa_fisica_form2.php");
        include_once("form_public_pessoa_fisica_form3.php");
 }

    function form_encode_input($string)
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      if (empty($data_search)) 
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['where_detal'];
          }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_public_pessoa_fisica_pack_ajax_response();
...
function ajax_add_dyn_search(str_field, str_origem)
{
    ...
    $.ajax({
      type: "POST",
      url: "form_public_pessoa_fisica.php",
...
<?php
   ...
   function SC_proc_dyn_search($Parms)
   {
       ...
       $rt->Close(); 
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['cond_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['cond_dyn_search'] . $this->Dyn_Serarch_and_or;
       if (NM_is_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['cond_pesq']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['cond_pesq'] = sc_convert_encoding($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['cond_pesq'], $_SESSION['scriptcase']['charset'], "UTF-8");
       }
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['empty_filter']);
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['sc_outra_jan'])
   {
       $nmgp_saida_form = "form_public_pessoa_fisica_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_public_pessoa_fisica_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['masterValue']))
{
?>
