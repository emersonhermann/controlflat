  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_public_pessoa_fisica" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_public_pessoa_fisica_validate_id_pessoa_fisica()
  {
    ...
    x_ajax_form_public_pessoa_fisica_validate_id_pessoa_fisica(var_id_pessoa_fisica, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_id_pessoa_fisica_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_id_pessoa_fisica

  function do_ajax_form_public_pessoa_fisica_validate_id_pessoa_fisica_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_id_pessoa_fisica_cb

  // ---------- Validate cpf
  function do_ajax_form_public_pessoa_fisica_validate_cpf()
  {
    var nomeCampo_cpf = "cpf";
    var var_cpf = scAjaxGetFieldText(nomeCampo_cpf);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_cpf(var_cpf, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_cpf_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_cpf

  function do_ajax_form_public_pessoa_fisica_validate_cpf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cpf";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_cpf_cb

  // ---------- Validate nome
  function do_ajax_form_public_pessoa_fisica_validate_nome()
  {
    var nomeCampo_nome = "nome";
    var var_nome = scAjaxGetFieldText(nomeCampo_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_nome(var_nome, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_nome_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_nome

  function do_ajax_form_public_pessoa_fisica_validate_nome_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nome";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_nome_cb

  // ---------- Validate sexo
  function do_ajax_form_public_pessoa_fisica_validate_sexo()
  {
    var nomeCampo_sexo = "sexo";
    var var_sexo = scAjaxGetFieldSelect(nomeCampo_sexo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_sexo(var_sexo, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_sexo_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_sexo

  function do_ajax_form_public_pessoa_fisica_validate_sexo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "sexo";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_sexo_cb

  // ---------- Validate dt_nasc
  function do_ajax_form_public_pessoa_fisica_validate_dt_nasc()
  {
    var nomeCampo_dt_nasc = "dt_nasc";
    var var_dt_nasc = scAjaxGetFieldText(nomeCampo_dt_nasc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_dt_nasc(var_dt_nasc, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_dt_nasc_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_dt_nasc

  function do_ajax_form_public_pessoa_fisica_validate_dt_nasc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "dt_nasc";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_dt_nasc_cb

  // ---------- Validate nacionalidade
  function do_ajax_form_public_pessoa_fisica_validate_nacionalidade()
  {
    var nomeCampo_nacionalidade = "nacionalidade";
    var var_nacionalidade = scAjaxGetFieldSelect(nomeCampo_nacionalidade);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_nacionalidade(var_nacionalidade, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_nacionalidade_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_nacionalidade

  function do_ajax_form_public_pessoa_fisica_validate_nacionalidade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_nacionalidade_cb

  // ---------- Validate naturalidade
  function do_ajax_form_public_pessoa_fisica_validate_naturalidade()
  {
    var nomeCampo_naturalidade = "naturalidade";
    var var_naturalidade = scAjaxGetFieldText(nomeCampo_naturalidade);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_naturalidade(var_naturalidade, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_naturalidade_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_naturalidade

  function do_ajax_form_public_pessoa_fisica_validate_naturalidade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_naturalidade_cb

  // ---------- Validate id_tipo_estado_civil
  function do_ajax_form_public_pessoa_fisica_validate_id_tipo_estado_civil()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_id_tipo_estado_civil(var_id_tipo_estado_civil, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_id_tipo_estado_civil_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_id_tipo_estado_civil

  function do_ajax_form_public_pessoa_fisica_validate_id_tipo_estado_civil_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_id_tipo_estado_civil_cb

  // ---------- Validate id_tipo_escolaridade
  function do_ajax_form_public_pessoa_fisica_validate_id_tipo_escolaridade()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_id_tipo_escolaridade(var_id_tipo_escolaridade, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_id_tipo_escolaridade_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_id_tipo_escolaridade

  function do_ajax_form_public_pessoa_fisica_validate_id_tipo_escolaridade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_id_tipo_escolaridade_cb

  // ---------- Validate id_tipo_sanguineo
  function do_ajax_form_public_pessoa_fisica_validate_id_tipo_sanguineo()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_id_tipo_sanguineo(var_id_tipo_sanguineo, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_id_tipo_sanguineo_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_id_tipo_sanguineo

  function do_ajax_form_public_pessoa_fisica_validate_id_tipo_sanguineo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_id_tipo_sanguineo_cb

  // ---------- Validate profissao
  function do_ajax_form_public_pessoa_fisica_validate_profissao()
  {
    var nomeCampo_profissao = "profissao";
    var var_profissao = scAjaxGetFieldText(nomeCampo_profissao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_profissao(var_profissao, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_profissao_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_profissao

  function do_ajax_form_public_pessoa_fisica_validate_profissao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_profissao_cb

  // ---------- Validate aposentado
  function do_ajax_form_public_pessoa_fisica_validate_aposentado()
  {
    var nomeCampo_aposentado = "aposentado";
    var var_aposentado = scAjaxGetFieldSelect(nomeCampo_aposentado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_aposentado(var_aposentado, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_aposentado_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_aposentado

  function do_ajax_form_public_pessoa_fisica_validate_aposentado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_aposentado_cb

  // ---------- Validate id_tipo_vinculo
  function do_ajax_form_public_pessoa_fisica_validate_id_tipo_vinculo()
  {
    var nomeCampo_id_tipo_vinculo = "id_tipo_vinculo";
    var var_id_tipo_vinculo = scAjaxGetFieldText(nomeCampo_id_tipo_vinculo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_id_tipo_vinculo(var_id_tipo_vinculo, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_id_tipo_vinculo_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_id_tipo_vinculo

  function do_ajax_form_public_pessoa_fisica_validate_id_tipo_vinculo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_id_tipo_vinculo_cb

  // ---------- Validate obs
  function do_ajax_form_public_pessoa_fisica_validate_obs()
  {
    var nomeCampo_obs = "obs";
    var var_obs = scAjaxGetFieldText(nomeCampo_obs);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_obs(var_obs, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_obs_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_obs

  function do_ajax_form_public_pessoa_fisica_validate_obs_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "obs";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_obs_cb

  // ---------- Validate id_ativo
  function do_ajax_form_public_pessoa_fisica_validate_id_ativo()
  {
    var nomeCampo_id_ativo = "id_ativo";
    var var_id_ativo = scAjaxGetFieldRadio(nomeCampo_id_ativo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_id_ativo(var_id_ativo, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_id_ativo_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_id_ativo

  function do_ajax_form_public_pessoa_fisica_validate_id_ativo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_id_ativo_cb

  // ---------- Validate endereco
  function do_ajax_form_public_pessoa_fisica_validate_endereco()
  {
    var nomeCampo_endereco = "endereco";
    var var_endereco = scAjaxGetFieldText(nomeCampo_endereco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_endereco(var_endereco, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_endereco_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_endereco

  function do_ajax_form_public_pessoa_fisica_validate_endereco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_endereco_cb

  // ---------- Validate endereco_comp
  function do_ajax_form_public_pessoa_fisica_validate_endereco_comp()
  {
    var nomeCampo_endereco_comp = "endereco_comp";
    var var_endereco_comp = scAjaxGetFieldText(nomeCampo_endereco_comp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_endereco_comp(var_endereco_comp, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_endereco_comp_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_endereco_comp

  function do_ajax_form_public_pessoa_fisica_validate_endereco_comp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_endereco_comp_cb

  // ---------- Validate bairro
  function do_ajax_form_public_pessoa_fisica_validate_bairro()
  {
    var nomeCampo_bairro = "bairro";
    var var_bairro = scAjaxGetFieldText(nomeCampo_bairro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_bairro(var_bairro, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_bairro_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_bairro

  function do_ajax_form_public_pessoa_fisica_validate_bairro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "bairro";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_bairro_cb

  // ---------- Validate id_municipio
  function do_ajax_form_public_pessoa_fisica_validate_id_municipio()
  {
    var nomeCampo_id_municipio = "id_municipio";
    var var_id_municipio = scAjaxGetFieldSelect(nomeCampo_id_municipio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_id_municipio(var_id_municipio, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_id_municipio_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_id_municipio

  function do_ajax_form_public_pessoa_fisica_validate_id_municipio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_id_municipio_cb

  // ---------- Validate id_uf
  function do_ajax_form_public_pessoa_fisica_validate_id_uf()
  {
    var nomeCampo_id_uf = "id_uf";
    var var_id_uf = scAjaxGetFieldSelect(nomeCampo_id_uf);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_id_uf(var_id_uf, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_id_uf_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_id_uf

  function do_ajax_form_public_pessoa_fisica_validate_id_uf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_uf";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_id_uf_cb

  // ---------- Validate id_pais
  function do_ajax_form_public_pessoa_fisica_validate_id_pais()
  {
    var nomeCampo_id_pais = "id_pais";
    var var_id_pais = scAjaxGetFieldSelect(nomeCampo_id_pais);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_id_pais(var_id_pais, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_id_pais_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_id_pais

  function do_ajax_form_public_pessoa_fisica_validate_id_pais_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_pais";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_id_pais_cb

  // ---------- Validate cep
  function do_ajax_form_public_pessoa_fisica_validate_cep()
  {
    var nomeCampo_cep = "cep";
    var var_cep = scAjaxGetFieldText(nomeCampo_cep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_cep(var_cep, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_cep_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_cep

  function do_ajax_form_public_pessoa_fisica_validate_cep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cep";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_cep_cb

  // ---------- Validate endereco_cob
  function do_ajax_form_public_pessoa_fisica_validate_endereco_cob()
  {
    var nomeCampo_endereco_cob = "endereco_cob";
    var var_endereco_cob = scAjaxGetFieldText(nomeCampo_endereco_cob);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_endereco_cob(var_endereco_cob, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_endereco_cob_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_endereco_cob

  function do_ajax_form_public_pessoa_fisica_validate_endereco_cob_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_endereco_cob_cb

  // ---------- Validate endereco_comp_cob
  function do_ajax_form_public_pessoa_fisica_validate_endereco_comp_cob()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_endereco_comp_cob(var_endereco_comp_cob, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_endereco_comp_cob_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_endereco_comp_cob

  function do_ajax_form_public_pessoa_fisica_validate_endereco_comp_cob_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_endereco_comp_cob_cb

  // ---------- Validate bairro_cob
  function do_ajax_form_public_pessoa_fisica_validate_bairro_cob()
  {
    var nomeCampo_bairro_cob = "bairro_cob";
    var var_bairro_cob = scAjaxGetFieldText(nomeCampo_bairro_cob);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_bairro_cob(var_bairro_cob, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_bairro_cob_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_bairro_cob

  function do_ajax_form_public_pessoa_fisica_validate_bairro_cob_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_bairro_cob_cb

  // ---------- Validate id_municipio_cob
  function do_ajax_form_public_pessoa_fisica_validate_id_municipio_cob()
  {
    var nomeCampo_id_municipio_cob = "id_municipio_cob";
    var var_id_municipio_cob = scAjaxGetFieldSelect(nomeCampo_id_municipio_cob);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_id_municipio_cob(var_id_municipio_cob, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_id_municipio_cob_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_id_municipio_cob

  function do_ajax_form_public_pessoa_fisica_validate_id_municipio_cob_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_id_municipio_cob_cb

  // ---------- Validate id_uf_cob
  function do_ajax_form_public_pessoa_fisica_validate_id_uf_cob()
  {
    var nomeCampo_id_uf_cob = "id_uf_cob";
    var var_id_uf_cob = scAjaxGetFieldSelect(nomeCampo_id_uf_cob);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_id_uf_cob(var_id_uf_cob, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_id_uf_cob_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_id_uf_cob

  function do_ajax_form_public_pessoa_fisica_validate_id_uf_cob_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_id_uf_cob_cb

  // ---------- Validate id_pais_cob
  function do_ajax_form_public_pessoa_fisica_validate_id_pais_cob()
  {
    var nomeCampo_id_pais_cob = "id_pais_cob";
    var var_id_pais_cob = scAjaxGetFieldSelect(nomeCampo_id_pais_cob);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_id_pais_cob(var_id_pais_cob, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_id_pais_cob_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_id_pais_cob

  function do_ajax_form_public_pessoa_fisica_validate_id_pais_cob_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_id_pais_cob_cb

  // ---------- Validate cep_cob
  function do_ajax_form_public_pessoa_fisica_validate_cep_cob()
  {
    var nomeCampo_cep_cob = "cep_cob";
    var var_cep_cob = scAjaxGetFieldText(nomeCampo_cep_cob);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_cep_cob(var_cep_cob, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_cep_cob_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_cep_cob

  function do_ajax_form_public_pessoa_fisica_validate_cep_cob_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cep_cob";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_cep_cob_cb

  // ---------- Validate rg
  function do_ajax_form_public_pessoa_fisica_validate_rg()
  {
    var nomeCampo_rg = "rg";
    var var_rg = scAjaxGetFieldText(nomeCampo_rg);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_rg(var_rg, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_rg_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_rg

  function do_ajax_form_public_pessoa_fisica_validate_rg_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "rg";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_rg_cb

  // ---------- Validate rg_uf_emissor
  function do_ajax_form_public_pessoa_fisica_validate_rg_uf_emissor()
  {
    var nomeCampo_rg_uf_emissor = "rg_uf_emissor";
    var var_rg_uf_emissor = scAjaxGetFieldSelect(nomeCampo_rg_uf_emissor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_rg_uf_emissor(var_rg_uf_emissor, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_rg_uf_emissor_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_rg_uf_emissor

  function do_ajax_form_public_pessoa_fisica_validate_rg_uf_emissor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_rg_uf_emissor_cb

  // ---------- Validate rg_orgao_emissor
  function do_ajax_form_public_pessoa_fisica_validate_rg_orgao_emissor()
  {
    var nomeCampo_rg_orgao_emissor = "rg_orgao_emissor";
    var var_rg_orgao_emissor = scAjaxGetFieldText(nomeCampo_rg_orgao_emissor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_rg_orgao_emissor(var_rg_orgao_emissor, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_rg_orgao_emissor_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_rg_orgao_emissor

  function do_ajax_form_public_pessoa_fisica_validate_rg_orgao_emissor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_rg_orgao_emissor_cb

  // ---------- Validate rg_dt_emissao
  function do_ajax_form_public_pessoa_fisica_validate_rg_dt_emissao()
  {
    var nomeCampo_rg_dt_emissao = "rg_dt_emissao";
    var var_rg_dt_emissao = scAjaxGetFieldText(nomeCampo_rg_dt_emissao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_rg_dt_emissao(var_rg_dt_emissao, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_rg_dt_emissao_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_rg_dt_emissao

  function do_ajax_form_public_pessoa_fisica_validate_rg_dt_emissao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_rg_dt_emissao_cb

  // ---------- Validate passaporte
  function do_ajax_form_public_pessoa_fisica_validate_passaporte()
  {
    var nomeCampo_passaporte = "passaporte";
    var var_passaporte = scAjaxGetFieldText(nomeCampo_passaporte);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_passaporte(var_passaporte, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_passaporte_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_passaporte

  function do_ajax_form_public_pessoa_fisica_validate_passaporte_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_passaporte_cb

  // ---------- Validate passaporte_pais_origem
  function do_ajax_form_public_pessoa_fisica_validate_passaporte_pais_origem()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_passaporte_pais_origem(var_passaporte_pais_origem, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_passaporte_pais_origem_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_passaporte_pais_origem

  function do_ajax_form_public_pessoa_fisica_validate_passaporte_pais_origem_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_passaporte_pais_origem_cb

  // ---------- Validate passaporte_dt_emissao
  function do_ajax_form_public_pessoa_fisica_validate_passaporte_dt_emissao()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_passaporte_dt_emissao(var_passaporte_dt_emissao, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_passaporte_dt_emissao_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_passaporte_dt_emissao

  function do_ajax_form_public_pessoa_fisica_validate_passaporte_dt_emissao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_passaporte_dt_emissao_cb

  // ---------- Validate cnh
  function do_ajax_form_public_pessoa_fisica_validate_cnh()
  {
    var nomeCampo_cnh = "cnh";
    var var_cnh = scAjaxGetFieldText(nomeCampo_cnh);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_cnh(var_cnh, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_cnh_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_cnh

  function do_ajax_form_public_pessoa_fisica_validate_cnh_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cnh";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_cnh_cb

  // ---------- Validate cnh_categoria
  function do_ajax_form_public_pessoa_fisica_validate_cnh_categoria()
  {
    var nomeCampo_cnh_categoria = "cnh_categoria";
    var var_cnh_categoria = scAjaxGetFieldText(nomeCampo_cnh_categoria);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_cnh_categoria(var_cnh_categoria, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_cnh_categoria_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_cnh_categoria

  function do_ajax_form_public_pessoa_fisica_validate_cnh_categoria_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_cnh_categoria_cb

  // ---------- Validate cnh_dt_validade
  function do_ajax_form_public_pessoa_fisica_validate_cnh_dt_validade()
  {
    var nomeCampo_cnh_dt_validade = "cnh_dt_validade";
    var var_cnh_dt_validade = scAjaxGetFieldText(nomeCampo_cnh_dt_validade);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_pessoa_fisica_validate_cnh_dt_validade(var_cnh_dt_validade, var_script_case_init, do_ajax_form_public_pessoa_fisica_validate_cnh_dt_validade_cb);
  } // do_ajax_form_public_pessoa_fisica_validate_cnh_dt_validade

  function do_ajax_form_public_pessoa_fisica_validate_cnh_dt_validade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_pessoa_fisica_validate_cnh_dt_validade_cb
  ...
  // ---------- Form
  function do_ajax_form_public_pessoa_fisica_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_public_pessoa_fisica_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_public_pessoa_fisica_submit_form(var_id_pessoa_fisica, var_cpf, var_nome, var_sexo, var_dt_nasc, var_nacionalidade, var_naturalidade, var_id_tipo_estado_civil, var_id_tipo_escolaridade, var_id_tipo_sanguineo, var_profissao, var_aposentado, var_id_tipo_vinculo, var_obs, var_id_ativo, var_endereco, var_endereco_comp, var_bairro, var_id_municipio, var_id_uf, var_id_pais, var_cep, var_endereco_cob, var_endereco_comp_cob, var_bairro_cob, var_id_municipio_cob, var_id_uf_cob, var_id_pais_cob, var_cep_cob, var_rg, var_rg_uf_emissor, var_rg_orgao_emissor, var_rg_dt_emissao, var_passaporte, var_passaporte_pais_origem, var_passaporte_dt_emissao, var_cnh, var_cnh_categoria, var_cnh_dt_validade, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_public_pessoa_fisica_submit_form_cb);
  } // do_ajax_form_public_pessoa_fisica_submit_form

  function do_ajax_form_public_pessoa_fisica_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_public_pessoa_fisica_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_public_pessoa_fisica_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_public_pessoa_fisica_navigate_form(var_id_pessoa_fisica, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_public_pessoa_fisica_navigate_form_cb);
  } // do_ajax_form_public_pessoa_fisica_navigate_form

  function do_ajax_form_public_pessoa_fisica_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_public_pessoa_fisica_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
...
{
?>
    do_ajax_form_public_pessoa_fisica_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_public_pessoa_fisica_navigate_form_cb
  function sc_hide_form_public_pessoa_fisica_form()
  {
