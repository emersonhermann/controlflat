<div id="form_public_pessoa_fisica_mob_form3" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rg_uf_emissor_line" id="hidden_field_data_rg_uf_emissor" style="<?php echo $sStyleHidden_rg_uf_emissor; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rg_uf_emissor_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rg_uf_emissor_label"><span id="id_label_rg_uf_emissor"><?php echo $this->nm_new_label['rg_uf_emissor']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rg_orgao_emissor_line" id="hidden_field_data_rg_orgao_emissor" style="<?php echo $sStyleHidden_rg_orgao_emissor; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rg_orgao_emissor_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rg_orgao_emissor_label"><span id="id_label_rg_orgao_emissor"><?php echo $this->nm_new_label['rg_orgao_emissor']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rg_dt_emissao_line" id="hidden_field_data_rg_dt_emissao" style="<?php echo $sStyleHidden_rg_dt_emissao; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rg_dt_emissao_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rg_dt_emissao_label"><span id="id_label_rg_dt_emissao"><?php echo $this->nm_new_label['rg_dt_emissao']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_passaporte_line" id="hidden_field_data_passaporte" style="<?php echo $sStyleHidden_passaporte; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_passaporte_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_passaporte_label"><span id="id_label_passaporte"><?php echo $this->nm_new_label['passaporte']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_passaporte_pais_origem_line" id="hidden_field_data_passaporte_pais_origem" style="<?php echo $sStyleHidden_passaporte_pais_origem; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_passaporte_pais_origem_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_passaporte_pais_origem_label"><span id="id_label_passaporte_pais_origem"><?php echo $this->nm_new_label['passaporte_pais_origem']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cnh_line" id="hidden_field_data_cnh" style="<?php echo $sStyleHidden_cnh; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cnh_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cnh_label"><span id="id_label_cnh"><?php echo $this->nm_new_label['cnh']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cnh_categoria_line" id="hidden_field_data_cnh_categoria" style="<?php echo $sStyleHidden_cnh_categoria; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cnh_categoria_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cnh_categoria_label"><span id="id_label_cnh_categoria"><?php echo $this->nm_new_label['cnh_categoria']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cnh_dt_validade_line" id="hidden_field_data_cnh_dt_validade" style="<?php echo $sStyleHidden_cnh_dt_validade; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cnh_dt_validade_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cnh_dt_validade_label"><span id="id_label_cnh_dt_validade"><?php echo $this->nm_new_label['cnh_dt_validade']; ?></span></span><br>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
<?php
...
<script> 
<?php
 $NM_pag_atual = "form_public_pessoa_fisica_mob_form0";
 if (isset($this->nmgp_ancora) && $this->nmgp_ancora != "")
 {
     $NM_pag_atual = "form_public_pessoa_fisica_mob_form" . $this->nmgp_ancora;
 }
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_public_pessoa_fisica_mob");
 parent.scAjaxDetailHeight("form_public_pessoa_fisica_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
