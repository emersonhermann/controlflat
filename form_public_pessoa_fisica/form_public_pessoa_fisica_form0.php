...
<?php
include_once("form_public_pessoa_fisica_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_public_pessoa_fisica_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['recarga'];
}
?>
...
<?php
 include_once("form_public_pessoa_fisica_js0.php");
?>
<script type="text/javascript" src="<?php  echo $this->Ini->path_js . "/nm_rpc.js" ?>"> 
</script> 
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_public_pessoa_fisica'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_public_pessoa_fisica'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
?>
<script type="text/javascript">
var pag_ativa = "form_public_pessoa_fisica_form0";
</script>
<ul class="scTabLine">
<?php
    if (empty($nmgp_num_form) || $nmgp_num_form == "form_public_pessoa_fisica_form0")
    {
...
?>
   <li id="id_form_public_pessoa_fisica_form0" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_public_pessoa_fisica_form0')">
     Principal
    </a>
   </li>
<?php
    if ($nmgp_num_form == "form_public_pessoa_fisica_form1")
    {
        $css_celula = "scTabActive";
    }
    else
...
?>
   <li id="id_form_public_pessoa_fisica_form1" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_public_pessoa_fisica_form1')">
     Endereço
    </a>
   </li>
<?php
    if ($nmgp_num_form == "form_public_pessoa_fisica_form2")
    {
        $css_celula = "scTabActive";
    }
    else
...
?>
   <li id="id_form_public_pessoa_fisica_form2" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_public_pessoa_fisica_form2')">
     Endereço Cobrança
    </a>
   </li>
<?php
    if ($nmgp_num_form == "form_public_pessoa_fisica_form3")
    {
        $css_celula = "scTabActive";
    }
    else
...
?>
   <li id="id_form_public_pessoa_fisica_form3" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_public_pessoa_fisica_form3')">
     Documentos
    </a>
   </li>
</ul>
...
<div id="form_public_pessoa_fisica_form0" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_sexo'][] = ''; ?>
 <option value=""></option>
 <option value="M" <?php  if ($this->sexo == "M") { echo " selected" ;} ?>>M - Masculino</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_sexo'][] = 'M'; ?>
 <option value="F" <?php  if ($this->sexo == "F") { echo " selected" ;} ?>>F - Feminino</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_sexo'][] = 'F'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_dt_nasc_label" id="hidden_field_label_dt_nasc" style="<?php echo $sStyleHidden_dt_nasc; ?>"><span id="id_label_dt_nasc"><?php echo $this->nm_new_label['dt_nasc']; ?></span></TD>
    <TD class="scFormDataOdd css_dt_nasc_line" id="hidden_field_data_dt_nasc" style="<?php echo $sStyleHidden_dt_nasc; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dt_nasc_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nacionalidade_label" id="hidden_field_label_nacionalidade" style="<?php echo $sStyleHidden_nacionalidade; ?>"><span id="id_label_nacionalidade"><?php echo $this->nm_new_label['nacionalidade']; ?></span></TD>
    <TD class="scFormDataOdd css_nacionalidade_line" id="hidden_field_data_nacionalidade" style="<?php echo $sStyleHidden_nacionalidade; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nacionalidade_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_naturalidade_label" id="hidden_field_label_naturalidade" style="<?php echo $sStyleHidden_naturalidade; ?>"><span id="id_label_naturalidade"><?php echo $this->nm_new_label['naturalidade']; ?></span></TD>
    <TD class="scFormDataOdd css_naturalidade_line" id="hidden_field_data_naturalidade" style="<?php echo $sStyleHidden_naturalidade; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_naturalidade_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_tipo_estado_civil_label" id="hidden_field_label_id_tipo_estado_civil" style="<?php echo $sStyleHidden_id_tipo_estado_civil; ?>"><span id="id_label_id_tipo_estado_civil"><?php echo $this->nm_new_label['id_tipo_estado_civil']; ?></span></TD>
    <TD class="scFormDataOdd css_id_tipo_estado_civil_line" id="hidden_field_data_id_tipo_estado_civil" style="<?php echo $sStyleHidden_id_tipo_estado_civil; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_tipo_estado_civil_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_tipo_escolaridade_label" id="hidden_field_label_id_tipo_escolaridade" style="<?php echo $sStyleHidden_id_tipo_escolaridade; ?>"><span id="id_label_id_tipo_escolaridade"><?php echo $this->nm_new_label['id_tipo_escolaridade']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_tipo_sanguineo_label" id="hidden_field_label_id_tipo_sanguineo" style="<?php echo $sStyleHidden_id_tipo_sanguineo; ?>"><span id="id_label_id_tipo_sanguineo"><?php echo $this->nm_new_label['id_tipo_sanguineo']; ?></span></TD>
    <TD class="scFormDataOdd css_id_tipo_sanguineo_line" id="hidden_field_data_id_tipo_sanguineo" style="<?php echo $sStyleHidden_id_tipo_sanguineo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_tipo_sanguineo_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_profissao_label" id="hidden_field_label_profissao" style="<?php echo $sStyleHidden_profissao; ?>"><span id="id_label_profissao"><?php echo $this->nm_new_label['profissao']; ?></span></TD>
    <TD class="scFormDataOdd css_profissao_line" id="hidden_field_data_profissao" style="<?php echo $sStyleHidden_profissao; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_profissao_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_aposentado_label" id="hidden_field_label_aposentado" style="<?php echo $sStyleHidden_aposentado; ?>"><span id="id_label_aposentado"><?php echo $this->nm_new_label['aposentado']; ?></span></TD>
    <TD class="scFormDataOdd css_aposentado_line" id="hidden_field_data_aposentado" style="<?php echo $sStyleHidden_aposentado; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_aposentado_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_aposentado'][] = ''; ?>
 <option value=""></option>
 <option value="S" <?php  if ($this->aposentado == "S") { echo " selected" ;} ?>>S - Sim</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_aposentado'][] = 'S'; ?>
 <option value="N" <?php  if ($this->aposentado == "N") { echo " selected" ;} ?>>N - Não</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_aposentado'][] = 'N'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_ativo'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['Lookup_id_ativo'][] = '0'; ?>
