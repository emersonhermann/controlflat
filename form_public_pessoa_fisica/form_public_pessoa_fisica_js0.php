<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="id_pessoa_fisica" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_pessoa_fisica']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_public_pessoa_fisica"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_fisica']['where_detal']))
  {
?>  
...
function cep_cep(num_cep, campos_cep)
{
   ...
   jsrsExecute("form_public_pessoa_fisica_cep.php?cep=" + num_cep + "&onchange=s", recebe_cep, "cep", num_cep, false);
}
...
function cep_cep_cob(num_cep, campos_cep)
{
   retorno_cep  = campos_cep;
   jsrsExecute("form_public_pessoa_fisica_cep.php?cep=" + num_cep + "&onchange=s", recebe_cep_cob, "cep_cob", num_cep, false);
}
function recebe_cep_cob(string)
{
   if (string.substr(0, 3) == "nao")
   {
       alert ("<?php echo html_entity_decode($this->Ini->Nm_lang['lang_othr_cepn'], ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>");
...
{
    document.getElementById('form_public_pessoa_fisica_form0').style.width='1px';
    document.getElementById('form_public_pessoa_fisica_form0').style.height='0px';
    document.getElementById('form_public_pessoa_fisica_form0').style.display='none';
    document.getElementById('form_public_pessoa_fisica_form0').style.overflow='scroll';
    document.getElementById('form_public_pessoa_fisica_form1').style.width='1px';
    document.getElementById('form_public_pessoa_fisica_form1').style.height='0px';
    document.getElementById('form_public_pessoa_fisica_form1').style.display='none';
    document.getElementById('form_public_pessoa_fisica_form1').style.overflow='scroll';
    document.getElementById('form_public_pessoa_fisica_form2').style.width='1px';
    document.getElementById('form_public_pessoa_fisica_form2').style.height='0px';
    document.getElementById('form_public_pessoa_fisica_form2').style.display='none';
    document.getElementById('form_public_pessoa_fisica_form2').style.overflow='scroll';
    document.getElementById('form_public_pessoa_fisica_form3').style.width='1px';
    document.getElementById('form_public_pessoa_fisica_form3').style.height='0px';
    document.getElementById('form_public_pessoa_fisica_form3').style.display='none';
    document.getElementById('form_public_pessoa_fisica_form3').style.overflow='scroll';
