<div id="form_public_pessoa_fisica_form2" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_endereco_cob_label" id="hidden_field_label_endereco_cob" style="<?php echo $sStyleHidden_endereco_cob; ?>"><span id="id_label_endereco_cob"><?php echo $this->nm_new_label['endereco_cob']; ?></span></TD>
    <TD class="scFormDataOdd css_endereco_cob_line" id="hidden_field_data_endereco_cob" style="<?php echo $sStyleHidden_endereco_cob; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_endereco_cob_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_endereco_comp_cob_label" id="hidden_field_label_endereco_comp_cob" style="<?php echo $sStyleHidden_endereco_comp_cob; ?>"><span id="id_label_endereco_comp_cob"><?php echo $this->nm_new_label['endereco_comp_cob']; ?></span></TD>
    <TD class="scFormDataOdd css_endereco_comp_cob_line" id="hidden_field_data_endereco_comp_cob" style="<?php echo $sStyleHidden_endereco_comp_cob; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_endereco_comp_cob_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_bairro_cob_label" id="hidden_field_label_bairro_cob" style="<?php echo $sStyleHidden_bairro_cob; ?>"><span id="id_label_bairro_cob"><?php echo $this->nm_new_label['bairro_cob']; ?></span></TD>
    <TD class="scFormDataOdd css_bairro_cob_line" id="hidden_field_data_bairro_cob" style="<?php echo $sStyleHidden_bairro_cob; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_bairro_cob_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_municipio_cob_label" id="hidden_field_label_id_municipio_cob" style="<?php echo $sStyleHidden_id_municipio_cob; ?>"><span id="id_label_id_municipio_cob"><?php echo $this->nm_new_label['id_municipio_cob']; ?></span></TD>
    <TD class="scFormDataOdd css_id_municipio_cob_line" id="hidden_field_data_id_municipio_cob" style="<?php echo $sStyleHidden_id_municipio_cob; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_municipio_cob_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_uf_cob_label" id="hidden_field_label_id_uf_cob" style="<?php echo $sStyleHidden_id_uf_cob; ?>"><span id="id_label_id_uf_cob"><?php echo $this->nm_new_label['id_uf_cob']; ?></span></TD>
    <TD class="scFormDataOdd css_id_uf_cob_line" id="hidden_field_data_id_uf_cob" style="<?php echo $sStyleHidden_id_uf_cob; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_uf_cob_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_pais_cob_label" id="hidden_field_label_id_pais_cob" style="<?php echo $sStyleHidden_id_pais_cob; ?>"><span id="id_label_id_pais_cob"><?php echo $this->nm_new_label['id_pais_cob']; ?></span></TD>
    <TD class="scFormDataOdd css_id_pais_cob_line" id="hidden_field_data_id_pais_cob" style="<?php echo $sStyleHidden_id_pais_cob; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_pais_cob_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cep_cob_label" id="hidden_field_label_cep_cob" style="<?php echo $sStyleHidden_cep_cob; ?>"><span id="id_label_cep_cob"><?php echo $this->nm_new_label['cep_cob']; ?></span></TD>
    <TD class="scFormDataOdd css_cep_cob_line" id="hidden_field_data_cep_cob" style="<?php echo $sStyleHidden_cep_cob; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cep_cob_line" style="vertical-align: top;padding: 0px">
