...
function scFocusField(sField) {
  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'obs':
      case 'id_ativo':
        sc_exib_ocult_pag('form_public_pessoa_fisica_form0');
        break;
      case 'endereco':
      case 'endereco_comp':
      case 'bairro':
      ...
      case 'id_pais':
      case 'cep':
        sc_exib_ocult_pag('form_public_pessoa_fisica_form1');
        break;
      case 'endereco_cob':
      ...
      case 'id_pais_cob':
      case 'cep_cob':
        sc_exib_ocult_pag('form_public_pessoa_fisica_form2');
        break;
      case 'rg':
      case 'rg_uf_emissor':
      ...
      case 'cnh_dt_validade':
        sc_exib_ocult_pag('form_public_pessoa_fisica_form3');
        break;
    }
  }
