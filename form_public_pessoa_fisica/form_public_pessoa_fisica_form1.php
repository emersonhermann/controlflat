<div id="form_public_pessoa_fisica_form1" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_endereco_comp_label" id="hidden_field_label_endereco_comp" style="<?php echo $sStyleHidden_endereco_comp; ?>"><span id="id_label_endereco_comp"><?php echo $this->nm_new_label['endereco_comp']; ?></span></TD>
    <TD class="scFormDataOdd css_endereco_comp_line" id="hidden_field_data_endereco_comp" style="<?php echo $sStyleHidden_endereco_comp; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_endereco_comp_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_municipio_label" id="hidden_field_label_id_municipio" style="<?php echo $sStyleHidden_id_municipio; ?>"><span id="id_label_id_municipio"><?php echo $this->nm_new_label['id_municipio']; ?></span></TD>
    <TD class="scFormDataOdd css_id_municipio_line" id="hidden_field_data_id_municipio" style="<?php echo $sStyleHidden_id_municipio; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_municipio_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_uf_label" id="hidden_field_label_id_uf" style="<?php echo $sStyleHidden_id_uf; ?>"><span id="id_label_id_uf"><?php echo $this->nm_new_label['id_uf']; ?></span></TD>
    <TD class="scFormDataOdd css_id_uf_line" id="hidden_field_data_id_uf" style="<?php echo $sStyleHidden_id_uf; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_uf_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_pais_label" id="hidden_field_label_id_pais" style="<?php echo $sStyleHidden_id_pais; ?>"><span id="id_label_id_pais"><?php echo $this->nm_new_label['id_pais']; ?></span></TD>
...
<span id="id_read_on_cep" class="sc-ui-readonly-cep css_cep_line" style="<?php echo $sStyleReadLab_cep; ?>"><?php echo $this->form_encode_input($this->cep); ?></span><span id="id_read_off_cep" style="white-space: nowrap;<?php echo $sStyleReadInp_cep; ?>">
 ...
 size=17 alt="{datatype: 'cep', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}">&nbsp;<?php echo nmButtonOutput($this->arr_buttons, "bzipcode", "tb_show('', '" . $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . SC_dir_app_name('form_public_pessoa_fisica'). "/form_public_pessoa_fisica_cep.php?cep=' + document.F1.cep.value + '&form_origem=F1;CEP,cep&TB_iframe=true&height=220&width=350&modal=true', '')", "tb_show('', '" . $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . SC_dir_app_name('form_public_pessoa_fisica'). "/form_public_pessoa_fisica_cep.php?cep=' + document.F1.cep.value + '&form_origem=F1;CEP,cep&TB_iframe=true&height=220&width=350&modal=true', '')", "cep_cep", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
