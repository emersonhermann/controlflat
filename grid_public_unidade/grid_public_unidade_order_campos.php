<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_public_unidade_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_public_unidade_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['id_unidade'] = "on";
   $tab_def_campos['id_unidade'] = "id_unidade";
   $tab_converte["id_unidade"]   = "id_unidade";
   $tab_labels["id_unidade"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_unidade']['labels']["id_unidade"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_unidade']['labels']["id_unidade"] : "Id Unidade";
   $tab_ger_campos['ds_unidade'] = "on";
   $tab_def_campos['ds_unidade'] = "ds_unidade";
   $tab_converte["ds_unidade"]   = "ds_unidade";
   $tab_labels["ds_unidade"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_unidade']['labels']["ds_unidade"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_unidade']['labels']["ds_unidade"] : "Ds Unidade";
   $tab_ger_campos['ds_unidade_antiga'] = "on";
   $tab_def_campos['ds_unidade_antiga'] = "ds_unidade_antiga";
   $tab_converte["ds_unidade_antiga"]   = "ds_unidade_antiga";
   $tab_labels["ds_unidade_antiga"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_unidade']['labels']["ds_unidade_antiga"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_unidade']['labels']["ds_unidade_antiga"] : "Ds Unidade Antiga";
   $tab_ger_campos['cd_unidade'] = "on";
   $tab_def_campos['cd_unidade'] = "cd_unidade";
   $tab_converte["cd_unidade"]   = "cd_unidade";
   $tab_labels["cd_unidade"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_unidade']['labels']["cd_unidade"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_unidade']['labels']["cd_unidade"] : "Cd Unidade";
   $tab_ger_campos['ds_unidade_compl'] = "on";
   $tab_def_campos['ds_unidade_compl'] = "ds_unidade_compl";
   $tab_converte["ds_unidade_compl"]   = "ds_unidade_compl";
   $tab_labels["ds_unidade_compl"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_unidade']['labels']["ds_unidade_compl"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_unidade']['labels']["ds_unidade_compl"] : "Ds Unidade Compl";
   $tab_ger_campos['id_bloco'] = "on";
   $tab_def_campos['id_bloco'] = "id_bloco";
   $tab_converte["id_bloco"]   = "id_bloco";
   $tab_labels["id_bloco"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_unidade']['labels']["id_bloco"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_unidade']['labels']["id_bloco"] : "Id Bloco";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_public_unidade']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_public_unidade']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_public_unidade']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_public_unidade']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_public_unidade']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_public_unidade']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_public_unidade']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_public_unidade']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_public_unidade']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Unidade</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_public_unidade_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_public_unidade']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_public_unidade']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
