...
class grid_public_unidade_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function grid_public_unidade_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_public_unidade_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_public_unidade_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_public_unidade_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_cd_unidade')
      {
          $cd_unidade = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_cd_unidade($cd_unidade);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_id_unidade')
      {
          $id_unidade = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_id_unidade($id_unidade);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
      ...
      if ($this->NM_ajax_opcao == 'autocomp_ds_unidade')
      {
          $ds_unidade = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_ds_unidade($ds_unidade);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
      ...
      if ($this->NM_ajax_opcao == 'autocomp_ds_unidade_antiga')
      {
          $ds_unidade_antiga = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_ds_unidade_antiga($ds_unidade_antiga);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_cd_unidade($cd_unidade)
   {
      $cd_unidade = substr($this->Db->qstr($cd_unidade), 1, -1);
            $cd_unidade_look = substr($this->Db->qstr($cd_unidade), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct cd_unidade from " . $this->Ini->nm_tabela . " where  cd_unidade like '%" . $cd_unidade . "%'"; 
   ...
   function lookup_ajax_id_unidade($id_unidade)
   {
      $id_unidade = substr($this->Db->qstr($id_unidade), 1, -1);
            $id_unidade_look = substr($this->Db->qstr($id_unidade), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id_unidade from " . $this->Ini->nm_tabela . " where   CAST (id_unidade AS TEXT)  like '%" . $id_unidade . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct id_unidade from " . $this->Ini->nm_tabela . " where  id_unidade like '%" . $id_unidade . "%'"; 
      }
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_ds_unidade($ds_unidade)
   {
      $ds_unidade = substr($this->Db->qstr($ds_unidade), 1, -1);
            $ds_unidade_look = substr($this->Db->qstr($ds_unidade), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct ds_unidade from " . $this->Ini->nm_tabela . " where  ds_unidade like '%" . $ds_unidade . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_ds_unidade_antiga($ds_unidade_antiga)
   {
      $ds_unidade_antiga = substr($this->Db->qstr($ds_unidade_antiga), 1, -1);
            $ds_unidade_antiga_look = substr($this->Db->qstr($ds_unidade_antiga), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct ds_unidade_antiga from " . $this->Ini->nm_tabela . " where  ds_unidade_antiga like '%" . $ds_unidade_antiga . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Unidade</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_public_unidade/grid_public_unidade_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_public_unidade_ajax_search.js"></script>
 <script type="text/javascript" src="grid_public_unidade_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_cd_unidade_cond#NMF#' + search_get_sel_txt('SC_cd_unidade_cond') + '@NMF@';
  str_out += 'SC_cd_unidade#NMF#' + search_get_text('SC_cd_unidade') + '@NMF@';
  str_out += 'id_ac_cd_unidade#NMF#' + search_get_text('id_ac_cd_unidade') + '@NMF@';
  str_out += 'SC_id_unidade_cond#NMF#' + search_get_sel_txt('SC_id_unidade_cond') + '@NMF@';
  str_out += 'SC_id_unidade#NMF#' + search_get_text('SC_id_unidade') + '@NMF@';
  str_out += 'id_ac_id_unidade#NMF#' + search_get_text('id_ac_id_unidade') + '@NMF@';
  str_out += 'SC_id_unidade_input_2#NMF#' + search_get_text('SC_id_unidade_input_2') + '@NMF@';
  str_out += 'SC_ds_unidade_cond#NMF#' + search_get_sel_txt('SC_ds_unidade_cond') + '@NMF@';
  str_out += 'SC_ds_unidade#NMF#' + search_get_text('SC_ds_unidade') + '@NMF@';
  str_out += 'id_ac_ds_unidade#NMF#' + search_get_text('id_ac_ds_unidade') + '@NMF@';
  str_out += 'SC_ds_unidade_antiga_cond#NMF#' + search_get_sel_txt('SC_ds_unidade_antiga_cond') + '@NMF@';
  str_out += 'SC_ds_unidade_antiga#NMF#' + search_get_text('SC_ds_unidade_antiga') + '@NMF@';
  str_out += 'id_ac_ds_unidade_antiga#NMF#' + search_get_text('id_ac_ds_unidade_antiga') + '@NMF@';
   ...
   $("#id_ac_id_unidade").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_id_unidade",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_id_unidade").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_id_unidade").val( $(this).val() );
       }
     }
   });
   $("#id_ac_ds_unidade").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_ds_unidade",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_ds_unidade").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_ds_unidade").val( $(this).val() );
       }
     }
   });
   $("#id_ac_ds_unidade_antiga").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_ds_unidade_antiga",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_ds_unidade_antiga").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_ds_unidade_antiga").val( $(this).val() );
       }
     }
   });
   $("#id_ac_cd_unidade").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_cd_unidade",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_cd_unidade").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_cd_unidade").val( $(this).val() );
       }
     }
   });
 });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Unidade</span></td>
...
<?php
   ...
   {
      global 
             $cd_unidade_cond, $cd_unidade, $cd_unidade_autocomp,
             $id_unidade_cond, $id_unidade, $id_unidade_input_2, $id_unidade_autocomp,
             $ds_unidade_cond, $ds_unidade, $ds_unidade_autocomp,
             $ds_unidade_antiga_cond, $ds_unidade_antiga, $ds_unidade_antiga_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $cd_unidade = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['campos_busca']['cd_unidade']; 
          $cd_unidade_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['campos_busca']['cd_unidade_cond']; 
          $id_unidade = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['campos_busca']['id_unidade']; 
          $id_unidade_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['campos_busca']['id_unidade_input_2']; 
          $id_unidade_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['campos_busca']['id_unidade_cond']; 
          $ds_unidade = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['campos_busca']['ds_unidade']; 
          $ds_unidade_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['campos_busca']['ds_unidade_cond']; 
          $ds_unidade_antiga = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['campos_busca']['ds_unidade_antiga']; 
          $ds_unidade_antiga_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['campos_busca']['ds_unidade_antiga_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['campos_busca']['NM_operador']; 
      } 
      if (!isset($cd_unidade_cond) || empty($cd_unidade_cond))
      {
         $cd_unidade_cond = "qp";
      }
      if (!isset($id_unidade_cond) || empty($id_unidade_cond))
      {
         $id_unidade_cond = "gt";
      }
      if (!isset($ds_unidade_cond) || empty($ds_unidade_cond))
      {
         $ds_unidade_cond = "qp";
      }
      if (!isset($ds_unidade_antiga_cond) || empty($ds_unidade_antiga_cond))
      {
         $ds_unidade_antiga_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_cd_unidade = (in_array($cd_unidade_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_id_unidade = (in_array($id_unidade_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_ds_unidade = (in_array($ds_unidade_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_ds_unidade_antiga = (in_array($ds_unidade_antiga_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_id_unidade = ('bw' == $id_unidade_cond) ? $display_aberto : $display_fechado;

      if (!isset($cd_unidade) || $cd_unidade == "")
      {
          $cd_unidade = "";
      }
      if (isset($cd_unidade) && !empty($cd_unidade))
      {
         $tmp_pos = strpos($cd_unidade, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $cd_unidade = substr($cd_unidade, 0, $tmp_pos);
         }
      }
      if (!isset($id_unidade) || $id_unidade == "")
      {
          $id_unidade = "";
      }
      if (isset($id_unidade) && !empty($id_unidade))
      {
         $tmp_pos = strpos($id_unidade, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_unidade = substr($id_unidade, 0, $tmp_pos);
         }
      }
      if (!isset($ds_unidade) || $ds_unidade == "")
      {
          $ds_unidade = "";
      }
      if (isset($ds_unidade) && !empty($ds_unidade))
      {
         $tmp_pos = strpos($ds_unidade, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $ds_unidade = substr($ds_unidade, 0, $tmp_pos);
         }
      }
      if (!isset($ds_unidade_antiga) || $ds_unidade_antiga == "")
      {
          $ds_unidade_antiga = "";
      }
      if (isset($ds_unidade_antiga) && !empty($ds_unidade_antiga))
      {
         $tmp_pos = strpos($ds_unidade_antiga, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $ds_unidade_antiga = substr($ds_unidade_antiga, 0, $tmp_pos);
         }
      }
?>
 <?php
...
<?php
   if (is_file("grid_public_unidade_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['cd_unidade'])) ? $this->New_label['cd_unidade'] : "Cd Unidade"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_cd_unidade_cond" name="cd_unidade_cond" onChange="nm_campos_between(document.getElementById('id_vis_cd_unidade'), this, 'cd_unidade')">
       <OPTION value="qp" <?php if ("qp" == $cd_unidade_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $cd_unidade_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $cd_unidade_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $cd_unidade_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cd_unidade" <?php echo $str_hide_cd_unidade?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['cd_unidade'])) ? $this->New_label['cd_unidade'] : "Cd Unidade";
 $nmgp_tab_label .= "cd_unidade?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $cd_unidade_look = substr($this->Db->qstr($cd_unidade), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct cd_unidade from " . $this->Ini->nm_tabela . " where cd_unidade = '$cd_unidade_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$cd_unidade]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$cd_unidade];
      }
      else
      {
          $sAutocompValue = $cd_unidade;
      }
?>
<INPUT  type="text" id="SC_cd_unidade" name="cd_unidade" value="<?php echo NM_encode_input($cd_unidade) ?>" size=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_cd_unidade" name="cd_unidade_autocomp" size="10" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['id_unidade'])) ? $this->New_label['id_unidade'] : "Id Unidade"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_id_unidade_cond" name="id_unidade_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_unidade'), this, 'id_unidade')">
       <OPTION value="gt" <?php if ("gt" == $id_unidade_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_unidade_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_unidade_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $id_unidade_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_unidade" <?php echo $str_hide_id_unidade?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['id_unidade'])) ? $this->New_label['id_unidade'] : "Id Unidade";
 $nmgp_tab_label .= "id_unidade?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $id_unidade_look = substr($this->Db->qstr($id_unidade), 1, -1); 
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id_unidade from " . $this->Ini->nm_tabela . " where id_unidade = $id_unidade_look"; 
      }
      else
      {
          $nm_comando = "select distinct id_unidade from " . $this->Ini->nm_tabela . " where id_unidade = $id_unidade_look"; 
      ...
      if (isset($nmgp_def_dados[0][$id_unidade]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$id_unidade];
      }
      else
      {
          $sAutocompValue = $id_unidade;
      }
?>
<INPUT  type="text" id="SC_id_unidade" name="id_unidade" value="<?php echo NM_encode_input($id_unidade) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_id_unidade" name="id_unidade_autocomp" size="9" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_id_unidade"  <?php echo $str_display_id_unidade; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_unidade_input_2" name="id_unidade_input_2" value="<?php echo NM_encode_input($id_unidade_input_2) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['ds_unidade'])) ? $this->New_label['ds_unidade'] : "Ds Unidade"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_ds_unidade_cond" name="ds_unidade_cond" onChange="nm_campos_between(document.getElementById('id_vis_ds_unidade'), this, 'ds_unidade')">
       <OPTION value="qp" <?php if ("qp" == $ds_unidade_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $ds_unidade_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $ds_unidade_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $ds_unidade_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ds_unidade" <?php echo $str_hide_ds_unidade?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['ds_unidade'])) ? $this->New_label['ds_unidade'] : "Ds Unidade";
 $nmgp_tab_label .= "ds_unidade?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $ds_unidade_look = substr($this->Db->qstr($ds_unidade), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct ds_unidade from " . $this->Ini->nm_tabela . " where ds_unidade = '$ds_unidade_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$ds_unidade]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$ds_unidade];
      }
      else
      {
          $sAutocompValue = $ds_unidade;
      }
?>
<INPUT  type="text" id="SC_ds_unidade" name="ds_unidade" value="<?php echo NM_encode_input($ds_unidade) ?>" size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_ds_unidade" name="ds_unidade_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['ds_unidade_antiga'])) ? $this->New_label['ds_unidade_antiga'] : "Ds Unidade Antiga"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_ds_unidade_antiga_cond" name="ds_unidade_antiga_cond" onChange="nm_campos_between(document.getElementById('id_vis_ds_unidade_antiga'), this, 'ds_unidade_antiga')">
       <OPTION value="qp" <?php if ("qp" == $ds_unidade_antiga_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $ds_unidade_antiga_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $ds_unidade_antiga_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $ds_unidade_antiga_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ds_unidade_antiga" <?php echo $str_hide_ds_unidade_antiga?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['ds_unidade_antiga'])) ? $this->New_label['ds_unidade_antiga'] : "Ds Unidade Antiga";
 $nmgp_tab_label .= "ds_unidade_antiga?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $ds_unidade_antiga_look = substr($this->Db->qstr($ds_unidade_antiga), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct ds_unidade_antiga from " . $this->Ini->nm_tabela . " where ds_unidade_antiga = '$ds_unidade_antiga_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$ds_unidade_antiga]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$ds_unidade_antiga];
      }
      else
      {
          $sAutocompValue = $ds_unidade_antiga;
      }
?>
<INPUT  type="text" id="SC_ds_unidade_antiga" name="ds_unidade_antiga" value="<?php echo NM_encode_input($ds_unidade_antiga) ?>" size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_ds_unidade_antiga" name="ds_unidade_antiga_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_public_unidade']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_public_unidade']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_cd_unidade'), document.F1.cd_unidade_cond, 'cd_unidade');
   document.F1.cd_unidade.value = "";
   document.F1.cd_unidade_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_id_unidade'), document.F1.id_unidade_cond, 'id_unidade');
   document.F1.id_unidade.value = "";
   document.F1.id_unidade_autocomp.value = "";
   document.F1.id_unidade_input_2.value = "";
   nm_campos_between(document.getElementById('id_vis_ds_unidade'), document.F1.ds_unidade_cond, 'ds_unidade');
   document.F1.ds_unidade.value = "";
   document.F1.ds_unidade_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_ds_unidade_antiga'), document.F1.ds_unidade_antiga_cond, 'ds_unidade_antiga');
   document.F1.ds_unidade_antiga.value = "";
   document.F1.ds_unidade_antiga_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "SYS_CONTROLFLAT/grid_public_unidade";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_cd_unidade_cond'] = 'cond';
      $tp_fields['SC_cd_unidade'] = 'text_aut';
      $tp_fields['id_ac_cd_unidade'] = 'text_aut';
      $tp_fields['SC_id_unidade_cond'] = 'cond';
      $tp_fields['SC_id_unidade'] = 'text_aut';
      $tp_fields['id_ac_id_unidade'] = 'text_aut';
      $tp_fields['SC_id_unidade_input_2'] = 'text';
      $tp_fields['SC_ds_unidade_cond'] = 'cond';
      $tp_fields['SC_ds_unidade'] = 'text_aut';
      $tp_fields['id_ac_ds_unidade'] = 'text_aut';
      $tp_fields['SC_ds_unidade_antiga_cond'] = 'cond';
      $tp_fields['SC_ds_unidade_antiga'] = 'text_aut';
      $tp_fields['id_ac_ds_unidade_antiga'] = 'text_aut';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $cd_unidade_cond, $cd_unidade, $cd_unidade_autocomp,
             $id_unidade_cond, $id_unidade, $id_unidade_input_2, $id_unidade_autocomp,
             $ds_unidade_cond, $ds_unidade, $ds_unidade_autocomp,
             $ds_unidade_antiga_cond, $ds_unidade_antiga, $ds_unidade_antiga_autocomp, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($cd_unidade_autocomp) && empty($cd_unidade))
      {
          $cd_unidade = $cd_unidade_autocomp;
      }
      if (!empty($id_unidade_autocomp) && empty($id_unidade))
      {
          $id_unidade = $id_unidade_autocomp;
      }
      if (!empty($ds_unidade_autocomp) && empty($ds_unidade))
      {
          $ds_unidade = $ds_unidade_autocomp;
      }
      if (!empty($ds_unidade_antiga_autocomp) && empty($ds_unidade_antiga))
      {
          $ds_unidade_antiga = $ds_unidade_antiga_autocomp;
      }
      $cd_unidade_cond_salva = $cd_unidade_cond; 
      if (!isset($cd_unidade_input_2) || $cd_unidade_input_2 == "")
      {
          $cd_unidade_input_2 = $cd_unidade;
      }
      $id_unidade_cond_salva = $id_unidade_cond; 
      if (!isset($id_unidade_input_2) || $id_unidade_input_2 == "")
      {
          $id_unidade_input_2 = $id_unidade;
      }
      $ds_unidade_cond_salva = $ds_unidade_cond; 
      if (!isset($ds_unidade_input_2) || $ds_unidade_input_2 == "")
      {
          $ds_unidade_input_2 = $ds_unidade;
      }
      $ds_unidade_antiga_cond_salva = $ds_unidade_antiga_cond; 
      if (!isset($ds_unidade_antiga_input_2) || $ds_unidade_antiga_input_2 == "")
      {
          $ds_unidade_antiga_input_2 = $ds_unidade_antiga;
      }
      if ($id_unidade_cond != "in")
      {
          nm_limpa_numero($id_unidade, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $id_unidade);
          ...
          $id_unidade = implode(",", $Nm_sc_valores);
      }
      if ($id_unidade_cond != "in")
      {
          nm_limpa_numero($id_unidade_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['campos_busca']['cd_unidade'] = $cd_unidade; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['campos_busca']['cd_unidade_cond'] = $cd_unidade_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['campos_busca']['id_unidade'] = $id_unidade; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['campos_busca']['id_unidade_input_2'] = $id_unidade_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['campos_busca']['id_unidade_cond'] = $id_unidade_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['campos_busca']['ds_unidade'] = $ds_unidade; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['campos_busca']['ds_unidade_cond'] = $ds_unidade_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['campos_busca']['ds_unidade_antiga'] = $ds_unidade_antiga; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['campos_busca']['ds_unidade_antiga_cond'] = $ds_unidade_antiga_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($id_unidade_cond != "in" && $id_unidade_cond != "bw" && !empty($id_unidade) && !is_numeric($id_unidade))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Id Unidade";
      }
      if ($id_unidade_cond == "bw" && ((!empty($id_unidade) && !is_numeric($id_unidade)) || (!empty($id_unidade_input_2) && !is_numeric($id_unidade_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Id Unidade";
      }
      if (!empty($this->Campos_Mens_erro)) 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['cd_unidade'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['cd_unidade'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['cd_unidade'] = $cd_unidade;
      }
      $id_unidade_look = substr($this->Db->qstr($id_unidade), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($id_unidade))
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['id_unidade'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['id_unidade'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['id_unidade'] = $id_unidade;
      }
      $Conteudo = $id_unidade_input_2;
      if (strtoupper($id_unidade_cond) != "II" && strtoupper($id_unidade_cond) != "QP" && strtoupper($id_unidade_cond) != "NP" && strtoupper($id_unidade_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['id_unidade_input_2'] = $Conteudo;
      $ds_unidade_look = substr($this->Db->qstr($ds_unidade), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct ds_unidade from " . $this->Ini->nm_tabela . " where ds_unidade = '$ds_unidade_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['ds_unidade'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['ds_unidade'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['ds_unidade'] = $ds_unidade;
      }
      $ds_unidade_antiga_look = substr($this->Db->qstr($ds_unidade_antiga), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct ds_unidade_antiga from " . $this->Ini->nm_tabela . " where ds_unidade_antiga = '$ds_unidade_antiga_look'"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['ds_unidade_antiga'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['ds_unidade_antiga'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['ds_unidade_antiga'] = $ds_unidade_antiga;
      }

      //----- $cd_unidade
      $this->Date_part = false;
      if (isset($cd_unidade) || $cd_unidade_cond == "nu" || $cd_unidade_cond == "nn" || $cd_unidade_cond == "ep" || $cd_unidade_cond == "ne")
      {
         $this->monta_condicao("cd_unidade", $cd_unidade_cond, $cd_unidade, "", "cd_unidade");
      }

      //----- $id_unidade
      $this->Date_part = false;
      if (isset($id_unidade) || $id_unidade_cond == "nu" || $id_unidade_cond == "nn" || $id_unidade_cond == "ep" || $id_unidade_cond == "ne")
      {
         $this->monta_condicao("id_unidade", $id_unidade_cond, $id_unidade, $id_unidade_input_2, "id_unidade");
      }

      //----- $ds_unidade
      $this->Date_part = false;
      if (isset($ds_unidade) || $ds_unidade_cond == "nu" || $ds_unidade_cond == "nn" || $ds_unidade_cond == "ep" || $ds_unidade_cond == "ne")
      {
         $this->monta_condicao("ds_unidade", $ds_unidade_cond, $ds_unidade, "", "ds_unidade");
      }

      //----- $ds_unidade_antiga
      $this->Date_part = false;
      if (isset($ds_unidade_antiga) || $ds_unidade_antiga_cond == "nu" || $ds_unidade_antiga_cond == "nn" || $ds_unidade_antiga_cond == "ep" || $ds_unidade_antiga_cond == "ne")
      {
         $this->monta_condicao("ds_unidade_antiga", $ds_unidade_antiga_cond, $ds_unidade_antiga, "", "ds_unidade_antiga");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_unidade']['where_pesq_ant'] = $this->comando . $this->comando_fim;
