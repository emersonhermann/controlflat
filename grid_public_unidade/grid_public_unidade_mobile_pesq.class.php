...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "dt_cadastro";$Nm_datas[] = "dt_atualiza";$Nm_numeric[] = "id_unidade";$Nm_numeric[] = "id_bloco";$Nm_numeric[] = "andar";$Nm_numeric[] = "id_pessoa_fisica";$Nm_numeric[] = "id_pessoa_juridica";$Nm_numeric[] = "id_tipo_vinculo";$Nm_numeric[] = "fracao";$Nm_numeric[] = "id_ativo";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_cd_unidade"  <?php echo $str_hide_cd_unidade?>><?php
      $cd_unidade_look = substr($this->Db->qstr($cd_unidade), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_id_unidade"  <?php echo $str_hide_id_unidade?>><?php
      $id_unidade_look = substr($this->Db->qstr($id_unidade), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_id_unidade" name="id_unidade_autocomp" size="9" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_id_unidade"  <?php echo $str_display_id_unidade; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_unidade_input_2" name="id_unidade_input_2" value="<?php echo NM_encode_input($id_unidade_input_2) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_ds_unidade"  <?php echo $str_hide_ds_unidade?>><?php
      $ds_unidade_look = substr($this->Db->qstr($ds_unidade), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_ds_unidade_antiga"  <?php echo $str_hide_ds_unidade_antiga?>><?php
      $ds_unidade_antiga_look = substr($this->Db->qstr($ds_unidade_antiga), 1, -1); 
      $nmgp_def_dados = array(); 
