...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SYS_CONTROLFLAT_____app_grid_sec_groups"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SYS_CONTROLFLAT_____app_grid_sec_groups"]);
   }
