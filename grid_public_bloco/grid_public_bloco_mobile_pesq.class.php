...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "dt_cadastro";$Nm_datas[] = "dt_atualiza";$Nm_numeric[] = "id_bloco";$Nm_numeric[] = "qt_andar";$Nm_numeric[] = "id_ativo";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_ds_obs"  <?php echo $str_hide_ds_obs?>><?php
      $ds_obs_look = substr($this->Db->qstr($ds_obs), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_id_bloco"  <?php echo $str_hide_id_bloco?>><?php
      $id_bloco_look = substr($this->Db->qstr($id_bloco), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_id_bloco" name="id_bloco_autocomp" size="9" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_id_bloco"  <?php echo $str_display_id_bloco; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_bloco_input_2" name="id_bloco_input_2" value="<?php echo NM_encode_input($id_bloco_input_2) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_ds_bloco"  <?php echo $str_hide_ds_bloco?>><?php
      $ds_bloco_look = substr($this->Db->qstr($ds_bloco), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_ds_apelido"  <?php echo $str_hide_ds_apelido?>><?php
      $ds_apelido_look = substr($this->Db->qstr($ds_apelido), 1, -1); 
      $nmgp_def_dados = array(); 
