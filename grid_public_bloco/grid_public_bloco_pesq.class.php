...
class grid_public_bloco_pesq
{
    ...
    * @access  public
    */
   function grid_public_bloco_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_public_bloco_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_public_bloco_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_public_bloco_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_ds_obs')
      {
          $ds_obs = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_ds_obs($ds_obs);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_id_bloco')
      {
          $id_bloco = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_id_bloco($id_bloco);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
      ...
      if ($this->NM_ajax_opcao == 'autocomp_ds_bloco')
      {
          $ds_bloco = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_ds_bloco($ds_bloco);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
      ...
      if ($this->NM_ajax_opcao == 'autocomp_ds_apelido')
      {
          $ds_apelido = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_ds_apelido($ds_apelido);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_ds_obs($ds_obs)
   {
      $ds_obs = substr($this->Db->qstr($ds_obs), 1, -1);
            $ds_obs_look = substr($this->Db->qstr($ds_obs), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct ds_obs from " . $this->Ini->nm_tabela . " where  ds_obs like '%" . $ds_obs . "%'"; 
   ...
   function lookup_ajax_id_bloco($id_bloco)
   {
      $id_bloco = substr($this->Db->qstr($id_bloco), 1, -1);
            $id_bloco_look = substr($this->Db->qstr($id_bloco), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id_bloco from " . $this->Ini->nm_tabela . " where   CAST (id_bloco AS TEXT)  like '%" . $id_bloco . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct id_bloco from " . $this->Ini->nm_tabela . " where  id_bloco like '%" . $id_bloco . "%'"; 
      }
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_ds_bloco($ds_bloco)
   {
      $ds_bloco = substr($this->Db->qstr($ds_bloco), 1, -1);
            $ds_bloco_look = substr($this->Db->qstr($ds_bloco), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct ds_bloco from " . $this->Ini->nm_tabela . " where  ds_bloco like '%" . $ds_bloco . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_ds_apelido($ds_apelido)
   {
      $ds_apelido = substr($this->Db->qstr($ds_apelido), 1, -1);
            $ds_apelido_look = substr($this->Db->qstr($ds_apelido), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct ds_apelido from " . $this->Ini->nm_tabela . " where  ds_apelido like '%" . $ds_apelido . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Bloco</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_public_bloco/grid_public_bloco_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_public_bloco_ajax_search.js"></script>
 <script type="text/javascript" src="grid_public_bloco_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_ds_obs_cond#NMF#' + search_get_sel_txt('SC_ds_obs_cond') + '@NMF@';
  str_out += 'SC_ds_obs#NMF#' + search_get_text('SC_ds_obs') + '@NMF@';
  str_out += 'id_ac_ds_obs#NMF#' + search_get_text('id_ac_ds_obs') + '@NMF@';
  str_out += 'SC_id_bloco_cond#NMF#' + search_get_sel_txt('SC_id_bloco_cond') + '@NMF@';
  str_out += 'SC_id_bloco#NMF#' + search_get_text('SC_id_bloco') + '@NMF@';
  str_out += 'id_ac_id_bloco#NMF#' + search_get_text('id_ac_id_bloco') + '@NMF@';
  str_out += 'SC_id_bloco_input_2#NMF#' + search_get_text('SC_id_bloco_input_2') + '@NMF@';
  str_out += 'SC_ds_bloco_cond#NMF#' + search_get_sel_txt('SC_ds_bloco_cond') + '@NMF@';
  str_out += 'SC_ds_bloco#NMF#' + search_get_text('SC_ds_bloco') + '@NMF@';
  str_out += 'id_ac_ds_bloco#NMF#' + search_get_text('id_ac_ds_bloco') + '@NMF@';
  str_out += 'SC_ds_apelido_cond#NMF#' + search_get_sel_txt('SC_ds_apelido_cond') + '@NMF@';
  str_out += 'SC_ds_apelido#NMF#' + search_get_text('SC_ds_apelido') + '@NMF@';
  str_out += 'id_ac_ds_apelido#NMF#' + search_get_text('id_ac_ds_apelido') + '@NMF@';
   ...
   $("#id_ac_id_bloco").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_id_bloco",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_id_bloco").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_id_bloco").val( $(this).val() );
       }
     }
   });
   $("#id_ac_ds_bloco").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_ds_bloco",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_ds_bloco").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_ds_bloco").val( $(this).val() );
       }
     }
   });
   $("#id_ac_ds_apelido").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_ds_apelido",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_ds_apelido").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_ds_apelido").val( $(this).val() );
       }
     }
   });
   $("#id_ac_ds_obs").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_ds_obs",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_ds_obs").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_ds_obs").val( $(this).val() );
       }
     }
   });
 });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Bloco</span></td>
...
<?php
   ...
   {
      global 
             $ds_obs_cond, $ds_obs, $ds_obs_autocomp,
             $id_bloco_cond, $id_bloco, $id_bloco_input_2, $id_bloco_autocomp,
             $ds_bloco_cond, $ds_bloco, $ds_bloco_autocomp,
             $ds_apelido_cond, $ds_apelido, $ds_apelido_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $ds_obs = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['campos_busca']['ds_obs']; 
          $ds_obs_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['campos_busca']['ds_obs_cond']; 
          $id_bloco = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['campos_busca']['id_bloco']; 
          $id_bloco_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['campos_busca']['id_bloco_input_2']; 
          $id_bloco_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['campos_busca']['id_bloco_cond']; 
          $ds_bloco = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['campos_busca']['ds_bloco']; 
          $ds_bloco_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['campos_busca']['ds_bloco_cond']; 
          $ds_apelido = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['campos_busca']['ds_apelido']; 
          $ds_apelido_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['campos_busca']['ds_apelido_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['campos_busca']['NM_operador']; 
      } 
      if (!isset($ds_obs_cond) || empty($ds_obs_cond))
      {
         $ds_obs_cond = "qp";
      }
      if (!isset($id_bloco_cond) || empty($id_bloco_cond))
      {
         $id_bloco_cond = "gt";
      }
      if (!isset($ds_bloco_cond) || empty($ds_bloco_cond))
      {
         $ds_bloco_cond = "qp";
      }
      if (!isset($ds_apelido_cond) || empty($ds_apelido_cond))
      {
         $ds_apelido_cond = "qp";
      }
      ...
      $str_hide_ds_obs = (in_array($ds_obs_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_id_bloco = (in_array($id_bloco_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_ds_bloco = (in_array($ds_bloco_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_ds_apelido = (in_array($ds_apelido_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_id_bloco = ('bw' == $id_bloco_cond) ? $display_aberto : $display_fechado;

      if (!isset($ds_obs) || $ds_obs == "")
      {
          $ds_obs = "";
      }
      if (isset($ds_obs) && !empty($ds_obs))
      {
         $tmp_pos = strpos($ds_obs, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $ds_obs = substr($ds_obs, 0, $tmp_pos);
         }
      }
      if (!isset($id_bloco) || $id_bloco == "")
      {
          $id_bloco = "";
      }
      if (isset($id_bloco) && !empty($id_bloco))
      {
         $tmp_pos = strpos($id_bloco, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_bloco = substr($id_bloco, 0, $tmp_pos);
         }
      }
      if (!isset($ds_bloco) || $ds_bloco == "")
      {
          $ds_bloco = "";
      }
      if (isset($ds_bloco) && !empty($ds_bloco))
      {
         $tmp_pos = strpos($ds_bloco, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $ds_bloco = substr($ds_bloco, 0, $tmp_pos);
         }
      }
      if (!isset($ds_apelido) || $ds_apelido == "")
      {
          $ds_apelido = "";
      }
      if (isset($ds_apelido) && !empty($ds_apelido))
      {
         $tmp_pos = strpos($ds_apelido, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $ds_apelido = substr($ds_apelido, 0, $tmp_pos);
         }
      }
?>
 <?php
...
<?php
   if (is_file("grid_public_bloco_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['ds_obs'])) ? $this->New_label['ds_obs'] : "Ds Obs"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_ds_obs_cond" name="ds_obs_cond" onChange="nm_campos_between(document.getElementById('id_vis_ds_obs'), this, 'ds_obs')">
       <OPTION value="qp" <?php if ("qp" == $ds_obs_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $ds_obs_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $ds_obs_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $ds_obs_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ds_obs" <?php echo $str_hide_ds_obs?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['ds_obs'])) ? $this->New_label['ds_obs'] : "Ds Obs";
 $nmgp_tab_label .= "ds_obs?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $ds_obs_look = substr($this->Db->qstr($ds_obs), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct ds_obs from " . $this->Ini->nm_tabela . " where ds_obs = '$ds_obs_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$ds_obs]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$ds_obs];
      }
      else
      {
          $sAutocompValue = $ds_obs;
      }
?>
<INPUT  type="text" id="SC_ds_obs" name="ds_obs" value="<?php echo NM_encode_input($ds_obs) ?>" size=50 alt="{datatype: 'text', maxLength: 500, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_ds_obs" name="ds_obs_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['id_bloco'])) ? $this->New_label['id_bloco'] : "ID Bloco"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_id_bloco_cond" name="id_bloco_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_bloco'), this, 'id_bloco')">
       <OPTION value="gt" <?php if ("gt" == $id_bloco_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_bloco_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_bloco_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $id_bloco_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_bloco" <?php echo $str_hide_id_bloco?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['id_bloco'])) ? $this->New_label['id_bloco'] : "ID Bloco";
 $nmgp_tab_label .= "id_bloco?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $id_bloco_look = substr($this->Db->qstr($id_bloco), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($id_bloco))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id_bloco from " . $this->Ini->nm_tabela . " where id_bloco = $id_bloco_look"; 
      }
      else
      {
          $nm_comando = "select distinct id_bloco from " . $this->Ini->nm_tabela . " where id_bloco = $id_bloco_look"; 
      ...
      if (isset($nmgp_def_dados[0][$id_bloco]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$id_bloco];
      }
      else
      {
          $sAutocompValue = $id_bloco;
      }
?>
<INPUT  type="text" id="SC_id_bloco" name="id_bloco" value="<?php echo NM_encode_input($id_bloco) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_id_bloco" name="id_bloco_autocomp" size="9" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_id_bloco"  <?php echo $str_display_id_bloco; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_bloco_input_2" name="id_bloco_input_2" value="<?php echo NM_encode_input($id_bloco_input_2) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['ds_bloco'])) ? $this->New_label['ds_bloco'] : "Ds Bloco"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_ds_bloco_cond" name="ds_bloco_cond" onChange="nm_campos_between(document.getElementById('id_vis_ds_bloco'), this, 'ds_bloco')">
       <OPTION value="qp" <?php if ("qp" == $ds_bloco_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $ds_bloco_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $ds_bloco_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $ds_bloco_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ds_bloco" <?php echo $str_hide_ds_bloco?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['ds_bloco'])) ? $this->New_label['ds_bloco'] : "Ds Bloco";
 $nmgp_tab_label .= "ds_bloco?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $ds_bloco_look = substr($this->Db->qstr($ds_bloco), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct ds_bloco from " . $this->Ini->nm_tabela . " where ds_bloco = '$ds_bloco_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$ds_bloco]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$ds_bloco];
      }
      else
      {
          $sAutocompValue = $ds_bloco;
      }
?>
<INPUT  type="text" id="SC_ds_bloco" name="ds_bloco" value="<?php echo NM_encode_input($ds_bloco) ?>" size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_ds_bloco" name="ds_bloco_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['ds_apelido'])) ? $this->New_label['ds_apelido'] : "Ds Apelido"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_ds_apelido_cond" name="ds_apelido_cond" onChange="nm_campos_between(document.getElementById('id_vis_ds_apelido'), this, 'ds_apelido')">
       <OPTION value="qp" <?php if ("qp" == $ds_apelido_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $ds_apelido_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $ds_apelido_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $ds_apelido_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ds_apelido" <?php echo $str_hide_ds_apelido?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['ds_apelido'])) ? $this->New_label['ds_apelido'] : "Ds Apelido";
 $nmgp_tab_label .= "ds_apelido?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $ds_apelido_look = substr($this->Db->qstr($ds_apelido), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct ds_apelido from " . $this->Ini->nm_tabela . " where ds_apelido = '$ds_apelido_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$ds_apelido]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$ds_apelido];
      }
      else
      {
          $sAutocompValue = $ds_apelido;
      }
?>
<INPUT  type="text" id="SC_ds_apelido" name="ds_apelido" value="<?php echo NM_encode_input($ds_apelido) ?>" size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_ds_apelido" name="ds_apelido_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_public_bloco']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_public_bloco']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_ds_obs'), document.F1.ds_obs_cond, 'ds_obs');
   document.F1.ds_obs.value = "";
   document.F1.ds_obs_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_id_bloco'), document.F1.id_bloco_cond, 'id_bloco');
   document.F1.id_bloco.value = "";
   document.F1.id_bloco_autocomp.value = "";
   document.F1.id_bloco_input_2.value = "";
   nm_campos_between(document.getElementById('id_vis_ds_bloco'), document.F1.ds_bloco_cond, 'ds_bloco');
   document.F1.ds_bloco.value = "";
   document.F1.ds_bloco_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_ds_apelido'), document.F1.ds_apelido_cond, 'ds_apelido');
   document.F1.ds_apelido.value = "";
   document.F1.ds_apelido_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "SYS_CONTROLFLAT/grid_public_bloco";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_ds_obs_cond'] = 'cond';
      $tp_fields['SC_ds_obs'] = 'text_aut';
      $tp_fields['id_ac_ds_obs'] = 'text_aut';
      $tp_fields['SC_id_bloco_cond'] = 'cond';
      $tp_fields['SC_id_bloco'] = 'text_aut';
      $tp_fields['id_ac_id_bloco'] = 'text_aut';
      $tp_fields['SC_id_bloco_input_2'] = 'text';
      $tp_fields['SC_ds_bloco_cond'] = 'cond';
      $tp_fields['SC_ds_bloco'] = 'text_aut';
      $tp_fields['id_ac_ds_bloco'] = 'text_aut';
      $tp_fields['SC_ds_apelido_cond'] = 'cond';
      $tp_fields['SC_ds_apelido'] = 'text_aut';
      $tp_fields['id_ac_ds_apelido'] = 'text_aut';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $ds_obs_cond, $ds_obs, $ds_obs_autocomp,
             $id_bloco_cond, $id_bloco, $id_bloco_input_2, $id_bloco_autocomp,
             $ds_bloco_cond, $ds_bloco, $ds_bloco_autocomp,
             $ds_apelido_cond, $ds_apelido, $ds_apelido_autocomp, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($ds_obs_autocomp) && empty($ds_obs))
      {
          $ds_obs = $ds_obs_autocomp;
      }
      if (!empty($id_bloco_autocomp) && empty($id_bloco))
      {
          $id_bloco = $id_bloco_autocomp;
      }
      if (!empty($ds_bloco_autocomp) && empty($ds_bloco))
      {
          $ds_bloco = $ds_bloco_autocomp;
      }
      if (!empty($ds_apelido_autocomp) && empty($ds_apelido))
      {
          $ds_apelido = $ds_apelido_autocomp;
      }
      $ds_obs_cond_salva = $ds_obs_cond; 
      if (!isset($ds_obs_input_2) || $ds_obs_input_2 == "")
      {
          $ds_obs_input_2 = $ds_obs;
      }
      $id_bloco_cond_salva = $id_bloco_cond; 
      if (!isset($id_bloco_input_2) || $id_bloco_input_2 == "")
      {
          $id_bloco_input_2 = $id_bloco;
      }
      $ds_bloco_cond_salva = $ds_bloco_cond; 
      if (!isset($ds_bloco_input_2) || $ds_bloco_input_2 == "")
      {
          $ds_bloco_input_2 = $ds_bloco;
      }
      $ds_apelido_cond_salva = $ds_apelido_cond; 
      if (!isset($ds_apelido_input_2) || $ds_apelido_input_2 == "")
      {
          $ds_apelido_input_2 = $ds_apelido;
      }
      if ($id_bloco_cond != "in")
      {
          nm_limpa_numero($id_bloco, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $id_bloco);
          ...
          $id_bloco = implode(",", $Nm_sc_valores);
      }
      if ($id_bloco_cond != "in")
      {
          nm_limpa_numero($id_bloco_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['campos_busca']['ds_obs'] = $ds_obs; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['campos_busca']['ds_obs_cond'] = $ds_obs_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['campos_busca']['id_bloco'] = $id_bloco; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['campos_busca']['id_bloco_input_2'] = $id_bloco_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['campos_busca']['id_bloco_cond'] = $id_bloco_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['campos_busca']['ds_bloco'] = $ds_bloco; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['campos_busca']['ds_bloco_cond'] = $ds_bloco_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['campos_busca']['ds_apelido'] = $ds_apelido; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['campos_busca']['ds_apelido_cond'] = $ds_apelido_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($id_bloco_cond != "in" && $id_bloco_cond != "bw" && !empty($id_bloco) && !is_numeric($id_bloco))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : ID Bloco";
      }
      if ($id_bloco_cond == "bw" && ((!empty($id_bloco) && !is_numeric($id_bloco)) || (!empty($id_bloco_input_2) && !is_numeric($id_bloco_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : ID Bloco";
      }
      if (!empty($this->Campos_Mens_erro)) 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['ds_obs'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['ds_obs'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['ds_obs'] = $ds_obs;
      }
      $id_bloco_look = substr($this->Db->qstr($id_bloco), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($id_bloco))
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['id_bloco'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['id_bloco'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['id_bloco'] = $id_bloco;
      }
      $Conteudo = $id_bloco_input_2;
      if (strtoupper($id_bloco_cond) != "II" && strtoupper($id_bloco_cond) != "QP" && strtoupper($id_bloco_cond) != "NP" && strtoupper($id_bloco_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['id_bloco_input_2'] = $Conteudo;
      $ds_bloco_look = substr($this->Db->qstr($ds_bloco), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct ds_bloco from " . $this->Ini->nm_tabela . " where ds_bloco = '$ds_bloco_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['ds_bloco'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['ds_bloco'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['ds_bloco'] = $ds_bloco;
      }
      $ds_apelido_look = substr($this->Db->qstr($ds_apelido), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct ds_apelido from " . $this->Ini->nm_tabela . " where ds_apelido = '$ds_apelido_look'"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['ds_apelido'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['ds_apelido'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['ds_apelido'] = $ds_apelido;
      }

      //----- $ds_obs
      $this->Date_part = false;
      if (isset($ds_obs) || $ds_obs_cond == "nu" || $ds_obs_cond == "nn" || $ds_obs_cond == "ep" || $ds_obs_cond == "ne")
      {
         $this->monta_condicao("ds_obs", $ds_obs_cond, $ds_obs, "", "ds_obs");
      }

      //----- $id_bloco
      $this->Date_part = false;
      if (isset($id_bloco) || $id_bloco_cond == "nu" || $id_bloco_cond == "nn" || $id_bloco_cond == "ep" || $id_bloco_cond == "ne")
      {
         $this->monta_condicao("id_bloco", $id_bloco_cond, $id_bloco, $id_bloco_input_2, "id_bloco");
      }

      //----- $ds_bloco
      $this->Date_part = false;
      if (isset($ds_bloco) || $ds_bloco_cond == "nu" || $ds_bloco_cond == "nn" || $ds_bloco_cond == "ep" || $ds_bloco_cond == "ne")
      {
         $this->monta_condicao("ds_bloco", $ds_bloco_cond, $ds_bloco, "", "ds_bloco");
      }

      //----- $ds_apelido
      $this->Date_part = false;
      if (isset($ds_apelido) || $ds_apelido_cond == "nu" || $ds_apelido_cond == "nn" || $ds_apelido_cond == "ep" || $ds_apelido_cond == "ne")
      {
         $this->monta_condicao("ds_apelido", $ds_apelido_cond, $ds_apelido, "", "ds_apelido");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_bloco']['where_pesq_ant'] = $this->comando . $this->comando_fim;
