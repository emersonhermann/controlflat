<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_public_bloco_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_public_bloco_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['id_bloco'] = "on";
   $tab_def_campos['id_bloco'] = "id_bloco";
   $tab_converte["id_bloco"]   = "id_bloco";
   $tab_labels["id_bloco"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_bloco']['labels']["id_bloco"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_bloco']['labels']["id_bloco"] : "ID Bloco";
   $tab_ger_campos['ds_bloco'] = "on";
   $tab_def_campos['ds_bloco'] = "ds_bloco";
   $tab_converte["ds_bloco"]   = "ds_bloco";
   $tab_labels["ds_bloco"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_bloco']['labels']["ds_bloco"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_bloco']['labels']["ds_bloco"] : "Ds Bloco";
   $tab_ger_campos['ds_apelido'] = "on";
   $tab_def_campos['ds_apelido'] = "ds_apelido";
   $tab_converte["ds_apelido"]   = "ds_apelido";
   $tab_labels["ds_apelido"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_bloco']['labels']["ds_apelido"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_bloco']['labels']["ds_apelido"] : "Ds Apelido";
   $tab_ger_campos['ds_obs'] = "on";
   $tab_def_campos['ds_obs'] = "ds_obs";
   $tab_converte["ds_obs"]   = "ds_obs";
   $tab_labels["ds_obs"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_bloco']['labels']["ds_obs"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_bloco']['labels']["ds_obs"] : "Ds Obs";
   $tab_ger_campos['qt_andar'] = "on";
   $tab_def_campos['qt_andar'] = "qt_andar";
   $tab_converte["qt_andar"]   = "qt_andar";
   $tab_labels["qt_andar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_bloco']['labels']["qt_andar"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_bloco']['labels']["qt_andar"] : "Qt Andar";
   $tab_ger_campos['id_ativo'] = "on";
   $tab_def_campos['id_ativo'] = "id_ativo";
   $tab_converte["id_ativo"]   = "id_ativo";
   $tab_labels["id_ativo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_bloco']['labels']["id_ativo"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_bloco']['labels']["id_ativo"] : "Id Ativo";
   $tab_ger_campos['dt_cadastro'] = "on";
   $tab_def_campos['dt_cadastro'] = "dt_cadastro";
   $tab_converte["dt_cadastro"]   = "dt_cadastro";
   $tab_labels["dt_cadastro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_bloco']['labels']["dt_cadastro"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_bloco']['labels']["dt_cadastro"] : "Dt Cadastrou";
   $tab_ger_campos['dt_atualiza'] = "on";
   $tab_def_campos['dt_atualiza'] = "dt_atualiza";
   $tab_converte["dt_atualiza"]   = "dt_atualiza";
   $tab_labels["dt_atualiza"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_bloco']['labels']["dt_atualiza"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_bloco']['labels']["dt_atualiza"] : "Dt Atualização";
   $tab_ger_campos['usu_cadastro'] = "on";
   $tab_def_campos['usu_cadastro'] = "usu_cadastro";
   $tab_converte["usu_cadastro"]   = "usu_cadastro";
   $tab_labels["usu_cadastro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_bloco']['labels']["usu_cadastro"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_bloco']['labels']["usu_cadastro"] : "Usuário Cadastrou";
   $tab_ger_campos['usu_atualiza'] = "on";
   $tab_def_campos['usu_atualiza'] = "usu_atualiza";
   $tab_converte["usu_atualiza"]   = "usu_atualiza";
   $tab_labels["usu_atualiza"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_bloco']['labels']["usu_atualiza"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_bloco']['labels']["usu_atualiza"] : "Usuário Atualizou";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_public_bloco']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_public_bloco']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_public_bloco']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_public_bloco']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_public_bloco']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_public_bloco']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_public_bloco']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_public_bloco']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_public_bloco']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Bloco</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_public_bloco_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_public_bloco']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_public_bloco']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
