...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - Pessoa Juridica"); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - Pessoa Juridica"); } ?></TITLE>
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_public_pessoa_juridica/form_public_pessoa_juridica_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_public_pessoa_juridica_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_public_pessoa_juridica_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['recarga'];
}
?>
...
<?php
 include_once("form_public_pessoa_juridica_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_public_pessoa_juridica'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_public_pessoa_juridica'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFormHeaderFont"><span><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - Pessoa Juridica"; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - Pessoa Juridica"; } ?></span></td>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<TABLE align="center" id="hidden_bloco_0" class="scFormTable" width="100%" style="height: 100%;"><?php
           if ('novo' != $this->nmgp_opcao && !isset($this->nmgp_cmp_readonly['id_pessoa_juridica']))
           {
               $this->nmgp_cmp_readonly['id_pessoa_juridica'] = 'on';
           }
?>
...
<?php
   ...
   if (/*($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || */(isset($this->nmgp_cmp_readonly["id_pessoa_juridica"]) &&  $this->nmgp_cmp_readonly["id_pessoa_juridica"] == "on"))
   {
       $bTestReadOnly = false;
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_pessoa_juridica_label" id="hidden_field_label_id_pessoa_juridica" style="<?php echo $sStyleHidden_id_pessoa_juridica; ?>"><span id="id_label_id_pessoa_juridica"><?php echo $this->nm_new_label['id_pessoa_juridica']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['php_cmp_required']['id_pessoa_juridica']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['php_cmp_required']['id_pessoa_juridica'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_id_pessoa_juridica_line" id="hidden_field_data_id_pessoa_juridica" style="<?php echo $sStyleHidden_id_pessoa_juridica; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_pessoa_juridica_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || (isset($this->nmgp_cmp_readonly["id_pessoa_juridica"]) &&  $this->nmgp_cmp_readonly["id_pessoa_juridica"] == "on")) { 

 ?>
<input type="hidden" name="id_pessoa_juridica" value="<?php echo $this->form_encode_input($id_pessoa_juridica) . "\"><span id=\"id_ajax_label_id_pessoa_juridica\">" . $id_pessoa_juridica . "</span>"; ?>
<?php } else { ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_razao_social_line" id="hidden_field_data_razao_social" style="<?php echo $sStyleHidden_razao_social; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_razao_social_line" style="vertical-align: top;padding: 0px">
...
<?php } else { ?>
<span id="id_read_on_razao_social" class="sc-ui-readonly-razao_social css_razao_social_line" style="<?php echo $sStyleReadLab_razao_social; ?>"><?php echo $this->form_encode_input($this->razao_social); ?></span><span id="id_read_off_razao_social" style="white-space: nowrap;<?php echo $sStyleReadInp_razao_social; ?>">
 <input class="sc-js-input scFormObjectOdd css_razao_social_obj" style="" id="id_sc_field_razao_social" type=text name="razao_social" value="<?php echo $this->form_encode_input($razao_social) ?>"
...
</td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_razao_social_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_razao_social_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_tipo_vinculo_label" id="hidden_field_label_id_tipo_vinculo" style="<?php echo $sStyleHidden_id_tipo_vinculo; ?>"><span id="id_label_id_tipo_vinculo"><?php echo $this->nm_new_label['id_tipo_vinculo']; ?></span></TD>
    <TD class="scFormDataOdd css_id_tipo_vinculo_line" id="hidden_field_data_id_tipo_vinculo" style="<?php echo $sStyleHidden_id_tipo_vinculo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_tipo_vinculo_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_endereco_line" id="hidden_field_data_endereco" style="<?php echo $sStyleHidden_endereco; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_endereco_line" style="vertical-align: top;padding: 0px">
...
<span id="id_read_on_cnpj" class="sc-ui-readonly-cnpj css_cnpj_line" style="<?php echo $sStyleReadLab_cnpj; ?>"><?php echo $this->form_encode_input($this->cnpj); ?></span><span id="id_read_off_cnpj" style="white-space: nowrap;<?php echo $sStyleReadInp_cnpj; ?>">
 ...
 size=21 maxlength=21 alt="{datatype: 'text', maxLength: 21, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ie_label" id="hidden_field_label_ie" style="<?php echo $sStyleHidden_ie; ?>"><span id="id_label_ie"><?php echo $this->nm_new_label['ie']; ?></span></TD>
...
<?php } else { ?>
<span id="id_read_on_ie" class="sc-ui-readonly-ie css_ie_line" style="<?php echo $sStyleReadLab_ie; ?>"><?php echo $this->form_encode_input($this->ie); ?></span><span id="id_read_off_ie" style="white-space: nowrap;<?php echo $sStyleReadInp_ie; ?>">
 <input class="sc-js-input scFormObjectOdd css_ie_obj" style="" id="id_sc_field_ie" type=text name="ie" value="<?php echo $this->form_encode_input($ie) ?>"
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['im']))
    {
        $this->nm_new_label['im'] = "Im";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   ...
   $im = $this->im;
   $sStyleHidden_im = '';
   if (isset($this->nmgp_cmp_hidden['im']) && $this->nmgp_cmp_hidden['im'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['im']);
       $sStyleHidden_im = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_im = 'display: none;';
   $sStyleReadInp_im = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['im']) && $this->nmgp_cmp_readonly['im'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['im']);
       $sStyleReadLab_im = '';
       $sStyleReadInp_im = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['im']) && $this->nmgp_cmp_hidden['im'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="im" value="<?php echo $this->form_encode_input($im) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_im_label" id="hidden_field_label_im" style="<?php echo $sStyleHidden_im; ?>"><span id="id_label_im"><?php echo $this->nm_new_label['im']; ?></span></TD>
    <TD class="scFormDataOdd css_im_line" id="hidden_field_data_im" style="<?php echo $sStyleHidden_im; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_im_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["im"]) &&  $this->nmgp_cmp_readonly["im"] == "on") { 

 ?>
<input type="hidden" name="im" value="<?php echo $this->form_encode_input($im) . "\">" . $im . ""; ?>
<?php } else { ?>
<span id="id_read_on_im" class="sc-ui-readonly-im css_im_line" style="<?php echo $sStyleReadLab_im; ?>"><?php echo $this->form_encode_input($this->im); ?></span><span id="id_read_off_im" style="white-space: nowrap;<?php echo $sStyleReadInp_im; ?>">
 <input class="sc-js-input scFormObjectOdd css_im_obj" style="" id="id_sc_field_im" type=text name="im" value="<?php echo $this->form_encode_input($im) ?>"
 size=25 maxlength=25 alt="{datatype: 'text', maxLength: 25, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_im_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_im_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['ds_contato_responsavel']))
    {
        $this->nm_new_label['ds_contato_responsavel'] = "Ds Contato Responsavel";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $ds_contato_responsavel = $this->ds_contato_responsavel;
   $sStyleHidden_ds_contato_responsavel = '';
   if (isset($this->nmgp_cmp_hidden['ds_contato_responsavel']) && $this->nmgp_cmp_hidden['ds_contato_responsavel'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['ds_contato_responsavel']);
       $sStyleHidden_ds_contato_responsavel = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_ds_contato_responsavel = 'display: none;';
   $sStyleReadInp_ds_contato_responsavel = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['ds_contato_responsavel']) && $this->nmgp_cmp_readonly['ds_contato_responsavel'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['ds_contato_responsavel']);
       $sStyleReadLab_ds_contato_responsavel = '';
       $sStyleReadInp_ds_contato_responsavel = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['ds_contato_responsavel']) && $this->nmgp_cmp_hidden['ds_contato_responsavel'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="ds_contato_responsavel" value="<?php echo $this->form_encode_input($ds_contato_responsavel) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_ds_contato_responsavel_label" id="hidden_field_label_ds_contato_responsavel" style="<?php echo $sStyleHidden_ds_contato_responsavel; ?>"><span id="id_label_ds_contato_responsavel"><?php echo $this->nm_new_label['ds_contato_responsavel']; ?></span></TD>
    <TD class="scFormDataOdd css_ds_contato_responsavel_line" id="hidden_field_data_ds_contato_responsavel" style="<?php echo $sStyleHidden_ds_contato_responsavel; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ds_contato_responsavel_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["ds_contato_responsavel"]) &&  $this->nmgp_cmp_readonly["ds_contato_responsavel"] == "on") { 

 ?>
<input type="hidden" name="ds_contato_responsavel" value="<?php echo $this->form_encode_input($ds_contato_responsavel) . "\">" . $ds_contato_responsavel . ""; ?>
<?php } else { ?>
<span id="id_read_on_ds_contato_responsavel" class="sc-ui-readonly-ds_contato_responsavel css_ds_contato_responsavel_line" style="<?php echo $sStyleReadLab_ds_contato_responsavel; ?>"><?php echo $this->form_encode_input($this->ds_contato_responsavel); ?></span><span id="id_read_off_ds_contato_responsavel" style="white-space: nowrap;<?php echo $sStyleReadInp_ds_contato_responsavel; ?>">
 <input class="sc-js-input scFormObjectOdd css_ds_contato_responsavel_obj" style="" id="id_sc_field_ds_contato_responsavel" type=text name="ds_contato_responsavel" value="<?php echo $this->form_encode_input($ds_contato_responsavel) ?>"
 size=50 maxlength=255 alt="{datatype: 'text', maxLength: 255, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_ds_contato_responsavel_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_ds_contato_responsavel_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['fone_fax']))
    {
        $this->nm_new_label['fone_fax'] = "Fone Fax";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $fone_fax = $this->fone_fax;
   $sStyleHidden_fone_fax = '';
   if (isset($this->nmgp_cmp_hidden['fone_fax']) && $this->nmgp_cmp_hidden['fone_fax'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['fone_fax']);
       $sStyleHidden_fone_fax = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_fone_fax = 'display: none;';
   $sStyleReadInp_fone_fax = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['fone_fax']) && $this->nmgp_cmp_readonly['fone_fax'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['fone_fax']);
       $sStyleReadLab_fone_fax = '';
       $sStyleReadInp_fone_fax = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['fone_fax']) && $this->nmgp_cmp_hidden['fone_fax'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="fone_fax" value="<?php echo $this->form_encode_input($fone_fax) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_fone_fax_label" id="hidden_field_label_fone_fax" style="<?php echo $sStyleHidden_fone_fax; ?>"><span id="id_label_fone_fax"><?php echo $this->nm_new_label['fone_fax']; ?></span></TD>
    <TD class="scFormDataOdd css_fone_fax_line" id="hidden_field_data_fone_fax" style="<?php echo $sStyleHidden_fone_fax; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fone_fax_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["fone_fax"]) &&  $this->nmgp_cmp_readonly["fone_fax"] == "on") { 

 ?>
<input type="hidden" name="fone_fax" value="<?php echo $this->form_encode_input($fone_fax) . "\">" . $fone_fax . ""; ?>
<?php } else { ?>
<span id="id_read_on_fone_fax" class="sc-ui-readonly-fone_fax css_fone_fax_line" style="<?php echo $sStyleReadLab_fone_fax; ?>"><?php echo $this->form_encode_input($this->fone_fax); ?></span><span id="id_read_off_fone_fax" style="white-space: nowrap;<?php echo $sStyleReadInp_fone_fax; ?>">
 <input class="sc-js-input scFormObjectOdd css_fone_fax_obj" style="" id="id_sc_field_fone_fax" type=text name="fone_fax" value="<?php echo $this->form_encode_input($fone_fax) ?>"
 size=50 maxlength=100 alt="{datatype: 'text', maxLength: 100, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_fone_fax_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_fone_fax_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_ativo_label" id="hidden_field_label_id_ativo" style="<?php echo $sStyleHidden_id_ativo; ?>"><span id="id_label_id_ativo"><?php echo $this->nm_new_label['id_ativo']; ?></span></TD>
    <TD class="scFormDataOdd css_id_ativo_line" id="hidden_field_data_id_ativo" style="<?php echo $sStyleHidden_id_ativo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_ativo_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_dt_cadastro_label" id="hidden_field_label_dt_cadastro" style="<?php echo $sStyleHidden_dt_cadastro; ?>"><span id="id_label_dt_cadastro"><?php echo $this->nm_new_label['dt_cadastro']; ?></span></TD>
    <TD class="scFormDataOdd css_dt_cadastro_line" id="hidden_field_data_dt_cadastro" style="<?php echo $sStyleHidden_dt_cadastro; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dt_cadastro_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_dt_atualiza_label" id="hidden_field_label_dt_atualiza" style="<?php echo $sStyleHidden_dt_atualiza; ?>"><span id="id_label_dt_atualiza"><?php echo $this->nm_new_label['dt_atualiza']; ?></span></TD>
    <TD class="scFormDataOdd css_dt_atualiza_line" id="hidden_field_data_dt_atualiza" style="<?php echo $sStyleHidden_dt_atualiza; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dt_atualiza_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_usu_cadastro_label" id="hidden_field_label_usu_cadastro" style="<?php echo $sStyleHidden_usu_cadastro; ?>"><span id="id_label_usu_cadastro"><?php echo $this->nm_new_label['usu_cadastro']; ?></span></TD>
    <TD class="scFormDataOdd css_usu_cadastro_line" id="hidden_field_data_usu_cadastro" style="<?php echo $sStyleHidden_usu_cadastro; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_usu_cadastro_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_usu_atualiza_label" id="hidden_field_label_usu_atualiza" style="<?php echo $sStyleHidden_usu_atualiza; ?>"><span id="id_label_usu_atualiza"><?php echo $this->nm_new_label['usu_atualiza']; ?></span></TD>
    <TD class="scFormDataOdd css_usu_atualiza_line" id="hidden_field_data_usu_atualiza" style="<?php echo $sStyleHidden_usu_atualiza; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_usu_atualiza_line" style="vertical-align: top;padding: 0px">
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['mostra_cab'] != "N"))
  {
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pessoa_juridica']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_public_pessoa_juridica");
 parent.scAjaxDetailHeight("form_public_pessoa_juridica", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
