...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "dt_cadastro";$Nm_datas[] = "dt_atualiza";$Nm_numeric[] = "id_pessoa_juridica";$Nm_numeric[] = "id_tipo_vinculo";$Nm_numeric[] = "id_ativo";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_id_tipo_vinculo"  <?php echo $str_hide_id_tipo_vinculo?>><?php
      $id_tipo_vinculo_look = substr($this->Db->qstr($id_tipo_vinculo), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_id_tipo_vinculo" name="id_tipo_vinculo_autocomp" size="9" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_id_tipo_vinculo"  <?php echo $str_display_id_tipo_vinculo; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_tipo_vinculo_input_2" name="id_tipo_vinculo_input_2" value="<?php echo NM_encode_input($id_tipo_vinculo_input_2) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_id_pessoa_juridica"  <?php echo $str_hide_id_pessoa_juridica?>><?php
      $id_pessoa_juridica_look = substr($this->Db->qstr($id_pessoa_juridica), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_id_pessoa_juridica" name="id_pessoa_juridica_autocomp" size="17" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 17, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_id_pessoa_juridica"  <?php echo $str_display_id_pessoa_juridica; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_pessoa_juridica_input_2" name="id_pessoa_juridica_input_2" value="<?php echo NM_encode_input($id_pessoa_juridica_input_2) ?>" size=17 alt="{datatype: 'integer', maxLength: 17, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_fantasia"  <?php echo $str_hide_fantasia?>><?php
      $fantasia_look = substr($this->Db->qstr($fantasia), 1, -1); 
      $nmgp_def_dados = array(); 
