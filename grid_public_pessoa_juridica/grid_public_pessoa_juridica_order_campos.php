<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_public_pessoa_juridica_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_public_pessoa_juridica_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['id_pessoa_juridica'] = "on";
   $tab_def_campos['id_pessoa_juridica'] = "id_pessoa_juridica";
   $tab_converte["id_pessoa_juridica"]   = "id_pessoa_juridica";
   $tab_labels["id_pessoa_juridica"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['labels']["id_pessoa_juridica"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['labels']["id_pessoa_juridica"] : "ID Pessoa Juridica";
   $tab_ger_campos['razao_social'] = "on";
   $tab_def_campos['razao_social'] = "razao_social";
   $tab_converte["razao_social"]   = "razao_social";
   $tab_labels["razao_social"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['labels']["razao_social"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['labels']["razao_social"] : "Razao Social";
   $tab_ger_campos['fantasia'] = "on";
   $tab_def_campos['fantasia'] = "fantasia";
   $tab_converte["fantasia"]   = "fantasia";
   $tab_labels["fantasia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['labels']["fantasia"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['labels']["fantasia"] : "Fantasia";
   $tab_ger_campos['id_tipo_vinculo'] = "on";
   $tab_def_campos['id_tipo_vinculo'] = "id_tipo_vinculo";
   $tab_converte["id_tipo_vinculo"]   = "id_tipo_vinculo";
   $tab_labels["id_tipo_vinculo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['labels']["id_tipo_vinculo"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['labels']["id_tipo_vinculo"] : "ID Tipo Vinculo";
   $tab_ger_campos['endereco'] = "on";
   $tab_def_campos['endereco'] = "endereco";
   $tab_converte["endereco"]   = "endereco";
   $tab_labels["endereco"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['labels']["endereco"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['labels']["endereco"] : "Endereço";
   $tab_ger_campos['cnpj'] = "on";
   $tab_def_campos['cnpj'] = "cnpj";
   $tab_converte["cnpj"]   = "cnpj";
   $tab_labels["cnpj"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['labels']["cnpj"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['labels']["cnpj"] : "CNPJ";
   $tab_ger_campos['ie'] = "on";
   $tab_def_campos['ie'] = "ie";
   $tab_converte["ie"]   = "ie";
   $tab_labels["ie"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['labels']["ie"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['labels']["ie"] : "IE";
   $tab_ger_campos['im'] = "on";
   $tab_def_campos['im'] = "im";
   $tab_converte["im"]   = "im";
   $tab_labels["im"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['labels']["im"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['labels']["im"] : "IM";
   $tab_ger_campos['ds_contato_responsavel'] = "on";
   $tab_def_campos['ds_contato_responsavel'] = "ds_contato_responsavel";
   $tab_converte["ds_contato_responsavel"]   = "ds_contato_responsavel";
   $tab_labels["ds_contato_responsavel"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['labels']["ds_contato_responsavel"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['labels']["ds_contato_responsavel"] : "Contato Responsavel";
   $tab_ger_campos['email'] = "on";
   $tab_def_campos['email'] = "email";
   $tab_converte["email"]   = "email";
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['labels']["email"] : "Email";
   $tab_ger_campos['fone_fax'] = "on";
   $tab_def_campos['fone_fax'] = "fone_fax";
   $tab_converte["fone_fax"]   = "fone_fax";
   $tab_labels["fone_fax"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['labels']["fone_fax"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['labels']["fone_fax"] : "Fone / Fax";
   $tab_ger_campos['id_ativo'] = "on";
   $tab_def_campos['id_ativo'] = "id_ativo";
   $tab_converte["id_ativo"]   = "id_ativo";
   $tab_labels["id_ativo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['labels']["id_ativo"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['labels']["id_ativo"] : "Id Ativo";
   $tab_ger_campos['dt_cadastro'] = "on";
   $tab_def_campos['dt_cadastro'] = "dt_cadastro";
   $tab_converte["dt_cadastro"]   = "dt_cadastro";
   $tab_labels["dt_cadastro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['labels']["dt_cadastro"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['labels']["dt_cadastro"] : "Dt Cadastro";
   $tab_ger_campos['dt_atualiza'] = "on";
   $tab_def_campos['dt_atualiza'] = "dt_atualiza";
   $tab_converte["dt_atualiza"]   = "dt_atualiza";
   $tab_labels["dt_atualiza"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['labels']["dt_atualiza"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['labels']["dt_atualiza"] : "Dt Atualização";
   $tab_ger_campos['usu_cadastro'] = "on";
   $tab_def_campos['usu_cadastro'] = "usu_cadastro";
   $tab_converte["usu_cadastro"]   = "usu_cadastro";
   $tab_labels["usu_cadastro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['labels']["usu_cadastro"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['labels']["usu_cadastro"] : "Usuário Cadastrou";
   $tab_ger_campos['usu_atualiza'] = "on";
   $tab_def_campos['usu_atualiza'] = "usu_atualiza";
   $tab_converte["usu_atualiza"]   = "usu_atualiza";
   $tab_labels["usu_atualiza"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['labels']["usu_atualiza"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['labels']["usu_atualiza"] : "Usuário Atualizou";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Pessoa Juridica</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_public_pessoa_juridica_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_public_pessoa_juridica']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
