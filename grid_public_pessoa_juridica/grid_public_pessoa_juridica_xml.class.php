...
class grid_public_pessoa_juridica_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_public_pessoa_juridica_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_public_pessoa_juridica.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_public_pessoa_juridica";
   ...
   function NM_export_razao_social()
   {
         ...
         $this->xml_registro .= " razao_social =\"" . $this->trata_dados($this->razao_social) . "\"";
   }
   //----- fantasia
   function NM_export_fantasia()
   {
         ...
         $this->xml_registro .= " fantasia =\"" . $this->trata_dados($this->fantasia) . "\"";
   }
   //----- id_tipo_vinculo
   ...
   function NM_export_endereco()
   {
         ...
         $this->xml_registro .= " endereco =\"" . $this->trata_dados($this->endereco) . "\"";
   }
   //----- cnpj
   ...
   function NM_export_ie()
   {
         ...
         $this->xml_registro .= " ie =\"" . $this->trata_dados($this->ie) . "\"";
   }
   //----- im
   function NM_export_im()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->im))
         {
             $this->im = sc_convert_encoding($this->im, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " im =\"" . $this->trata_dados($this->im) . "\"";
   }
   //----- ds_contato_responsavel
   function NM_export_ds_contato_responsavel()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->ds_contato_responsavel))
         {
             $this->ds_contato_responsavel = sc_convert_encoding($this->ds_contato_responsavel, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " ds_contato_responsavel =\"" . $this->trata_dados($this->ds_contato_responsavel) . "\"";
   }
   //----- email
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->fone_fax))
         {
             $this->fone_fax = sc_convert_encoding($this->fone_fax, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " fone_fax =\"" . $this->trata_dados($this->fone_fax) . "\"";
   }
   //----- id_ativo
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Pessoa Juridica :: XML</TITLE>
