...
class grid_public_pessoa_juridica_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function grid_public_pessoa_juridica_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_public_pessoa_juridica_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_public_pessoa_juridica_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_public_pessoa_juridica_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_id_tipo_vinculo')
      {
          $id_tipo_vinculo = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_id_tipo_vinculo($id_tipo_vinculo);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_id_pessoa_juridica')
      {
          $id_pessoa_juridica = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_id_pessoa_juridica($id_pessoa_juridica);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
      ...
      if ($this->NM_ajax_opcao == 'autocomp_fantasia')
      {
          $fantasia = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_fantasia($fantasia);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_id_tipo_vinculo($id_tipo_vinculo)
   {
      $id_tipo_vinculo = substr($this->Db->qstr($id_tipo_vinculo), 1, -1);
            $id_tipo_vinculo_look = substr($this->Db->qstr($id_tipo_vinculo), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id_tipo_vinculo from " . $this->Ini->nm_tabela . " where   CAST (id_tipo_vinculo AS TEXT)  like '%" . $id_tipo_vinculo . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct id_tipo_vinculo from " . $this->Ini->nm_tabela . " where  id_tipo_vinculo like '%" . $id_tipo_vinculo . "%'"; 
      }
   ...
   function lookup_ajax_id_pessoa_juridica($id_pessoa_juridica)
   {
      $id_pessoa_juridica = substr($this->Db->qstr($id_pessoa_juridica), 1, -1);
            $id_pessoa_juridica_look = substr($this->Db->qstr($id_pessoa_juridica), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id_pessoa_juridica from " . $this->Ini->nm_tabela . " where   CAST (id_pessoa_juridica AS TEXT)  like '%" . $id_pessoa_juridica . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct id_pessoa_juridica from " . $this->Ini->nm_tabela . " where  id_pessoa_juridica like '%" . $id_pessoa_juridica . "%'"; 
      }
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_razao_social($razao_social)
   {
      $razao_social = substr($this->Db->qstr($razao_social), 1, -1);
            $razao_social_look = substr($this->Db->qstr($razao_social), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct razao_social from " . $this->Ini->nm_tabela . " where  razao_social like '%" . $razao_social . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_fantasia($fantasia)
   {
      $fantasia = substr($this->Db->qstr($fantasia), 1, -1);
            $fantasia_look = substr($this->Db->qstr($fantasia), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct fantasia from " . $this->Ini->nm_tabela . " where  fantasia like '%" . $fantasia . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         $nome_sum = "\"public\".pessoa_juridica.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Pessoa Juridica</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_public_pessoa_juridica/grid_public_pessoa_juridica_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_public_pessoa_juridica_ajax_search.js"></script>
 <script type="text/javascript" src="grid_public_pessoa_juridica_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_id_tipo_vinculo_cond#NMF#' + search_get_sel_txt('SC_id_tipo_vinculo_cond') + '@NMF@';
  str_out += 'SC_id_tipo_vinculo#NMF#' + search_get_text('SC_id_tipo_vinculo') + '@NMF@';
  str_out += 'id_ac_id_tipo_vinculo#NMF#' + search_get_text('id_ac_id_tipo_vinculo') + '@NMF@';
  str_out += 'SC_id_tipo_vinculo_input_2#NMF#' + search_get_text('SC_id_tipo_vinculo_input_2') + '@NMF@';
  str_out += 'SC_id_pessoa_juridica_cond#NMF#' + search_get_sel_txt('SC_id_pessoa_juridica_cond') + '@NMF@';
  str_out += 'SC_id_pessoa_juridica#NMF#' + search_get_text('SC_id_pessoa_juridica') + '@NMF@';
  str_out += 'id_ac_id_pessoa_juridica#NMF#' + search_get_text('id_ac_id_pessoa_juridica') + '@NMF@';
  str_out += 'SC_id_pessoa_juridica_input_2#NMF#' + search_get_text('SC_id_pessoa_juridica_input_2') + '@NMF@';
  ...
  str_out += 'SC_fantasia_cond#NMF#' + search_get_sel_txt('SC_fantasia_cond') + '@NMF@';
  str_out += 'SC_fantasia#NMF#' + search_get_text('SC_fantasia') + '@NMF@';
  str_out += 'id_ac_fantasia#NMF#' + search_get_text('id_ac_fantasia') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   $("#id_ac_id_pessoa_juridica").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_id_pessoa_juridica",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_id_pessoa_juridica").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_id_pessoa_juridica").val( $(this).val() );
       }
     }
   });
   ...
   $("#id_ac_fantasia").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_fantasia",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_fantasia").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_fantasia").val( $(this).val() );
       }
     }
   });
   $("#id_ac_id_tipo_vinculo").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_id_tipo_vinculo",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_id_tipo_vinculo").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_id_tipo_vinculo").val( $(this).val() );
       }
     }
   });
 });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Pessoa Juridica</span></td>
...
<?php
   ...
   {
      global 
             $id_tipo_vinculo_cond, $id_tipo_vinculo, $id_tipo_vinculo_input_2, $id_tipo_vinculo_autocomp,
             $id_pessoa_juridica_cond, $id_pessoa_juridica, $id_pessoa_juridica_input_2, $id_pessoa_juridica_autocomp,
             $razao_social_cond, $razao_social, $razao_social_autocomp,
             $fantasia_cond, $fantasia, $fantasia_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $id_tipo_vinculo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['campos_busca']['id_tipo_vinculo']; 
          $id_tipo_vinculo_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['campos_busca']['id_tipo_vinculo_input_2']; 
          $id_tipo_vinculo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['campos_busca']['id_tipo_vinculo_cond']; 
          $id_pessoa_juridica = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['campos_busca']['id_pessoa_juridica']; 
          $id_pessoa_juridica_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['campos_busca']['id_pessoa_juridica_input_2']; 
          $id_pessoa_juridica_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['campos_busca']['id_pessoa_juridica_cond']; 
          $razao_social = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['campos_busca']['razao_social']; 
          $razao_social_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['campos_busca']['razao_social_cond']; 
          $fantasia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['campos_busca']['fantasia']; 
          $fantasia_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['campos_busca']['fantasia_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['campos_busca']['NM_operador']; 
      } 
      if (!isset($id_tipo_vinculo_cond) || empty($id_tipo_vinculo_cond))
      {
         $id_tipo_vinculo_cond = "gt";
      }
      if (!isset($id_pessoa_juridica_cond) || empty($id_pessoa_juridica_cond))
      {
         $id_pessoa_juridica_cond = "gt";
      }
      if (!isset($razao_social_cond) || empty($razao_social_cond))
      {
         $razao_social_cond = "qp";
      }
      if (!isset($fantasia_cond) || empty($fantasia_cond))
      {
         $fantasia_cond = "qp";
      }
      ...
      $str_hide_id_tipo_vinculo = (in_array($id_tipo_vinculo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_id_pessoa_juridica = (in_array($id_pessoa_juridica_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_razao_social = (in_array($razao_social_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_fantasia = (in_array($fantasia_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_id_tipo_vinculo = ('bw' == $id_tipo_vinculo_cond) ? $display_aberto : $display_fechado;
      $str_display_id_pessoa_juridica = ('bw' == $id_pessoa_juridica_cond) ? $display_aberto : $display_fechado;

      if (!isset($id_tipo_vinculo) || $id_tipo_vinculo == "")
      {
          $id_tipo_vinculo = "";
      }
      if (isset($id_tipo_vinculo) && !empty($id_tipo_vinculo))
      {
         $tmp_pos = strpos($id_tipo_vinculo, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_tipo_vinculo = substr($id_tipo_vinculo, 0, $tmp_pos);
         }
      }
      if (!isset($id_pessoa_juridica) || $id_pessoa_juridica == "")
      {
          $id_pessoa_juridica = "";
      }
      if (isset($id_pessoa_juridica) && !empty($id_pessoa_juridica))
      {
         $tmp_pos = strpos($id_pessoa_juridica, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_pessoa_juridica = substr($id_pessoa_juridica, 0, $tmp_pos);
         }
      }
      ...
      if (!isset($fantasia) || $fantasia == "")
      {
          $fantasia = "";
      }
      if (isset($fantasia) && !empty($fantasia))
      {
         $tmp_pos = strpos($fantasia, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $fantasia = substr($fantasia, 0, $tmp_pos);
         }
      }
?>
 <?php
...
<?php
   if (is_file("grid_public_pessoa_juridica_help.txt"))
   {
...
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_tipo_vinculo'])) ? $this->New_label['id_tipo_vinculo'] : "ID Tipo Vinculo"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_id_tipo_vinculo_cond" name="id_tipo_vinculo_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_tipo_vinculo'), this, 'id_tipo_vinculo')">
       <OPTION value="gt" <?php if ("gt" == $id_tipo_vinculo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_tipo_vinculo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_tipo_vinculo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $id_tipo_vinculo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_tipo_vinculo" <?php echo $str_hide_id_tipo_vinculo?> valign="top">
 ...
 $nmgp_tab_label .= "id_tipo_vinculo?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $id_tipo_vinculo_look = substr($this->Db->qstr($id_tipo_vinculo), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($id_tipo_vinculo))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id_tipo_vinculo from " . $this->Ini->nm_tabela . " where id_tipo_vinculo = $id_tipo_vinculo_look"; 
      }
      else
      {
          $nm_comando = "select distinct id_tipo_vinculo from " . $this->Ini->nm_tabela . " where id_tipo_vinculo = $id_tipo_vinculo_look"; 
      ...
      if (isset($nmgp_def_dados[0][$id_tipo_vinculo]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$id_tipo_vinculo];
      }
      else
      {
          $sAutocompValue = $id_tipo_vinculo;
      }
?>
<INPUT  type="text" id="SC_id_tipo_vinculo" name="id_tipo_vinculo" value="<?php echo NM_encode_input($id_tipo_vinculo) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_id_tipo_vinculo" name="id_tipo_vinculo_autocomp" size="9" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_id_tipo_vinculo"  <?php echo $str_display_id_tipo_vinculo; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_tipo_vinculo_input_2" name="id_tipo_vinculo_input_2" value="<?php echo NM_encode_input($id_tipo_vinculo_input_2) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['id_pessoa_juridica'])) ? $this->New_label['id_pessoa_juridica'] : "ID Pessoa Juridica"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_id_pessoa_juridica_cond" name="id_pessoa_juridica_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_pessoa_juridica'), this, 'id_pessoa_juridica')">
       <OPTION value="gt" <?php if ("gt" == $id_pessoa_juridica_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_pessoa_juridica_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_pessoa_juridica_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $id_pessoa_juridica_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_pessoa_juridica" <?php echo $str_hide_id_pessoa_juridica?> valign="top">
 ...
 $nmgp_tab_label .= "id_pessoa_juridica?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $id_pessoa_juridica_look = substr($this->Db->qstr($id_pessoa_juridica), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($id_pessoa_juridica))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id_pessoa_juridica from " . $this->Ini->nm_tabela . " where id_pessoa_juridica = $id_pessoa_juridica_look"; 
      }
      else
      {
          $nm_comando = "select distinct id_pessoa_juridica from " . $this->Ini->nm_tabela . " where id_pessoa_juridica = $id_pessoa_juridica_look"; 
      ...
      if (isset($nmgp_def_dados[0][$id_pessoa_juridica]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$id_pessoa_juridica];
      }
      else
      {
          $sAutocompValue = $id_pessoa_juridica;
      }
?>
<INPUT  type="text" id="SC_id_pessoa_juridica" name="id_pessoa_juridica" value="<?php echo NM_encode_input($id_pessoa_juridica) ?>" size=17 alt="{datatype: 'integer', maxLength: 17, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_id_pessoa_juridica" name="id_pessoa_juridica_autocomp" size="17" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 17, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_id_pessoa_juridica"  <?php echo $str_display_id_pessoa_juridica; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_pessoa_juridica_input_2" name="id_pessoa_juridica_input_2" value="<?php echo NM_encode_input($id_pessoa_juridica_input_2) ?>" size=17 alt="{datatype: 'integer', maxLength: 17, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['razao_social'])) ? $this->New_label['razao_social'] : "Razao Social"; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
<?php
      $razao_social_look = substr($this->Db->qstr($razao_social), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct razao_social from " . $this->Ini->nm_tabela . " where razao_social = '$razao_social_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
?>
<INPUT  type="text" id="SC_razao_social" name="razao_social" value="<?php echo NM_encode_input($razao_social) ?>" size=50 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_razao_social" name="razao_social_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['fantasia'])) ? $this->New_label['fantasia'] : "Fantasia"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_fantasia_cond" name="fantasia_cond" onChange="nm_campos_between(document.getElementById('id_vis_fantasia'), this, 'fantasia')">
       <OPTION value="qp" <?php if ("qp" == $fantasia_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $fantasia_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $fantasia_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $fantasia_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_fantasia" <?php echo $str_hide_fantasia?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['fantasia'])) ? $this->New_label['fantasia'] : "Fantasia";
 $nmgp_tab_label .= "fantasia?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $fantasia_look = substr($this->Db->qstr($fantasia), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct fantasia from " . $this->Ini->nm_tabela . " where fantasia = '$fantasia_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$fantasia]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$fantasia];
      }
      else
      {
          $sAutocompValue = $fantasia;
      }
?>
<INPUT  type="text" id="SC_fantasia" name="fantasia" value="<?php echo NM_encode_input($fantasia) ?>" size=50 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_fantasia" name="fantasia_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_public_pessoa_juridica']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_public_pessoa_juridica']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_id_tipo_vinculo'), document.F1.id_tipo_vinculo_cond, 'id_tipo_vinculo');
   document.F1.id_tipo_vinculo.value = "";
   document.F1.id_tipo_vinculo_autocomp.value = "";
   document.F1.id_tipo_vinculo_input_2.value = "";
   nm_campos_between(document.getElementById('id_vis_id_pessoa_juridica'), document.F1.id_pessoa_juridica_cond, 'id_pessoa_juridica');
   document.F1.id_pessoa_juridica.value = "";
   document.F1.id_pessoa_juridica_autocomp.value = "";
   document.F1.id_pessoa_juridica_input_2.value = "";
   ...
   nm_campos_between(document.getElementById('id_vis_fantasia'), document.F1.fantasia_cond, 'fantasia');
   document.F1.fantasia.value = "";
   document.F1.fantasia_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "SYS_CONTROLFLAT/grid_public_pessoa_juridica";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_public_pessoa_juridica/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_id_tipo_vinculo_cond'] = 'cond';
      $tp_fields['SC_id_tipo_vinculo'] = 'text_aut';
      $tp_fields['id_ac_id_tipo_vinculo'] = 'text_aut';
      $tp_fields['SC_id_tipo_vinculo_input_2'] = 'text';
      $tp_fields['SC_id_pessoa_juridica_cond'] = 'cond';
      $tp_fields['SC_id_pessoa_juridica'] = 'text_aut';
      $tp_fields['id_ac_id_pessoa_juridica'] = 'text_aut';
      $tp_fields['SC_id_pessoa_juridica_input_2'] = 'text';
      $tp_fields['SC_razao_social_cond'] = 'cond';
      $tp_fields['SC_razao_social'] = 'text_aut';
      $tp_fields['id_ac_razao_social'] = 'text_aut';
      $tp_fields['SC_fantasia_cond'] = 'cond';
      $tp_fields['SC_fantasia'] = 'text_aut';
      $tp_fields['id_ac_fantasia'] = 'text_aut';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $id_tipo_vinculo_cond, $id_tipo_vinculo, $id_tipo_vinculo_input_2, $id_tipo_vinculo_autocomp,
             $id_pessoa_juridica_cond, $id_pessoa_juridica, $id_pessoa_juridica_input_2, $id_pessoa_juridica_autocomp,
             $razao_social_cond, $razao_social, $razao_social_autocomp,
             $fantasia_cond, $fantasia, $fantasia_autocomp, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($id_tipo_vinculo_autocomp) && empty($id_tipo_vinculo))
      {
          $id_tipo_vinculo = $id_tipo_vinculo_autocomp;
      }
      if (!empty($id_pessoa_juridica_autocomp) && empty($id_pessoa_juridica))
      {
          $id_pessoa_juridica = $id_pessoa_juridica_autocomp;
      }
      if (!empty($razao_social_autocomp) && empty($razao_social))
      {
          $razao_social = $razao_social_autocomp;
      }
      if (!empty($fantasia_autocomp) && empty($fantasia))
      {
          $fantasia = $fantasia_autocomp;
      }
      $id_tipo_vinculo_cond_salva = $id_tipo_vinculo_cond; 
      if (!isset($id_tipo_vinculo_input_2) || $id_tipo_vinculo_input_2 == "")
      {
          $id_tipo_vinculo_input_2 = $id_tipo_vinculo;
      }
      $id_pessoa_juridica_cond_salva = $id_pessoa_juridica_cond; 
      if (!isset($id_pessoa_juridica_input_2) || $id_pessoa_juridica_input_2 == "")
      {
          $id_pessoa_juridica_input_2 = $id_pessoa_juridica;
      }
      ...
      $fantasia_cond_salva = $fantasia_cond; 
      if (!isset($fantasia_input_2) || $fantasia_input_2 == "")
      {
          $fantasia_input_2 = $fantasia;
      }
      if ($id_tipo_vinculo_cond != "in")
      {
          nm_limpa_numero($id_tipo_vinculo, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $id_tipo_vinculo);
          ...
          $id_tipo_vinculo = implode(",", $Nm_sc_valores);
      }
      if ($id_tipo_vinculo_cond != "in")
      {
          nm_limpa_numero($id_tipo_vinculo_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($id_pessoa_juridica_cond != "in")
      {
          nm_limpa_numero($id_pessoa_juridica, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $id_pessoa_juridica);
          foreach ($Nm_sc_valores as $II => $Nm_sc_valor)
          {
              $Nm_sc_valor = trim($Nm_sc_valor);
              nm_limpa_numero($Nm_sc_valor, $_SESSION['scriptcase']['reg_conf']['grup_num']); 
          ...
          $id_pessoa_juridica = implode(",", $Nm_sc_valores);
      }
      if ($id_pessoa_juridica_cond != "in")
      {
          nm_limpa_numero($id_pessoa_juridica_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['campos_busca']['id_tipo_vinculo'] = $id_tipo_vinculo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['campos_busca']['id_tipo_vinculo_input_2'] = $id_tipo_vinculo_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['campos_busca']['id_tipo_vinculo_cond'] = $id_tipo_vinculo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['campos_busca']['id_pessoa_juridica'] = $id_pessoa_juridica; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['campos_busca']['id_pessoa_juridica_input_2'] = $id_pessoa_juridica_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['campos_busca']['id_pessoa_juridica_cond'] = $id_pessoa_juridica_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['campos_busca']['razao_social'] = $razao_social; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['campos_busca']['razao_social_cond'] = $razao_social_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['campos_busca']['fantasia'] = $fantasia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['campos_busca']['fantasia_cond'] = $fantasia_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($id_tipo_vinculo_cond != "in" && $id_tipo_vinculo_cond != "bw" && !empty($id_tipo_vinculo) && !is_numeric($id_tipo_vinculo))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : ID Tipo Vinculo";
      }
      if ($id_tipo_vinculo_cond == "bw" && ((!empty($id_tipo_vinculo) && !is_numeric($id_tipo_vinculo)) || (!empty($id_tipo_vinculo_input_2) && !is_numeric($id_tipo_vinculo_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : ID Tipo Vinculo";
      }
      if ($id_pessoa_juridica_cond != "in" && $id_pessoa_juridica_cond != "bw" && !empty($id_pessoa_juridica) && !is_numeric($id_pessoa_juridica))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : ID Pessoa Juridica";
      }
      if ($id_pessoa_juridica_cond == "bw" && ((!empty($id_pessoa_juridica) && !is_numeric($id_pessoa_juridica)) || (!empty($id_pessoa_juridica_input_2) && !is_numeric($id_pessoa_juridica_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : ID Pessoa Juridica";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['id_tipo_vinculo'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['id_tipo_vinculo'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['id_tipo_vinculo'] = $id_tipo_vinculo;
      }
      $Conteudo = $id_tipo_vinculo_input_2;
      if (strtoupper($id_tipo_vinculo_cond) != "II" && strtoupper($id_tipo_vinculo_cond) != "QP" && strtoupper($id_tipo_vinculo_cond) != "NP" && strtoupper($id_tipo_vinculo_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['id_tipo_vinculo_input_2'] = $Conteudo;
      $id_pessoa_juridica_look = substr($this->Db->qstr($id_pessoa_juridica), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($id_pessoa_juridica))
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['id_pessoa_juridica'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['id_pessoa_juridica'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['id_pessoa_juridica'] = $id_pessoa_juridica;
      }
      $Conteudo = $id_pessoa_juridica_input_2;
      if (strtoupper($id_pessoa_juridica_cond) != "II" && strtoupper($id_pessoa_juridica_cond) != "QP" && strtoupper($id_pessoa_juridica_cond) != "NP" && strtoupper($id_pessoa_juridica_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['id_pessoa_juridica_input_2'] = $Conteudo;
      $razao_social_look = substr($this->Db->qstr($razao_social), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct razao_social from " . $this->Ini->nm_tabela . " where razao_social = '$razao_social_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['fantasia'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['fantasia'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['fantasia'] = $fantasia;
      }

      //----- $id_tipo_vinculo
      $this->Date_part = false;
      if (isset($id_tipo_vinculo) || $id_tipo_vinculo_cond == "nu" || $id_tipo_vinculo_cond == "nn" || $id_tipo_vinculo_cond == "ep" || $id_tipo_vinculo_cond == "ne")
      {
         $this->monta_condicao("id_tipo_vinculo", $id_tipo_vinculo_cond, $id_tipo_vinculo, $id_tipo_vinculo_input_2, "id_tipo_vinculo");
      }

      //----- $id_pessoa_juridica
      $this->Date_part = false;
      if (isset($id_pessoa_juridica) || $id_pessoa_juridica_cond == "nu" || $id_pessoa_juridica_cond == "nn" || $id_pessoa_juridica_cond == "ep" || $id_pessoa_juridica_cond == "ne")
      {
         $this->monta_condicao("id_pessoa_juridica", $id_pessoa_juridica_cond, $id_pessoa_juridica, $id_pessoa_juridica_input_2, "id_pessoa_juridica");
      }
      ...
      {
         $this->monta_condicao("razao_social", $razao_social_cond, $razao_social, "", "razao_social");
      }

      //----- $fantasia
      $this->Date_part = false;
      if (isset($fantasia) || $fantasia_cond == "nu" || $fantasia_cond == "nn" || $fantasia_cond == "ep" || $fantasia_cond == "ne")
      {
         $this->monta_condicao("fantasia", $fantasia_cond, $fantasia, "", "fantasia");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_juridica']['where_pesq_ant'] = $this->comando . $this->comando_fim;
