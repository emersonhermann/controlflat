...
class app_grid_sec_users_xml
{
   ...
   function grava_arquivo()
   {
      ...
      { 
          $nmgp_select = "SELECT login, email, name, priv_admin, active from " . $this->Ini->nm_tabela; 
      } 
   ...
   function NM_export_priv_admin()
   {
         ...
         $this->xml_registro .= " priv_admin =\"" . $this->trata_dados($this->priv_admin) . "\"";
   }
   //----- active
