<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_public_pais_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_public_pais_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["id_pais"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_pais']['labels']["id_pais"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_pais']['labels']["id_pais"] : "Id Pais";
   $tab_ger_campos['pais_ibge_cod'] = "on";
   $tab_def_campos['pais_ibge_cod'] = "pais_ibge_cod";
   $tab_converte["pais_ibge_cod"]   = "pais_ibge_cod";
   $tab_labels["pais_ibge_cod"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_pais']['labels']["pais_ibge_cod"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_pais']['labels']["pais_ibge_cod"] : "Pais Ibge Cod";
   $tab_ger_campos['pais_nm_pais_ter_ptb'] = "on";
   $tab_def_campos['pais_nm_pais_ter_ptb'] = "pais_nm_pais_ter_ptb";
   $tab_converte["pais_nm_pais_ter_ptb"]   = "pais_nm_pais_ter_ptb";
   $tab_labels["pais_nm_pais_ter_ptb"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_pais']['labels']["pais_nm_pais_ter_ptb"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_pais']['labels']["pais_nm_pais_ter_ptb"] : "Pais Nm Pais Ter Ptb";
   $tab_ger_campos['pais_iso_alpha3_cod'] = "on";
   $tab_def_campos['pais_iso_alpha3_cod'] = "pais_iso_alpha3_cod";
   $tab_converte["pais_iso_alpha3_cod"]   = "pais_iso_alpha3_cod";
   $tab_labels["pais_iso_alpha3_cod"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_pais']['labels']["pais_iso_alpha3_cod"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_pais']['labels']["pais_iso_alpha3_cod"] : "Pais Iso Alpha 3 Cod";
   $tab_ger_campos['dt_cadastro'] = "on";
   $tab_def_campos['dt_cadastro'] = "dt_cadastro";
   $tab_converte["dt_cadastro"]   = "dt_cadastro";
   $tab_labels["dt_cadastro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_pais']['labels']["dt_cadastro"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_pais']['labels']["dt_cadastro"] : "Dt Cadastro";
   $tab_ger_campos['usu_cadastro'] = "on";
   $tab_def_campos['usu_cadastro'] = "usu_cadastro";
   $tab_converte["usu_cadastro"]   = "usu_cadastro";
   $tab_labels["usu_cadastro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_pais']['labels']["usu_cadastro"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_pais']['labels']["usu_cadastro"] : "Usu Cadastro";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_public_pais']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_public_pais']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_public_pais']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_public_pais']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_public_pais']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_public_pais']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_public_pais']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_public_pais']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_public_pais']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - Pais</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_public_pais_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_public_pais']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_public_pais']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
