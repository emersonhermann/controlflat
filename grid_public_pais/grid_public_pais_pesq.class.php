...
class grid_public_pais_pesq
{
    ...
    * @access  public
    */
   function grid_public_pais_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_public_pais_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_public_pais_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_public_pais_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_pais_iso_alpha3_cod')
      {
          $pais_iso_alpha3_cod = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_pais_iso_alpha3_cod($pais_iso_alpha3_cod);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_id_pais')
      {
          $id_pais = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_id_pais($id_pais);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
      ...
      if ($this->NM_ajax_opcao == 'autocomp_pais_ibge_cod')
      {
          $pais_ibge_cod = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_pais_ibge_cod($pais_ibge_cod);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
      ...
      if ($this->NM_ajax_opcao == 'autocomp_pais_nm_pais_ter_ptb')
      {
          $pais_nm_pais_ter_ptb = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_pais_nm_pais_ter_ptb($pais_nm_pais_ter_ptb);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_pais_iso_alpha3_cod($pais_iso_alpha3_cod)
   {
      $pais_iso_alpha3_cod = substr($this->Db->qstr($pais_iso_alpha3_cod), 1, -1);
            $pais_iso_alpha3_cod_look = substr($this->Db->qstr($pais_iso_alpha3_cod), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct pais_iso_alpha3_cod from " . $this->Ini->nm_tabela . " where  pais_iso_alpha3_cod like '%" . $pais_iso_alpha3_cod . "%'"; 
   ...
   function lookup_ajax_id_pais($id_pais)
   {
      $id_pais = substr($this->Db->qstr($id_pais), 1, -1);
            $id_pais_look = substr($this->Db->qstr($id_pais), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id_pais from " . $this->Ini->nm_tabela . " where   CAST (id_pais AS TEXT)  like '%" . $id_pais . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct id_pais from " . $this->Ini->nm_tabela . " where  id_pais like '%" . $id_pais . "%'"; 
      }
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_pais_ibge_cod($pais_ibge_cod)
   {
      $pais_ibge_cod = substr($this->Db->qstr($pais_ibge_cod), 1, -1);
            $pais_ibge_cod_look = substr($this->Db->qstr($pais_ibge_cod), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct pais_ibge_cod from " . $this->Ini->nm_tabela . " where  pais_ibge_cod like '%" . $pais_ibge_cod . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_pais_nm_pais_ter_ptb($pais_nm_pais_ter_ptb)
   {
      $pais_nm_pais_ter_ptb = substr($this->Db->qstr($pais_nm_pais_ter_ptb), 1, -1);
            $pais_nm_pais_ter_ptb_look = substr($this->Db->qstr($pais_nm_pais_ter_ptb), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct pais_nm_pais_ter_ptb from " . $this->Ini->nm_tabela . " where  pais_nm_pais_ter_ptb like '%" . $pais_nm_pais_ter_ptb . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Pais</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_public_pais/grid_public_pais_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_public_pais_ajax_search.js"></script>
 <script type="text/javascript" src="grid_public_pais_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_pais_iso_alpha3_cod_cond#NMF#' + search_get_sel_txt('SC_pais_iso_alpha3_cod_cond') + '@NMF@';
  str_out += 'SC_pais_iso_alpha3_cod#NMF#' + search_get_text('SC_pais_iso_alpha3_cod') + '@NMF@';
  str_out += 'id_ac_pais_iso_alpha3_cod#NMF#' + search_get_text('id_ac_pais_iso_alpha3_cod') + '@NMF@';
  str_out += 'SC_id_pais_cond#NMF#' + search_get_sel_txt('SC_id_pais_cond') + '@NMF@';
  str_out += 'SC_id_pais#NMF#' + search_get_text('SC_id_pais') + '@NMF@';
  str_out += 'id_ac_id_pais#NMF#' + search_get_text('id_ac_id_pais') + '@NMF@';
  str_out += 'SC_id_pais_input_2#NMF#' + search_get_text('SC_id_pais_input_2') + '@NMF@';
  str_out += 'SC_pais_ibge_cod_cond#NMF#' + search_get_sel_txt('SC_pais_ibge_cod_cond') + '@NMF@';
  str_out += 'SC_pais_ibge_cod#NMF#' + search_get_text('SC_pais_ibge_cod') + '@NMF@';
  str_out += 'id_ac_pais_ibge_cod#NMF#' + search_get_text('id_ac_pais_ibge_cod') + '@NMF@';
  str_out += 'SC_pais_nm_pais_ter_ptb_cond#NMF#' + search_get_sel_txt('SC_pais_nm_pais_ter_ptb_cond') + '@NMF@';
  str_out += 'SC_pais_nm_pais_ter_ptb#NMF#' + search_get_text('SC_pais_nm_pais_ter_ptb') + '@NMF@';
  str_out += 'id_ac_pais_nm_pais_ter_ptb#NMF#' + search_get_text('id_ac_pais_nm_pais_ter_ptb') + '@NMF@';
   ...
   $("#id_ac_id_pais").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_id_pais",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_id_pais").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_id_pais").val( $(this).val() );
       }
     }
   });
   $("#id_ac_pais_ibge_cod").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_pais_ibge_cod",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_pais_ibge_cod").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_pais_ibge_cod").val( $(this).val() );
       }
     }
   });
   $("#id_ac_pais_nm_pais_ter_ptb").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_pais_nm_pais_ter_ptb",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_pais_nm_pais_ter_ptb").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_pais_nm_pais_ter_ptb").val( $(this).val() );
       }
     }
   });
   $("#id_ac_pais_iso_alpha3_cod").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_pais_iso_alpha3_cod",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_pais_iso_alpha3_cod").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_pais_iso_alpha3_cod").val( $(this).val() );
       }
     }
   });
 });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Pais</span></td>
...
<?php
   ...
   {
      global 
             $pais_iso_alpha3_cod_cond, $pais_iso_alpha3_cod, $pais_iso_alpha3_cod_autocomp,
             $id_pais_cond, $id_pais, $id_pais_input_2, $id_pais_autocomp,
             $pais_ibge_cod_cond, $pais_ibge_cod, $pais_ibge_cod_autocomp,
             $pais_nm_pais_ter_ptb_cond, $pais_nm_pais_ter_ptb, $pais_nm_pais_ter_ptb_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $pais_iso_alpha3_cod = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['campos_busca']['pais_iso_alpha3_cod']; 
          $pais_iso_alpha3_cod_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['campos_busca']['pais_iso_alpha3_cod_cond']; 
          $id_pais = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['campos_busca']['id_pais']; 
          $id_pais_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['campos_busca']['id_pais_input_2']; 
          $id_pais_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['campos_busca']['id_pais_cond']; 
          $pais_ibge_cod = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['campos_busca']['pais_ibge_cod']; 
          $pais_ibge_cod_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['campos_busca']['pais_ibge_cod_cond']; 
          $pais_nm_pais_ter_ptb = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['campos_busca']['pais_nm_pais_ter_ptb']; 
          $pais_nm_pais_ter_ptb_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['campos_busca']['pais_nm_pais_ter_ptb_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['campos_busca']['NM_operador']; 
      } 
      if (!isset($pais_iso_alpha3_cod_cond) || empty($pais_iso_alpha3_cod_cond))
      {
         $pais_iso_alpha3_cod_cond = "qp";
      }
      if (!isset($id_pais_cond) || empty($id_pais_cond))
      {
         $id_pais_cond = "gt";
      }
      if (!isset($pais_ibge_cod_cond) || empty($pais_ibge_cod_cond))
      {
         $pais_ibge_cod_cond = "qp";
      }
      if (!isset($pais_nm_pais_ter_ptb_cond) || empty($pais_nm_pais_ter_ptb_cond))
      {
         $pais_nm_pais_ter_ptb_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_pais_iso_alpha3_cod = (in_array($pais_iso_alpha3_cod_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_id_pais = (in_array($id_pais_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_pais_ibge_cod = (in_array($pais_ibge_cod_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_pais_nm_pais_ter_ptb = (in_array($pais_nm_pais_ter_ptb_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_id_pais = ('bw' == $id_pais_cond) ? $display_aberto : $display_fechado;

      if (!isset($pais_iso_alpha3_cod) || $pais_iso_alpha3_cod == "")
      {
          $pais_iso_alpha3_cod = "";
      }
      if (isset($pais_iso_alpha3_cod) && !empty($pais_iso_alpha3_cod))
      {
         $tmp_pos = strpos($pais_iso_alpha3_cod, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $pais_iso_alpha3_cod = substr($pais_iso_alpha3_cod, 0, $tmp_pos);
         }
      }
      ...
      if (isset($id_pais) && !empty($id_pais))
      {
         $tmp_pos = strpos($id_pais, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_pais = substr($id_pais, 0, $tmp_pos);
         }
      }
      if (!isset($pais_ibge_cod) || $pais_ibge_cod == "")
      {
          $pais_ibge_cod = "";
      }
      if (isset($pais_ibge_cod) && !empty($pais_ibge_cod))
      {
         $tmp_pos = strpos($pais_ibge_cod, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $pais_ibge_cod = substr($pais_ibge_cod, 0, $tmp_pos);
         }
      }
      if (!isset($pais_nm_pais_ter_ptb) || $pais_nm_pais_ter_ptb == "")
      {
          $pais_nm_pais_ter_ptb = "";
      }
      if (isset($pais_nm_pais_ter_ptb) && !empty($pais_nm_pais_ter_ptb))
      {
         $tmp_pos = strpos($pais_nm_pais_ter_ptb, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $pais_nm_pais_ter_ptb = substr($pais_nm_pais_ter_ptb, 0, $tmp_pos);
         }
      }
?>
 <?php
...
<?php
   if (is_file("grid_public_pais_help.txt"))
   {
...
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['pais_iso_alpha3_cod'])) ? $this->New_label['pais_iso_alpha3_cod'] : "Pais Iso Alpha 3 Cod"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_pais_iso_alpha3_cod_cond" name="pais_iso_alpha3_cod_cond" onChange="nm_campos_between(document.getElementById('id_vis_pais_iso_alpha3_cod'), this, 'pais_iso_alpha3_cod')">
       <OPTION value="qp" <?php if ("qp" == $pais_iso_alpha3_cod_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $pais_iso_alpha3_cod_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $pais_iso_alpha3_cod_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $pais_iso_alpha3_cod_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_pais_iso_alpha3_cod" <?php echo $str_hide_pais_iso_alpha3_cod?> valign="top">
 ...
 $nmgp_tab_label .= "pais_iso_alpha3_cod?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $pais_iso_alpha3_cod_look = substr($this->Db->qstr($pais_iso_alpha3_cod), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct pais_iso_alpha3_cod from " . $this->Ini->nm_tabela . " where pais_iso_alpha3_cod = '$pais_iso_alpha3_cod_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$pais_iso_alpha3_cod]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$pais_iso_alpha3_cod];
      }
      else
      {
          $sAutocompValue = $pais_iso_alpha3_cod;
      }
?>
<INPUT  type="text" id="SC_pais_iso_alpha3_cod" name="pais_iso_alpha3_cod" value="<?php echo NM_encode_input($pais_iso_alpha3_cod) ?>" size=3 alt="{datatype: 'text', maxLength: 3, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_pais_iso_alpha3_cod" name="pais_iso_alpha3_cod_autocomp" size="3" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 3, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['id_pais'])) ? $this->New_label['id_pais'] : "Id Pais"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_id_pais_cond" name="id_pais_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_pais'), this, 'id_pais')">
       <OPTION value="gt" <?php if ("gt" == $id_pais_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_pais_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_pais_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $id_pais_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_pais" <?php echo $str_hide_id_pais?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['id_pais'])) ? $this->New_label['id_pais'] : "Id Pais";
 $nmgp_tab_label .= "id_pais?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $id_pais_look = substr($this->Db->qstr($id_pais), 1, -1); 
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id_pais from " . $this->Ini->nm_tabela . " where id_pais = $id_pais_look"; 
      }
      else
      {
          $nm_comando = "select distinct id_pais from " . $this->Ini->nm_tabela . " where id_pais = $id_pais_look"; 
      ...
      if (isset($nmgp_def_dados[0][$id_pais]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$id_pais];
      }
      else
      {
          $sAutocompValue = $id_pais;
      }
?>
<INPUT  type="text" id="SC_id_pais" name="id_pais" value="<?php echo NM_encode_input($id_pais) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_id_pais" name="id_pais_autocomp" size="9" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_id_pais"  <?php echo $str_display_id_pais; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_pais_input_2" name="id_pais_input_2" value="<?php echo NM_encode_input($id_pais_input_2) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['pais_ibge_cod'])) ? $this->New_label['pais_ibge_cod'] : "Pais Ibge Cod"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_pais_ibge_cod_cond" name="pais_ibge_cod_cond" onChange="nm_campos_between(document.getElementById('id_vis_pais_ibge_cod'), this, 'pais_ibge_cod')">
       <OPTION value="qp" <?php if ("qp" == $pais_ibge_cod_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $pais_ibge_cod_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $pais_ibge_cod_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $pais_ibge_cod_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_pais_ibge_cod" <?php echo $str_hide_pais_ibge_cod?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['pais_ibge_cod'])) ? $this->New_label['pais_ibge_cod'] : "Pais Ibge Cod";
 $nmgp_tab_label .= "pais_ibge_cod?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $pais_ibge_cod_look = substr($this->Db->qstr($pais_ibge_cod), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct pais_ibge_cod from " . $this->Ini->nm_tabela . " where pais_ibge_cod = '$pais_ibge_cod_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$pais_ibge_cod]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$pais_ibge_cod];
      }
      else
      {
          $sAutocompValue = $pais_ibge_cod;
      }
?>
<INPUT  type="text" id="SC_pais_ibge_cod" name="pais_ibge_cod" value="<?php echo NM_encode_input($pais_ibge_cod) ?>" size=3 alt="{datatype: 'text', maxLength: 3, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_pais_ibge_cod" name="pais_ibge_cod_autocomp" size="3" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 3, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['pais_nm_pais_ter_ptb'])) ? $this->New_label['pais_nm_pais_ter_ptb'] : "Pais Nm Pais Ter Ptb"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_pais_nm_pais_ter_ptb_cond" name="pais_nm_pais_ter_ptb_cond" onChange="nm_campos_between(document.getElementById('id_vis_pais_nm_pais_ter_ptb'), this, 'pais_nm_pais_ter_ptb')">
       <OPTION value="qp" <?php if ("qp" == $pais_nm_pais_ter_ptb_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $pais_nm_pais_ter_ptb_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $pais_nm_pais_ter_ptb_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $pais_nm_pais_ter_ptb_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_pais_nm_pais_ter_ptb" <?php echo $str_hide_pais_nm_pais_ter_ptb?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['pais_nm_pais_ter_ptb'])) ? $this->New_label['pais_nm_pais_ter_ptb'] : "Pais Nm Pais Ter Ptb";
 $nmgp_tab_label .= "pais_nm_pais_ter_ptb?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $pais_nm_pais_ter_ptb_look = substr($this->Db->qstr($pais_nm_pais_ter_ptb), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct pais_nm_pais_ter_ptb from " . $this->Ini->nm_tabela . " where pais_nm_pais_ter_ptb = '$pais_nm_pais_ter_ptb_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$pais_nm_pais_ter_ptb]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$pais_nm_pais_ter_ptb];
      }
      else
      {
          $sAutocompValue = $pais_nm_pais_ter_ptb;
      }
?>
<INPUT  type="text" id="SC_pais_nm_pais_ter_ptb" name="pais_nm_pais_ter_ptb" value="<?php echo NM_encode_input($pais_nm_pais_ter_ptb) ?>" size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_pais_nm_pais_ter_ptb" name="pais_nm_pais_ter_ptb_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_public_pais']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_public_pais']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_pais_iso_alpha3_cod'), document.F1.pais_iso_alpha3_cod_cond, 'pais_iso_alpha3_cod');
   document.F1.pais_iso_alpha3_cod.value = "";
   document.F1.pais_iso_alpha3_cod_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_id_pais'), document.F1.id_pais_cond, 'id_pais');
   document.F1.id_pais.value = "";
   document.F1.id_pais_autocomp.value = "";
   document.F1.id_pais_input_2.value = "";
   nm_campos_between(document.getElementById('id_vis_pais_ibge_cod'), document.F1.pais_ibge_cod_cond, 'pais_ibge_cod');
   document.F1.pais_ibge_cod.value = "";
   document.F1.pais_ibge_cod_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_pais_nm_pais_ter_ptb'), document.F1.pais_nm_pais_ter_ptb_cond, 'pais_nm_pais_ter_ptb');
   document.F1.pais_nm_pais_ter_ptb.value = "";
   document.F1.pais_nm_pais_ter_ptb_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "SYS_CONTROLFLAT/grid_public_pais";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_pais_iso_alpha3_cod_cond'] = 'cond';
      $tp_fields['SC_pais_iso_alpha3_cod'] = 'text_aut';
      $tp_fields['id_ac_pais_iso_alpha3_cod'] = 'text_aut';
      $tp_fields['SC_id_pais_cond'] = 'cond';
      $tp_fields['SC_id_pais'] = 'text_aut';
      $tp_fields['id_ac_id_pais'] = 'text_aut';
      $tp_fields['SC_id_pais_input_2'] = 'text';
      $tp_fields['SC_pais_ibge_cod_cond'] = 'cond';
      $tp_fields['SC_pais_ibge_cod'] = 'text_aut';
      $tp_fields['id_ac_pais_ibge_cod'] = 'text_aut';
      $tp_fields['SC_pais_nm_pais_ter_ptb_cond'] = 'cond';
      $tp_fields['SC_pais_nm_pais_ter_ptb'] = 'text_aut';
      $tp_fields['id_ac_pais_nm_pais_ter_ptb'] = 'text_aut';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $pais_iso_alpha3_cod_cond, $pais_iso_alpha3_cod, $pais_iso_alpha3_cod_autocomp,
             $id_pais_cond, $id_pais, $id_pais_input_2, $id_pais_autocomp,
             $pais_ibge_cod_cond, $pais_ibge_cod, $pais_ibge_cod_autocomp,
             $pais_nm_pais_ter_ptb_cond, $pais_nm_pais_ter_ptb, $pais_nm_pais_ter_ptb_autocomp, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($pais_iso_alpha3_cod_autocomp) && empty($pais_iso_alpha3_cod))
      {
          $pais_iso_alpha3_cod = $pais_iso_alpha3_cod_autocomp;
      }
      if (!empty($id_pais_autocomp) && empty($id_pais))
      {
          $id_pais = $id_pais_autocomp;
      }
      if (!empty($pais_ibge_cod_autocomp) && empty($pais_ibge_cod))
      {
          $pais_ibge_cod = $pais_ibge_cod_autocomp;
      }
      if (!empty($pais_nm_pais_ter_ptb_autocomp) && empty($pais_nm_pais_ter_ptb))
      {
          $pais_nm_pais_ter_ptb = $pais_nm_pais_ter_ptb_autocomp;
      }
      $pais_iso_alpha3_cod_cond_salva = $pais_iso_alpha3_cod_cond; 
      if (!isset($pais_iso_alpha3_cod_input_2) || $pais_iso_alpha3_cod_input_2 == "")
      {
          $pais_iso_alpha3_cod_input_2 = $pais_iso_alpha3_cod;
      }
      $id_pais_cond_salva = $id_pais_cond; 
      if (!isset($id_pais_input_2) || $id_pais_input_2 == "")
      {
          $id_pais_input_2 = $id_pais;
      }
      $pais_ibge_cod_cond_salva = $pais_ibge_cod_cond; 
      if (!isset($pais_ibge_cod_input_2) || $pais_ibge_cod_input_2 == "")
      {
          $pais_ibge_cod_input_2 = $pais_ibge_cod;
      }
      $pais_nm_pais_ter_ptb_cond_salva = $pais_nm_pais_ter_ptb_cond; 
      if (!isset($pais_nm_pais_ter_ptb_input_2) || $pais_nm_pais_ter_ptb_input_2 == "")
      {
          $pais_nm_pais_ter_ptb_input_2 = $pais_nm_pais_ter_ptb;
      }
      if ($id_pais_cond != "in")
      {
          nm_limpa_numero($id_pais, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $id_pais);
          ...
          $id_pais = implode(",", $Nm_sc_valores);
      }
      if ($id_pais_cond != "in")
      {
          nm_limpa_numero($id_pais_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['campos_busca']['pais_iso_alpha3_cod'] = $pais_iso_alpha3_cod; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['campos_busca']['pais_iso_alpha3_cod_cond'] = $pais_iso_alpha3_cod_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['campos_busca']['id_pais'] = $id_pais; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['campos_busca']['id_pais_input_2'] = $id_pais_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['campos_busca']['id_pais_cond'] = $id_pais_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['campos_busca']['pais_ibge_cod'] = $pais_ibge_cod; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['campos_busca']['pais_ibge_cod_cond'] = $pais_ibge_cod_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['campos_busca']['pais_nm_pais_ter_ptb'] = $pais_nm_pais_ter_ptb; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['campos_busca']['pais_nm_pais_ter_ptb_cond'] = $pais_nm_pais_ter_ptb_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($id_pais_cond != "in" && $id_pais_cond != "bw" && !empty($id_pais) && !is_numeric($id_pais))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Id Pais";
      }
      if ($id_pais_cond == "bw" && ((!empty($id_pais) && !is_numeric($id_pais)) || (!empty($id_pais_input_2) && !is_numeric($id_pais_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Id Pais";
      }
      if (!empty($this->Campos_Mens_erro)) 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['pais_iso_alpha3_cod'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['pais_iso_alpha3_cod'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['pais_iso_alpha3_cod'] = $pais_iso_alpha3_cod;
      }
      $id_pais_look = substr($this->Db->qstr($id_pais), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($id_pais))
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['id_pais'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['id_pais'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['id_pais'] = $id_pais;
      }
      $Conteudo = $id_pais_input_2;
      if (strtoupper($id_pais_cond) != "II" && strtoupper($id_pais_cond) != "QP" && strtoupper($id_pais_cond) != "NP" && strtoupper($id_pais_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['id_pais_input_2'] = $Conteudo;
      $pais_ibge_cod_look = substr($this->Db->qstr($pais_ibge_cod), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct pais_ibge_cod from " . $this->Ini->nm_tabela . " where pais_ibge_cod = '$pais_ibge_cod_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['pais_ibge_cod'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['pais_ibge_cod'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['pais_ibge_cod'] = $pais_ibge_cod;
      }
      $pais_nm_pais_ter_ptb_look = substr($this->Db->qstr($pais_nm_pais_ter_ptb), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct pais_nm_pais_ter_ptb from " . $this->Ini->nm_tabela . " where pais_nm_pais_ter_ptb = '$pais_nm_pais_ter_ptb_look'"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['pais_nm_pais_ter_ptb'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['pais_nm_pais_ter_ptb'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['pais_nm_pais_ter_ptb'] = $pais_nm_pais_ter_ptb;
      }

      //----- $pais_iso_alpha3_cod
      $this->Date_part = false;
      if (isset($pais_iso_alpha3_cod) || $pais_iso_alpha3_cod_cond == "nu" || $pais_iso_alpha3_cod_cond == "nn" || $pais_iso_alpha3_cod_cond == "ep" || $pais_iso_alpha3_cod_cond == "ne")
      {
         $this->monta_condicao("pais_iso_alpha3_cod", $pais_iso_alpha3_cod_cond, $pais_iso_alpha3_cod, "", "pais_iso_alpha3_cod");
      }

      //----- $id_pais
      $this->Date_part = false;
      if (isset($id_pais) || $id_pais_cond == "nu" || $id_pais_cond == "nn" || $id_pais_cond == "ep" || $id_pais_cond == "ne")
      {
         $this->monta_condicao("id_pais", $id_pais_cond, $id_pais, $id_pais_input_2, "id_pais");
      }

      //----- $pais_ibge_cod
      $this->Date_part = false;
      if (isset($pais_ibge_cod) || $pais_ibge_cod_cond == "nu" || $pais_ibge_cod_cond == "nn" || $pais_ibge_cod_cond == "ep" || $pais_ibge_cod_cond == "ne")
      {
         $this->monta_condicao("pais_ibge_cod", $pais_ibge_cod_cond, $pais_ibge_cod, "", "pais_ibge_cod");
      }

      //----- $pais_nm_pais_ter_ptb
      $this->Date_part = false;
      if (isset($pais_nm_pais_ter_ptb) || $pais_nm_pais_ter_ptb_cond == "nu" || $pais_nm_pais_ter_ptb_cond == "nn" || $pais_nm_pais_ter_ptb_cond == "ep" || $pais_nm_pais_ter_ptb_cond == "ne")
      {
         $this->monta_condicao("pais_nm_pais_ter_ptb", $pais_nm_pais_ter_ptb_cond, $pais_nm_pais_ter_ptb, "", "pais_nm_pais_ter_ptb");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['where_pesq_ant'] = $this->comando . $this->comando_fim;
