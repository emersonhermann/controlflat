...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "dt_cadastro";$Nm_datas[] = "dt_atualiza";$Nm_numeric[] = "id_pais";$Nm_numeric[] = "id_ativo";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_pais_iso_alpha3_cod"  <?php echo $str_hide_pais_iso_alpha3_cod?>><?php
      $pais_iso_alpha3_cod_look = substr($this->Db->qstr($pais_iso_alpha3_cod), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_id_pais"  <?php echo $str_hide_id_pais?>><?php
      $id_pais_look = substr($this->Db->qstr($id_pais), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_id_pais" name="id_pais_autocomp" size="9" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_id_pais"  <?php echo $str_display_id_pais; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_pais_input_2" name="id_pais_input_2" value="<?php echo NM_encode_input($id_pais_input_2) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_pais_ibge_cod"  <?php echo $str_hide_pais_ibge_cod?>><?php
      $pais_ibge_cod_look = substr($this->Db->qstr($pais_ibge_cod), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_pais_nm_pais_ter_ptb"  <?php echo $str_hide_pais_nm_pais_ter_ptb?>><?php
      $pais_nm_pais_ter_ptb_look = substr($this->Db->qstr($pais_nm_pais_ter_ptb), 1, -1); 
      $nmgp_def_dados = array(); 
