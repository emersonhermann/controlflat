...
class grid_public_pais_xml
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_public_pais.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_public_pais";
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->pais_ibge_cod))
         {
             $this->pais_ibge_cod = sc_convert_encoding($this->pais_ibge_cod, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " pais_ibge_cod =\"" . $this->trata_dados($this->pais_ibge_cod) . "\"";
   }
   //----- pais_nm_pais_ter_ptb
   function NM_export_pais_nm_pais_ter_ptb()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->pais_nm_pais_ter_ptb))
         {
             $this->pais_nm_pais_ter_ptb = sc_convert_encoding($this->pais_nm_pais_ter_ptb, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " pais_nm_pais_ter_ptb =\"" . $this->trata_dados($this->pais_nm_pais_ter_ptb) . "\"";
   }
   //----- pais_iso_alpha3_cod
   function NM_export_pais_iso_alpha3_cod()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->pais_iso_alpha3_cod))
         {
             $this->pais_iso_alpha3_cod = sc_convert_encoding($this->pais_iso_alpha3_cod, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " pais_iso_alpha3_cod =\"" . $this->trata_dados($this->pais_iso_alpha3_cod) . "\"";
   }
   //----- dt_cadastro
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pais']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Pais :: XML</TITLE>
