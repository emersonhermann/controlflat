...
class grid_public_pessoa_fisica_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function grid_public_pessoa_fisica_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_public_pessoa_fisica_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_public_pessoa_fisica_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_public_pessoa_fisica_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_public_pessoa_fisica_nome')
      {
          $public_pessoa_fisica_nome = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_public_pessoa_fisica_nome($public_pessoa_fisica_nome);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_public_pessoa_fisica_id_pessoa_fisica')
      {
          $public_pessoa_fisica_id_pessoa_fisica = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_public_pessoa_fisica_id_pessoa_fisica($public_pessoa_fisica_id_pessoa_fisica);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_public_pessoa_fisica_nome($public_pessoa_fisica_nome)
   {
      $public_pessoa_fisica_nome = substr($this->Db->qstr($public_pessoa_fisica_nome), 1, -1);
            $public_pessoa_fisica_nome_look = substr($this->Db->qstr($public_pessoa_fisica_nome), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nome from " . $this->Ini->nm_tabela . " where  nome like '%" . $public_pessoa_fisica_nome . "%'"; 
   ...
   function lookup_ajax_public_pessoa_fisica_id_pessoa_fisica($public_pessoa_fisica_id_pessoa_fisica)
   {
      $public_pessoa_fisica_id_pessoa_fisica = substr($this->Db->qstr($public_pessoa_fisica_id_pessoa_fisica), 1, -1);
            $public_pessoa_fisica_id_pessoa_fisica_look = substr($this->Db->qstr($public_pessoa_fisica_id_pessoa_fisica), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id_pessoa_fisica from " . $this->Ini->nm_tabela . " where   CAST (id_pessoa_fisica AS TEXT)  like '%" . $public_pessoa_fisica_id_pessoa_fisica . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct id_pessoa_fisica from " . $this->Ini->nm_tabela . " where  id_pessoa_fisica like '%" . $public_pessoa_fisica_id_pessoa_fisica . "%'"; 
      }
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $Nm_datas[] = "public_pessoa_fisica_dt_nasc";$Nm_datas[] = "public_pessoa_fisica_rg_dt_emissao";$Nm_datas[] = "public_pessoa_fisica_passaporte_dt_emissao";$Nm_datas[] = "public_pessoa_fisica_cnh_dt_validade";$Nm_datas[] = "dt_cadastro";$Nm_datas[] = "dt_atualiza";
      $campo_join = strtolower(str_replace(".", "_", $nome));
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Pessoa Física</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_public_pessoa_fisica/grid_public_pessoa_fisica_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_public_pessoa_fisica_ajax_search.js"></script>
 <script type="text/javascript" src="grid_public_pessoa_fisica_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_public_pessoa_fisica_nome_cond#NMF#' + search_get_sel_txt('SC_public_pessoa_fisica_nome_cond') + '@NMF@';
  str_out += 'SC_public_pessoa_fisica_nome#NMF#' + search_get_text('SC_public_pessoa_fisica_nome') + '@NMF@';
  str_out += 'id_ac_public_pessoa_fisica_nome#NMF#' + search_get_text('id_ac_public_pessoa_fisica_nome') + '@NMF@';
  str_out += 'SC_public_pessoa_fisica_id_pessoa_fisica_cond#NMF#' + search_get_sel_txt('SC_public_pessoa_fisica_id_pessoa_fisica_cond') + '@NMF@';
  str_out += 'SC_public_pessoa_fisica_id_pessoa_fisica#NMF#' + search_get_text('SC_public_pessoa_fisica_id_pessoa_fisica') + '@NMF@';
  str_out += 'id_ac_public_pessoa_fisica_id_pessoa_fisica#NMF#' + search_get_text('id_ac_public_pessoa_fisica_id_pessoa_fisica') + '@NMF@';
  str_out += 'SC_public_pessoa_fisica_id_pessoa_fisica_input_2#NMF#' + search_get_text('SC_public_pessoa_fisica_id_pessoa_fisica_input_2') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   $("#id_ac_public_pessoa_fisica_id_pessoa_fisica").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_public_pessoa_fisica_id_pessoa_fisica",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_public_pessoa_fisica_id_pessoa_fisica").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_public_pessoa_fisica_id_pessoa_fisica").val( $(this).val() );
       }
     }
   });
   $("#id_ac_public_pessoa_fisica_nome").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_public_pessoa_fisica_nome",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_public_pessoa_fisica_nome").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_public_pessoa_fisica_nome").val( $(this).val() );
       }
     }
   });
 });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Pessoa Física</span></td>
...
<?php
   ...
   {
      global 
             $public_pessoa_fisica_nome_cond, $public_pessoa_fisica_nome, $public_pessoa_fisica_nome_autocomp,
             $public_pessoa_fisica_id_pessoa_fisica_cond, $public_pessoa_fisica_id_pessoa_fisica, $public_pessoa_fisica_id_pessoa_fisica_input_2, $public_pessoa_fisica_id_pessoa_fisica_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $public_pessoa_fisica_nome = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['campos_busca']['public_pessoa_fisica_nome']; 
          $public_pessoa_fisica_nome_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['campos_busca']['public_pessoa_fisica_nome_cond']; 
          $public_pessoa_fisica_id_pessoa_fisica = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['campos_busca']['public_pessoa_fisica_id_pessoa_fisica']; 
          $public_pessoa_fisica_id_pessoa_fisica_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['campos_busca']['public_pessoa_fisica_id_pessoa_fisica_input_2']; 
          $public_pessoa_fisica_id_pessoa_fisica_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['campos_busca']['public_pessoa_fisica_id_pessoa_fisica_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['campos_busca']['NM_operador']; 
      } 
      if (!isset($public_pessoa_fisica_nome_cond) || empty($public_pessoa_fisica_nome_cond))
      {
         $public_pessoa_fisica_nome_cond = "qp";
      }
      if (!isset($public_pessoa_fisica_id_pessoa_fisica_cond) || empty($public_pessoa_fisica_id_pessoa_fisica_cond))
      {
         $public_pessoa_fisica_id_pessoa_fisica_cond = "gt";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_public_pessoa_fisica_nome = (in_array($public_pessoa_fisica_nome_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_public_pessoa_fisica_id_pessoa_fisica = (in_array($public_pessoa_fisica_id_pessoa_fisica_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_public_pessoa_fisica_id_pessoa_fisica = ('bw' == $public_pessoa_fisica_id_pessoa_fisica_cond) ? $display_aberto : $display_fechado;

      if (!isset($public_pessoa_fisica_nome) || $public_pessoa_fisica_nome == "")
      {
          $public_pessoa_fisica_nome = "";
      }
      if (isset($public_pessoa_fisica_nome) && !empty($public_pessoa_fisica_nome))
      {
         $tmp_pos = strpos($public_pessoa_fisica_nome, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $public_pessoa_fisica_nome = substr($public_pessoa_fisica_nome, 0, $tmp_pos);
         }
      }
      if (!isset($public_pessoa_fisica_id_pessoa_fisica) || $public_pessoa_fisica_id_pessoa_fisica == "")
      {
          $public_pessoa_fisica_id_pessoa_fisica = "";
      }
      if (isset($public_pessoa_fisica_id_pessoa_fisica) && !empty($public_pessoa_fisica_id_pessoa_fisica))
      {
         $tmp_pos = strpos($public_pessoa_fisica_id_pessoa_fisica, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $public_pessoa_fisica_id_pessoa_fisica = substr($public_pessoa_fisica_id_pessoa_fisica, 0, $tmp_pos);
         }
      }
?>
 <?php
...
<?php
   if (is_file("grid_public_pessoa_fisica_help.txt"))
   {
...
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['public_pessoa_fisica_nome'])) ? $this->New_label['public_pessoa_fisica_nome'] : "Nome"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_public_pessoa_fisica_nome_cond" name="public_pessoa_fisica_nome_cond" onChange="nm_campos_between(document.getElementById('id_vis_public_pessoa_fisica_nome'), this, 'public_pessoa_fisica_nome')">
       <OPTION value="qp" <?php if ("qp" == $public_pessoa_fisica_nome_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $public_pessoa_fisica_nome_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $public_pessoa_fisica_nome_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $public_pessoa_fisica_nome_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_public_pessoa_fisica_nome" <?php echo $str_hide_public_pessoa_fisica_nome?> valign="top">
 ...
 $nmgp_tab_label .= "public_pessoa_fisica_nome?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $public_pessoa_fisica_nome_look = substr($this->Db->qstr($public_pessoa_fisica_nome), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nome from " . $this->Ini->nm_tabela . " where nome = '$public_pessoa_fisica_nome_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$public_pessoa_fisica_nome]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$public_pessoa_fisica_nome];
      }
      else
      {
          $sAutocompValue = $public_pessoa_fisica_nome;
      }
?>
<INPUT  type="text" id="SC_public_pessoa_fisica_nome" name="public_pessoa_fisica_nome" value="<?php echo NM_encode_input($public_pessoa_fisica_nome) ?>" size=50 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_public_pessoa_fisica_nome" name="public_pessoa_fisica_nome_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['public_pessoa_fisica_id_pessoa_fisica'])) ? $this->New_label['public_pessoa_fisica_id_pessoa_fisica'] : "ID Pessoa Fisica"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_public_pessoa_fisica_id_pessoa_fisica_cond" name="public_pessoa_fisica_id_pessoa_fisica_cond" onChange="nm_campos_between(document.getElementById('id_vis_public_pessoa_fisica_id_pessoa_fisica'), this, 'public_pessoa_fisica_id_pessoa_fisica')">
       <OPTION value="gt" <?php if ("gt" == $public_pessoa_fisica_id_pessoa_fisica_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $public_pessoa_fisica_id_pessoa_fisica_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $public_pessoa_fisica_id_pessoa_fisica_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $public_pessoa_fisica_id_pessoa_fisica_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_public_pessoa_fisica_id_pessoa_fisica" <?php echo $str_hide_public_pessoa_fisica_id_pessoa_fisica?> valign="top">
 ...
 $nmgp_tab_label .= "public_pessoa_fisica_id_pessoa_fisica?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $public_pessoa_fisica_id_pessoa_fisica_look = substr($this->Db->qstr($public_pessoa_fisica_id_pessoa_fisica), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($public_pessoa_fisica_id_pessoa_fisica))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id_pessoa_fisica from " . $this->Ini->nm_tabela . " where id_pessoa_fisica = $public_pessoa_fisica_id_pessoa_fisica_look"; 
      }
      else
      {
          $nm_comando = "select distinct id_pessoa_fisica from " . $this->Ini->nm_tabela . " where id_pessoa_fisica = $public_pessoa_fisica_id_pessoa_fisica_look"; 
      ...
      if (isset($nmgp_def_dados[0][$public_pessoa_fisica_id_pessoa_fisica]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$public_pessoa_fisica_id_pessoa_fisica];
      }
      else
      {
          $sAutocompValue = $public_pessoa_fisica_id_pessoa_fisica;
      }
?>
<INPUT  type="text" id="SC_public_pessoa_fisica_id_pessoa_fisica" name="public_pessoa_fisica_id_pessoa_fisica" value="<?php echo NM_encode_input($public_pessoa_fisica_id_pessoa_fisica) ?>" size=17 alt="{datatype: 'integer', maxLength: 17, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_public_pessoa_fisica_id_pessoa_fisica" name="public_pessoa_fisica_id_pessoa_fisica_autocomp" size="17" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 17, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_public_pessoa_fisica_id_pessoa_fisica"  <?php echo $str_display_public_pessoa_fisica_id_pessoa_fisica; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_public_pessoa_fisica_id_pessoa_fisica_input_2" name="public_pessoa_fisica_id_pessoa_fisica_input_2" value="<?php echo NM_encode_input($public_pessoa_fisica_id_pessoa_fisica_input_2) ?>" size=17 alt="{datatype: 'integer', maxLength: 17, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_public_pessoa_fisica']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_public_pessoa_fisica']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_public_pessoa_fisica_nome'), document.F1.public_pessoa_fisica_nome_cond, 'public_pessoa_fisica_nome');
   document.F1.public_pessoa_fisica_nome.value = "";
   document.F1.public_pessoa_fisica_nome_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_public_pessoa_fisica_id_pessoa_fisica'), document.F1.public_pessoa_fisica_id_pessoa_fisica_cond, 'public_pessoa_fisica_id_pessoa_fisica');
   document.F1.public_pessoa_fisica_id_pessoa_fisica.value = "";
   document.F1.public_pessoa_fisica_id_pessoa_fisica_autocomp.value = "";
   document.F1.public_pessoa_fisica_id_pessoa_fisica_input_2.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "SYS_CONTROLFLAT/grid_public_pessoa_fisica";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_public_pessoa_fisica/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_public_pessoa_fisica_nome_cond'] = 'cond';
      $tp_fields['SC_public_pessoa_fisica_nome'] = 'text_aut';
      $tp_fields['id_ac_public_pessoa_fisica_nome'] = 'text_aut';
      $tp_fields['SC_public_pessoa_fisica_id_pessoa_fisica_cond'] = 'cond';
      $tp_fields['SC_public_pessoa_fisica_id_pessoa_fisica'] = 'text_aut';
      $tp_fields['id_ac_public_pessoa_fisica_id_pessoa_fisica'] = 'text_aut';
      $tp_fields['SC_public_pessoa_fisica_id_pessoa_fisica_input_2'] = 'text';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $public_pessoa_fisica_nome_cond, $public_pessoa_fisica_nome, $public_pessoa_fisica_nome_autocomp,
             $public_pessoa_fisica_id_pessoa_fisica_cond, $public_pessoa_fisica_id_pessoa_fisica, $public_pessoa_fisica_id_pessoa_fisica_input_2, $public_pessoa_fisica_id_pessoa_fisica_autocomp, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($public_pessoa_fisica_nome_autocomp) && empty($public_pessoa_fisica_nome))
      {
          $public_pessoa_fisica_nome = $public_pessoa_fisica_nome_autocomp;
      }
      if (!empty($public_pessoa_fisica_id_pessoa_fisica_autocomp) && empty($public_pessoa_fisica_id_pessoa_fisica))
      {
          $public_pessoa_fisica_id_pessoa_fisica = $public_pessoa_fisica_id_pessoa_fisica_autocomp;
      }
      $public_pessoa_fisica_nome_cond_salva = $public_pessoa_fisica_nome_cond; 
      if (!isset($public_pessoa_fisica_nome_input_2) || $public_pessoa_fisica_nome_input_2 == "")
      {
          $public_pessoa_fisica_nome_input_2 = $public_pessoa_fisica_nome;
      }
      $public_pessoa_fisica_id_pessoa_fisica_cond_salva = $public_pessoa_fisica_id_pessoa_fisica_cond; 
      if (!isset($public_pessoa_fisica_id_pessoa_fisica_input_2) || $public_pessoa_fisica_id_pessoa_fisica_input_2 == "")
      {
          $public_pessoa_fisica_id_pessoa_fisica_input_2 = $public_pessoa_fisica_id_pessoa_fisica;
      }
      if ($public_pessoa_fisica_id_pessoa_fisica_cond != "in")
      {
          nm_limpa_numero($public_pessoa_fisica_id_pessoa_fisica, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $public_pessoa_fisica_id_pessoa_fisica);
          ...
          $public_pessoa_fisica_id_pessoa_fisica = implode(",", $Nm_sc_valores);
      }
      if ($public_pessoa_fisica_id_pessoa_fisica_cond != "in")
      {
          nm_limpa_numero($public_pessoa_fisica_id_pessoa_fisica_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['campos_busca']['public_pessoa_fisica_nome'] = $public_pessoa_fisica_nome; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['campos_busca']['public_pessoa_fisica_nome_cond'] = $public_pessoa_fisica_nome_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['campos_busca']['public_pessoa_fisica_id_pessoa_fisica'] = $public_pessoa_fisica_id_pessoa_fisica; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['campos_busca']['public_pessoa_fisica_id_pessoa_fisica_input_2'] = $public_pessoa_fisica_id_pessoa_fisica_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['campos_busca']['public_pessoa_fisica_id_pessoa_fisica_cond'] = $public_pessoa_fisica_id_pessoa_fisica_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($public_pessoa_fisica_id_pessoa_fisica_cond != "in" && $public_pessoa_fisica_id_pessoa_fisica_cond != "bw" && !empty($public_pessoa_fisica_id_pessoa_fisica) && !is_numeric($public_pessoa_fisica_id_pessoa_fisica))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : ID Pessoa Fisica";
      }
      if ($public_pessoa_fisica_id_pessoa_fisica_cond == "bw" && ((!empty($public_pessoa_fisica_id_pessoa_fisica) && !is_numeric($public_pessoa_fisica_id_pessoa_fisica)) || (!empty($public_pessoa_fisica_id_pessoa_fisica_input_2) && !is_numeric($public_pessoa_fisica_id_pessoa_fisica_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : ID Pessoa Fisica";
      }
      if (!empty($this->Campos_Mens_erro)) 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['public_pessoa_fisica_nome'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['public_pessoa_fisica_nome'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['public_pessoa_fisica_nome'] = $public_pessoa_fisica_nome;
      }
      $public_pessoa_fisica_id_pessoa_fisica_look = substr($this->Db->qstr($public_pessoa_fisica_id_pessoa_fisica), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($public_pessoa_fisica_id_pessoa_fisica))
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['public_pessoa_fisica_id_pessoa_fisica'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['public_pessoa_fisica_id_pessoa_fisica'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['public_pessoa_fisica_id_pessoa_fisica'] = $public_pessoa_fisica_id_pessoa_fisica;
      }
      $Conteudo = $public_pessoa_fisica_id_pessoa_fisica_input_2;
      if (strtoupper($public_pessoa_fisica_id_pessoa_fisica_cond) != "II" && strtoupper($public_pessoa_fisica_id_pessoa_fisica_cond) != "QP" && strtoupper($public_pessoa_fisica_id_pessoa_fisica_cond) != "NP" && strtoupper($public_pessoa_fisica_id_pessoa_fisica_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['public_pessoa_fisica_id_pessoa_fisica_input_2'] = $Conteudo;

      //----- $public_pessoa_fisica_nome
      $this->Date_part = false;
      if (isset($public_pessoa_fisica_nome) || $public_pessoa_fisica_nome_cond == "nu" || $public_pessoa_fisica_nome_cond == "nn" || $public_pessoa_fisica_nome_cond == "ep" || $public_pessoa_fisica_nome_cond == "ne")
      {
         $this->monta_condicao("nome", $public_pessoa_fisica_nome_cond, $public_pessoa_fisica_nome, "", "public_pessoa_fisica_nome");
      }

      //----- $public_pessoa_fisica_id_pessoa_fisica
      $this->Date_part = false;
      if (isset($public_pessoa_fisica_id_pessoa_fisica) || $public_pessoa_fisica_id_pessoa_fisica_cond == "nu" || $public_pessoa_fisica_id_pessoa_fisica_cond == "nn" || $public_pessoa_fisica_id_pessoa_fisica_cond == "ep" || $public_pessoa_fisica_id_pessoa_fisica_cond == "ne")
      {
         $this->monta_condicao("id_pessoa_fisica", $public_pessoa_fisica_id_pessoa_fisica_cond, $public_pessoa_fisica_id_pessoa_fisica, $public_pessoa_fisica_id_pessoa_fisica_input_2, "public_pessoa_fisica_id_pessoa_fisica");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_pessoa_fisica']['where_pesq_ant'] = $this->comando . $this->comando_fim;
