...
//
   ...
   $_SESSION['scriptcase']['app_Login']['glo_nm_perfil']          = "BDSEC_POS";
   $_SESSION['scriptcase']['app_Login']['glo_nm_path_prod']       = "/scriptcase8/prod";
   $_SESSION['scriptcase']['app_Login']['glo_nm_path_imagens']    = "/scriptcase8/file/img";
   $_SESSION['scriptcase']['app_Login']['glo_nm_path_imag_temp']  = "/scriptcase8/tmp";
   $_SESSION['scriptcase']['app_Login']['glo_nm_path_doc']        = "/doc";
//
class app_Login_ini
{
   var $nm_cod_apl;
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_Login']['glo_nm_conexao'], $this->root . $this->path_prod, 'SYS_CONTROLFLAT'); 
      } 
      else 
      { 
...
//
    ...
    function ajax_app_Login_submit_form($login, $pswd, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $captcha_code, $csrf_token)
    {
        global $inicial_app_Login;
        //register_shutdown_function("app_Login_pack_ajax_response");
        $inicial_app_Login->contr_app_Login->NM_ajax_flag          = true;
