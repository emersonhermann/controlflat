...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_dt_cadastro_hora' + iSeqRow).bind('blur', function() { sc_form_public_pais_dt_cadastro_onblur(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_public_pais_dt_cadastro_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_dt_atualiza_hora' + iSeqRow).bind('blur', function() { sc_form_public_pais_dt_atualiza_onblur(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_public_pais_dt_atualiza_onfocus(this, iSeqRow) });
