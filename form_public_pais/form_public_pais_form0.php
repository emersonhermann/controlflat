...
<?php
include_once("form_public_pais_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_public_pais_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['recarga'];
}
?>
...
<?php
 include_once("form_public_pais_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_public_pais'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_public_pais'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_pais_label" id="hidden_field_label_id_pais" style="<?php echo $sStyleHidden_id_pais; ?>"><span id="id_label_id_pais"><?php echo $this->nm_new_label['id_pais']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['php_cmp_required']['id_pais']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['php_cmp_required']['id_pais'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_id_pais_line" id="hidden_field_data_id_pais" style="<?php echo $sStyleHidden_id_pais; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_pais_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pais_ibge_cod_label" id="hidden_field_label_pais_ibge_cod" style="<?php echo $sStyleHidden_pais_ibge_cod; ?>"><span id="id_label_pais_ibge_cod"><?php echo $this->nm_new_label['pais_ibge_cod']; ?></span></TD>
    <TD class="scFormDataOdd css_pais_ibge_cod_line" id="hidden_field_data_pais_ibge_cod" style="<?php echo $sStyleHidden_pais_ibge_cod; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pais_ibge_cod_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pais_nm_pais_ter_ptb_label" id="hidden_field_label_pais_nm_pais_ter_ptb" style="<?php echo $sStyleHidden_pais_nm_pais_ter_ptb; ?>"><span id="id_label_pais_nm_pais_ter_ptb"><?php echo $this->nm_new_label['pais_nm_pais_ter_ptb']; ?></span></TD>
    <TD class="scFormDataOdd css_pais_nm_pais_ter_ptb_line" id="hidden_field_data_pais_nm_pais_ter_ptb" style="<?php echo $sStyleHidden_pais_nm_pais_ter_ptb; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pais_nm_pais_ter_ptb_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pais_iso_alpha3_cod_label" id="hidden_field_label_pais_iso_alpha3_cod" style="<?php echo $sStyleHidden_pais_iso_alpha3_cod; ?>"><span id="id_label_pais_iso_alpha3_cod"><?php echo $this->nm_new_label['pais_iso_alpha3_cod']; ?></span></TD>
    <TD class="scFormDataOdd css_pais_iso_alpha3_cod_line" id="hidden_field_data_pais_iso_alpha3_cod" style="<?php echo $sStyleHidden_pais_iso_alpha3_cod; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pais_iso_alpha3_cod_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pais_nm_pais_ter_ptb2_label" id="hidden_field_label_pais_nm_pais_ter_ptb2" style="<?php echo $sStyleHidden_pais_nm_pais_ter_ptb2; ?>"><span id="id_label_pais_nm_pais_ter_ptb2"><?php echo $this->nm_new_label['pais_nm_pais_ter_ptb2']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pais_sigla_label" id="hidden_field_label_pais_sigla" style="<?php echo $sStyleHidden_pais_sigla; ?>"><span id="id_label_pais_sigla"><?php echo $this->nm_new_label['pais_sigla']; ?></span></TD>
    <TD class="scFormDataOdd css_pais_sigla_line" id="hidden_field_data_pais_sigla" style="<?php echo $sStyleHidden_pais_sigla; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pais_sigla_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pais_capital_label" id="hidden_field_label_pais_capital" style="<?php echo $sStyleHidden_pais_capital; ?>"><span id="id_label_pais_capital"><?php echo $this->nm_new_label['pais_capital']; ?></span></TD>
    <TD class="scFormDataOdd css_pais_capital_line" id="hidden_field_data_pais_capital" style="<?php echo $sStyleHidden_pais_capital; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pais_capital_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pais_moeda_label" id="hidden_field_label_pais_moeda" style="<?php echo $sStyleHidden_pais_moeda; ?>"><span id="id_label_pais_moeda"><?php echo $this->nm_new_label['pais_moeda']; ?></span></TD>
    <TD class="scFormDataOdd css_pais_moeda_line" id="hidden_field_data_pais_moeda" style="<?php echo $sStyleHidden_pais_moeda; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pais_moeda_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_moeda_label" id="hidden_field_label_id_moeda" style="<?php echo $sStyleHidden_id_moeda; ?>"><span id="id_label_id_moeda"><?php echo $this->nm_new_label['id_moeda']; ?></span></TD>
    <TD class="scFormDataOdd css_id_moeda_line" id="hidden_field_data_id_moeda" style="<?php echo $sStyleHidden_id_moeda; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_moeda_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pais_idioma_label" id="hidden_field_label_pais_idioma" style="<?php echo $sStyleHidden_pais_idioma; ?>"><span id="id_label_pais_idioma"><?php echo $this->nm_new_label['pais_idioma']; ?></span></TD>
    <TD class="scFormDataOdd css_pais_idioma_line" id="hidden_field_data_pais_idioma" style="<?php echo $sStyleHidden_pais_idioma; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pais_idioma_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pais_dominio_label" id="hidden_field_label_pais_dominio" style="<?php echo $sStyleHidden_pais_dominio; ?>"><span id="id_label_pais_dominio"><?php echo $this->nm_new_label['pais_dominio']; ?></span></TD>
    <TD class="scFormDataOdd css_pais_dominio_line" id="hidden_field_data_pais_dominio" style="<?php echo $sStyleHidden_pais_dominio; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pais_dominio_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pais_obs_label" id="hidden_field_label_pais_obs" style="<?php echo $sStyleHidden_pais_obs; ?>"><span id="id_label_pais_obs"><?php echo $this->nm_new_label['pais_obs']; ?></span></TD>
    <TD class="scFormDataOdd css_pais_obs_line" id="hidden_field_data_pais_obs" style="<?php echo $sStyleHidden_pais_obs; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pais_obs_line" style="vertical-align: top;padding: 0px">
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['mostra_cab'] != "N"))
  {
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_pais']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_public_pais");
 parent.scAjaxDetailHeight("form_public_pais", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
