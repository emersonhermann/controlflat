<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_perfil']          = "BDSEC_POS";
   $_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_path_prod']       = "/scriptcase8/prod";
   $_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_path_imagens']    = "/scriptcase8/file/img";
   $_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_path_imag_temp']  = "/scriptcase8/tmp";
   $_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_path_doc']        = "/doc";
//
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_conexao'], $this->root . $this->path_prod, 'SYS_CONTROLFLAT'); 
      } 
      else 
      { 
...
//----- 
   function controle()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_conexao'], $this->Ini->root . $this->Ini->path_prod, 'SYS_CONTROLFLAT'); 
      } 
      else 
      { 
