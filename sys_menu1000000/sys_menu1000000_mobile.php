...
<html>
    <head>
        ...
        <title>CONTROL FLAT</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["sys_menu1000000"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.css" />
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>tema_verde/tema_verde_menuMobile.css" />
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>tema_verde/tema_verde_menuMobile<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" />
        <script src="<?php echo $_SESSION["scriptcase"]["sys_menu1000000"]["glo_nm_path_prod"]; ?>/third/jquery/js/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["sys_menu1000000"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.js"></script>
    </head>
    <body>
   <TABLE width="100%" class="scMenuHHeader">
    ...
    <?php
        escreveMenuMobile($sys_menu1000000_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
