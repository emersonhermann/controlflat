...
<?php
include_once("form_public_unidade_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_public_unidade_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['recarga'];
}
?>
...
<?php
 include_once("form_public_unidade_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_public_unidade'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_public_unidade'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_unidade_label" id="hidden_field_label_id_unidade" style="<?php echo $sStyleHidden_id_unidade; ?>"><span id="id_label_id_unidade"><?php echo $this->nm_new_label['id_unidade']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['php_cmp_required']['id_unidade']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['php_cmp_required']['id_unidade'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_id_unidade_line" id="hidden_field_data_id_unidade" style="<?php echo $sStyleHidden_id_unidade; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_unidade_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ds_unidade_label" id="hidden_field_label_ds_unidade" style="<?php echo $sStyleHidden_ds_unidade; ?>"><span id="id_label_ds_unidade"><?php echo $this->nm_new_label['ds_unidade']; ?></span></TD>
    <TD class="scFormDataOdd css_ds_unidade_line" id="hidden_field_data_ds_unidade" style="<?php echo $sStyleHidden_ds_unidade; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ds_unidade_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ds_unidade_antiga_label" id="hidden_field_label_ds_unidade_antiga" style="<?php echo $sStyleHidden_ds_unidade_antiga; ?>"><span id="id_label_ds_unidade_antiga"><?php echo $this->nm_new_label['ds_unidade_antiga']; ?></span></TD>
    <TD class="scFormDataOdd css_ds_unidade_antiga_line" id="hidden_field_data_ds_unidade_antiga" style="<?php echo $sStyleHidden_ds_unidade_antiga; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ds_unidade_antiga_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cd_unidade_label" id="hidden_field_label_cd_unidade" style="<?php echo $sStyleHidden_cd_unidade; ?>"><span id="id_label_cd_unidade"><?php echo $this->nm_new_label['cd_unidade']; ?></span></TD>
    <TD class="scFormDataOdd css_cd_unidade_line" id="hidden_field_data_cd_unidade" style="<?php echo $sStyleHidden_cd_unidade; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cd_unidade_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ds_unidade_compl_label" id="hidden_field_label_ds_unidade_compl" style="<?php echo $sStyleHidden_ds_unidade_compl; ?>"><span id="id_label_ds_unidade_compl"><?php echo $this->nm_new_label['ds_unidade_compl']; ?></span></TD>
    <TD class="scFormDataOdd css_ds_unidade_compl_line" id="hidden_field_data_ds_unidade_compl" style="<?php echo $sStyleHidden_ds_unidade_compl; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ds_unidade_compl_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_bloco_label" id="hidden_field_label_id_bloco" style="<?php echo $sStyleHidden_id_bloco; ?>"><span id="id_label_id_bloco"><?php echo $this->nm_new_label['id_bloco']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_andar_label" id="hidden_field_label_andar" style="<?php echo $sStyleHidden_andar; ?>"><span id="id_label_andar"><?php echo $this->nm_new_label['andar']; ?></span></TD>
    <TD class="scFormDataOdd css_andar_line" id="hidden_field_data_andar" style="<?php echo $sStyleHidden_andar; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_andar_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_pessoa_fisica_label" id="hidden_field_label_id_pessoa_fisica" style="<?php echo $sStyleHidden_id_pessoa_fisica; ?>"><span id="id_label_id_pessoa_fisica"><?php echo $this->nm_new_label['id_pessoa_fisica']; ?></span></TD>
    <TD class="scFormDataOdd css_id_pessoa_fisica_line" id="hidden_field_data_id_pessoa_fisica" style="<?php echo $sStyleHidden_id_pessoa_fisica; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_pessoa_fisica_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_pessoa_juridica_label" id="hidden_field_label_id_pessoa_juridica" style="<?php echo $sStyleHidden_id_pessoa_juridica; ?>"><span id="id_label_id_pessoa_juridica"><?php echo $this->nm_new_label['id_pessoa_juridica']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fracao_label" id="hidden_field_label_fracao" style="<?php echo $sStyleHidden_fracao; ?>"><span id="id_label_fracao"><?php echo $this->nm_new_label['fracao']; ?></span></TD>
    <TD class="scFormDataOdd css_fracao_line" id="hidden_field_data_fracao" style="<?php echo $sStyleHidden_fracao; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fracao_line" style="vertical-align: top;padding: 0px">
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['mostra_cab'] != "N"))
  {
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_unidade']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_public_unidade");
 parent.scAjaxDetailHeight("form_public_unidade", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
