...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_dt_cadastro_hora' + iSeqRow).bind('blur', function() { sc_form_public_bloco_dt_cadastro_hora_onblur(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_public_bloco_dt_cadastro_hora_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_dt_atualiza_hora' + iSeqRow).bind('blur', function() { sc_form_public_bloco_dt_atualiza_hora_onblur(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_public_bloco_dt_atualiza_hora_onfocus(this, iSeqRow) });
...
function sc_form_public_bloco_dt_cadastro_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_public_bloco_validate_dt_cadastro();
  scCssBlur(oThis);
}
...
function sc_form_public_bloco_dt_cadastro_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_public_bloco_dt_atualiza_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_public_bloco_validate_dt_atualiza();
  scCssBlur(oThis);
}
...
function sc_form_public_bloco_dt_atualiza_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
