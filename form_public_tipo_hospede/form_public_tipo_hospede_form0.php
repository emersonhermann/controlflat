...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - \"public\".tipo_hospede"); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - \"public\".tipo_hospede"); } ?></TITLE>
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_public_tipo_hospede/form_public_tipo_hospede_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_public_tipo_hospede_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_public_tipo_hospede_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['recarga'];
}
?>
...
<?php
 include_once("form_public_tipo_hospede_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_public_tipo_hospede'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_public_tipo_hospede'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFormHeaderFont"><span><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - \"public\".tipo_hospede"; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - \"public\".tipo_hospede"; } ?></span></td>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<TABLE align="center" id="hidden_bloco_0" class="scFormTable" width="100%" style="height: 100%;"><?php
           if ('novo' != $this->nmgp_opcao && !isset($this->nmgp_cmp_readonly['id_tipo_hospede']))
           {
               $this->nmgp_cmp_readonly['id_tipo_hospede'] = 'on';
           }
?>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['id_tipo_hospede']))
    {
        $this->nm_new_label['id_tipo_hospede'] = "Id Tipo Hospede";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $id_tipo_hospede = $this->id_tipo_hospede;
   $sStyleHidden_id_tipo_hospede = '';
   if (isset($this->nmgp_cmp_hidden['id_tipo_hospede']) && $this->nmgp_cmp_hidden['id_tipo_hospede'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['id_tipo_hospede']);
       $sStyleHidden_id_tipo_hospede = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_id_tipo_hospede = 'display: none;';
   $sStyleReadInp_id_tipo_hospede = '';
   if (/*($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || */(isset($this->nmgp_cmp_readonly["id_tipo_hospede"]) &&  $this->nmgp_cmp_readonly["id_tipo_hospede"] == "on"))
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['id_tipo_hospede']);
       $sStyleReadLab_id_tipo_hospede = '';
       $sStyleReadInp_id_tipo_hospede = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['id_tipo_hospede']) && $this->nmgp_cmp_hidden['id_tipo_hospede'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="id_tipo_hospede" value="<?php echo $this->form_encode_input($id_tipo_hospede) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_tipo_hospede_label" id="hidden_field_label_id_tipo_hospede" style="<?php echo $sStyleHidden_id_tipo_hospede; ?>"><span id="id_label_id_tipo_hospede"><?php echo $this->nm_new_label['id_tipo_hospede']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['php_cmp_required']['id_tipo_hospede']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['php_cmp_required']['id_tipo_hospede'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_id_tipo_hospede_line" id="hidden_field_data_id_tipo_hospede" style="<?php echo $sStyleHidden_id_tipo_hospede; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_tipo_hospede_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || (isset($this->nmgp_cmp_readonly["id_tipo_hospede"]) &&  $this->nmgp_cmp_readonly["id_tipo_hospede"] == "on")) { 

 ?>
<input type="hidden" name="id_tipo_hospede" value="<?php echo $this->form_encode_input($id_tipo_hospede) . "\"><span id=\"id_ajax_label_id_tipo_hospede\">" . $id_tipo_hospede . "</span>"; ?>
<?php } else { ?>
<span id="id_read_on_id_tipo_hospede" class="sc-ui-readonly-id_tipo_hospede css_id_tipo_hospede_line" style="<?php echo $sStyleReadLab_id_tipo_hospede; ?>"><?php echo $this->form_encode_input($this->id_tipo_hospede); ?></span><span id="id_read_off_id_tipo_hospede" style="white-space: nowrap;<?php echo $sStyleReadInp_id_tipo_hospede; ?>">
 <input class="sc-js-input scFormObjectOdd css_id_tipo_hospede_obj" style="" id="id_sc_field_id_tipo_hospede" type=text name="id_tipo_hospede" value="<?php echo $this->form_encode_input($id_tipo_hospede) ?>"
 size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['id_tipo_hospede']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['id_tipo_hospede']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_id_tipo_hospede_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_id_tipo_hospede_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['ds_tipo_hospede']))
    {
        $this->nm_new_label['ds_tipo_hospede'] = "Ds Tipo Hospede";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $ds_tipo_hospede = $this->ds_tipo_hospede;
   $sStyleHidden_ds_tipo_hospede = '';
   if (isset($this->nmgp_cmp_hidden['ds_tipo_hospede']) && $this->nmgp_cmp_hidden['ds_tipo_hospede'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['ds_tipo_hospede']);
       $sStyleHidden_ds_tipo_hospede = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_ds_tipo_hospede = 'display: none;';
   $sStyleReadInp_ds_tipo_hospede = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['ds_tipo_hospede']) && $this->nmgp_cmp_readonly['ds_tipo_hospede'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['ds_tipo_hospede']);
       $sStyleReadLab_ds_tipo_hospede = '';
       $sStyleReadInp_ds_tipo_hospede = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['ds_tipo_hospede']) && $this->nmgp_cmp_hidden['ds_tipo_hospede'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="ds_tipo_hospede" value="<?php echo $this->form_encode_input($ds_tipo_hospede) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_ds_tipo_hospede_label" id="hidden_field_label_ds_tipo_hospede" style="<?php echo $sStyleHidden_ds_tipo_hospede; ?>"><span id="id_label_ds_tipo_hospede"><?php echo $this->nm_new_label['ds_tipo_hospede']; ?></span></TD>
    <TD class="scFormDataOdd css_ds_tipo_hospede_line" id="hidden_field_data_ds_tipo_hospede" style="<?php echo $sStyleHidden_ds_tipo_hospede; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ds_tipo_hospede_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["ds_tipo_hospede"]) &&  $this->nmgp_cmp_readonly["ds_tipo_hospede"] == "on") { 

 ?>
<input type="hidden" name="ds_tipo_hospede" value="<?php echo $this->form_encode_input($ds_tipo_hospede) . "\">" . $ds_tipo_hospede . ""; ?>
<?php } else { ?>
<span id="id_read_on_ds_tipo_hospede" class="sc-ui-readonly-ds_tipo_hospede css_ds_tipo_hospede_line" style="<?php echo $sStyleReadLab_ds_tipo_hospede; ?>"><?php echo $this->form_encode_input($this->ds_tipo_hospede); ?></span><span id="id_read_off_ds_tipo_hospede" style="white-space: nowrap;<?php echo $sStyleReadInp_ds_tipo_hospede; ?>">
 <input class="sc-js-input scFormObjectOdd css_ds_tipo_hospede_obj" style="" id="id_sc_field_ds_tipo_hospede" type=text name="ds_tipo_hospede" value="<?php echo $this->form_encode_input($ds_tipo_hospede) ?>"
...
</td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_ds_tipo_hospede_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_ds_tipo_hospede_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_merge_label" id="hidden_field_label_id_merge" style="<?php echo $sStyleHidden_id_merge; ?>"><span id="id_label_id_merge"><?php echo $this->nm_new_label['id_merge']; ?></span></TD>
    <TD class="scFormDataOdd css_id_merge_line" id="hidden_field_data_id_merge" style="<?php echo $sStyleHidden_id_merge; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_merge_line" style="vertical-align: top;padding: 0px">
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['mostra_cab'] != "N"))
  {
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_public_tipo_hospede']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_public_tipo_hospede");
 parent.scAjaxDetailHeight("form_public_tipo_hospede", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
