<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_public_tipo_hospede_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_public_tipo_hospede_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['id_tipo_hospede'] = "on";
   $tab_def_campos['id_tipo_hospede'] = "id_tipo_hospede";
   $tab_converte["id_tipo_hospede"]   = "id_tipo_hospede";
   $tab_labels["id_tipo_hospede"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_tipo_hospede']['labels']["id_tipo_hospede"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_tipo_hospede']['labels']["id_tipo_hospede"] : "Id Tipo Hospede";
   $tab_ger_campos['ds_tipo_hospede'] = "on";
   $tab_def_campos['ds_tipo_hospede'] = "ds_tipo_hospede";
   $tab_converte["ds_tipo_hospede"]   = "ds_tipo_hospede";
   $tab_labels["ds_tipo_hospede"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_tipo_hospede']['labels']["ds_tipo_hospede"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_tipo_hospede']['labels']["ds_tipo_hospede"] : "Ds Tipo Hospede";
   $tab_ger_campos['obs'] = "on";
   $tab_def_campos['obs'] = "obs";
   $tab_converte["obs"]   = "obs";
   $tab_labels["obs"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_tipo_hospede']['labels']["obs"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_tipo_hospede']['labels']["obs"] : "Obs";
   $tab_ger_campos['dt_cadastro'] = "on";
   $tab_def_campos['dt_cadastro'] = "dt_cadastro";
   $tab_converte["dt_cadastro"]   = "dt_cadastro";
   $tab_labels["dt_cadastro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_tipo_hospede']['labels']["dt_cadastro"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_tipo_hospede']['labels']["dt_cadastro"] : "Dt Cadastro";
   $tab_ger_campos['usu_cadastro'] = "on";
   $tab_def_campos['usu_cadastro'] = "usu_cadastro";
   $tab_converte["usu_cadastro"]   = "usu_cadastro";
   $tab_labels["usu_cadastro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_tipo_hospede']['labels']["usu_cadastro"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_tipo_hospede']['labels']["usu_cadastro"] : "Usu Cadastro";
   $tab_ger_campos['dt_atualiza'] = "on";
   $tab_def_campos['dt_atualiza'] = "dt_atualiza";
   $tab_converte["dt_atualiza"]   = "dt_atualiza";
   $tab_labels["dt_atualiza"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_tipo_hospede']['labels']["dt_atualiza"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_tipo_hospede']['labels']["dt_atualiza"] : "Dt Atualiza";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_public_tipo_hospede']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_public_tipo_hospede']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_public_tipo_hospede']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_public_tipo_hospede']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_public_tipo_hospede']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_public_tipo_hospede']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_public_tipo_hospede']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_public_tipo_hospede']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_public_tipo_hospede']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - "public".tipo_hospede</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_public_tipo_hospede_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_public_tipo_hospede']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_public_tipo_hospede']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
